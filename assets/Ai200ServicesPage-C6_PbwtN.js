import{_ as n}from"./NotesPage.vue_vue_type_script_setup_true_lang-D2hLR9Ji.js";import{d as t,f as e,e as i,o as c}from"./index-CVd9JySu.js";import"./ThemeToggle.vue_vue_type_script_setup_true_lang-BVmnr-2x.js";import"./useStudyClock-BGDH9axH.js";const h=`<h2 class="dom">0. Trang này là gì và bù cái gì</h2>
...
<div class="warn"><b>Lock duration mặc định 1 phút, tối đa 5 phút.</b> Xử lý lâu hơn thế thì message quay lại hàng đợi và bị xử lý <b>lần nữa</b> — sinh trùng lặp âm thầm. Cách đúng là gọi <b>RenewLock</b> định kỳ trong lúc xử lý, <b>không phải</b> kéo lock duration lên kịch trần.</div>
...
Mã HTTP handler trả về quyết định hành vi
  200–204     thành công, KHÔNG thử lại
  400, 413, 403  không retry (400/413 → dead-letter ngay); webhook thêm 401 không retry
  401, 404 (endpoint tài nguyên Azure) → retry sau ≥ 5 phút; 408 → ≥ 2 phút; 503 → ≥ 30 giây; mã khác → ≥ 10 giây
...
Container Apps        GA           function đóng container, chạy cạnh microservice
                                   có cả GPU
Consumption (cũ)      LEGACY       Linux Consumption retire sau 9/2028 — dự án mới dùng Flex</code></pre>
<div class="warn"><b>Chỗ tài liệu cũ sai nhiều nhất:</b> Consumption nay là <b>legacy</b>, app serverless mới phải dùng <b>Flex Consumption</b>, và <b>Linux Consumption sẽ bị retire sau tháng 9/2028</b> (khóa AI-200T00, 2026). Khoá học nào còn dạy "Consumption là plan serverless mặc định" là đã lỗi thời.</div>
