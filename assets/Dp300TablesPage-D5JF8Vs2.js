import{d as rt,r as p,z as ct,M as at,c as o,a as c,t as l,e as A,F as f,h as U,g as N,b as D,w as O,Y as F,q as Y,k as it,x as ht,o as s,n as W,i as X}from"./index-CnO1xks7.js";import{_ as ot}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-B8xZtp92.js";import{u as st}from"./useStudyClock-D22XUb7e.js";const P=`<h2 class="dom" id="d0">Bản đồ đề thi · bản 24/04/2026</h2>
...
<section id="t113">
<h3>Managed Instance link — di trú online và DR hai chiều<a class="nl" href="/dp-300/documents#s15">docs 1.17</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Migration,Hybrid%20HADR" title="Ôn 23 câu: Migration, Hybrid HADR (tab mới)">ôn 23 câu</a></h3>
...
<section id="t215">
<h3>Mã hoá cấp cột và cây khoá — SMK, DMK, certificate, symmetric key<a class="nl" href="/dp-300/documents#s31">docs 2.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Object%20encryption,Certificates" title="Ôn 7 câu: Object encryption, Certificates (tab mới)">ôn 7 câu</a></h3>
...
<section id="t312">
<h3>Intelligent Query Processing — bốn đợt theo compatibility level<a class="nl" href="/dp-300/documents#s66">docs 3.31</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=IQP" title="Ôn 10 câu: IQP (tab mới)">ôn 10 câu</a></h3>
...
<section id="t313">
<h3>Extended Events — session, target và khác biệt trên Azure<a class="nl" href="/dp-300/documents#s52">docs 3.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Extended%20Events,Blocking" title="Ôn 15 câu: Extended Events, Blocking (tab mới)">ôn 15 câu</a></h3>
...
<section id="t314">
<h3>Server setting cho hiệu năng — sp_configure và cấu hình Windows<a class="nl" href="/dp-300/documents#s62">docs 3.27</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Scoped%20config,DB%20options" title="Ôn 12 câu: Scoped config, DB options (tab mới)">ôn 12 câu</a></h3>
...
<section id="t510">
<h3>Replica đọc và availability group trên Managed Instance<a class="nl" href="/dp-300/documents#s90">docs 5.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Azure%20SQL%20MI,Availability%20Group" title="Ôn 19 câu: Azure SQL MI, Availability Group (tab mới)">ôn 19 câu</a></h3>
...
<section id="t511">
<h3>Contained availability group — SQL Server 2022 trở lên<a class="nl" href="/dp-300/documents#s90-2">docs 5.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=AG%20setup,AG%20listener" title="Ôn 11 câu: AG setup, AG listener (tab mới)">ôn 11 câu</a></h3>
...
`,lt={class:"tables-dp"},gt={class:"layout"},bt={class:"sub"},ut={class:"search"},pt={key:0,class:"cnt"},mt={key:1,class:"cnt"},yt={key:2,class:"toc-nav"},vt={key:0},St=["href","onClick"],Et={class:"topbar"},At={key:0,class:"nohit"},Dt=rt({__name:"Dp300TablesPage",setup(kt){st("dp300","notes");const Q=ht(),k=p(),b=p(),v=p(matchMedia("(max-width:960px)").matches),B=(()=>{const n=new DOMParser().parseFromString(P,"text/html"),t=[];return n.body.childNodes.forEach(r=>{if(r instanceof HTMLElement){if(r.tagName==="H2")t.push({id:r.id,title:r.textContent||"",items:[]});else if(r.tagName==="SECTION"&&t.length){const d=r.querySelector("h3");if(!d)return;const e=d.cloneNode(!0);e.querySelectorAll(".nl, .ql").forEach(i=>i.remove()),t[t.length-1].items.push({id:r.id,title:(e.textContent||"").trim()})}}}),t})(),_=B.reduce((n,t)=>n+t.items.length,0),j=(P.match(/<table class="cmp"/g)||[]).length,R=p(""),m=p(null),C=p(0),T=p(0),G=Y(()=>m.value!==null),w=Y(()=>{var n;return((n=m.value)==null?void 0:n.size)??_}),K=n=>!m.value||m.value.has(n);let y=[],S=null,L=null,M;const I=n=>(n||"").toLowerCase();function J(n){const t=n.cloneNode(!0);return t.querySelectorAll(".nl, .ql").forEach(r=>r.remove()),t.textContent}function Z(){y=[...k.value.querySelectorAll("section")].map(n=>{const t=[...n.querySelectorAll("h3, p.lead")],r=[...n.querySelectorAll(".tw")].map(d=>({tw:d,rows:[...d.querySelectorAll("tr")].map(e=>({tr:e,text:I(e.textContent),head:!!e.querySelector("th")}))}));return{el:n,id:n.id,head:t.map(d=>I(d.querySelector(".nl, .ql")?J(d):d.textContent)).join(" "),heads:t,tbls:r,rows:r.flatMap(d=>d.rows)}}),T.value=y.reduce((n,t)=>n+t.rows.filter(r=>!r.head).length,0),C.value=T.value}function $(n){n.querySelectorAll("mark").forEach(t=>t.replaceWith(document.createTextNode(t.textContent||""))),n.normalize()}function x(n,t){const r=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),d=[];let e;for(;e=r.nextNode();)I(e.nodeValue).includes(t)&&d.push(e);d.forEach(i=>{const u=document.createDocumentFragment(),a=i.nodeValue||"",E=a.toLowerCase();let h=0,g;for(;(g=E.indexOf(t,h))>-1;){u.appendChild(document.createTextNode(a.slice(h,g)));const z=document.createElement("mark");z.textContent=a.slice(g,g+t.length),u.appendChild(z),h=g+t.length}u.appendChild(document.createTextNode(a.slice(h))),i.replaceWith(u)})}function q(){const n=b.value.value.trim().toLowerCase();if(y.forEach(d=>{$(d.el),d.rows.forEach(e=>e.tr.classList.remove("hit"))}),!n){y.forEach(d=>{d.el.classList.remove("hidden"),d.tbls.forEach(e=>e.tw.classList.remove("hidden")),d.rows.forEach(e=>e.tr.classList.remove("hidden"))}),k.value.querySelectorAll("h2.dom").forEach(d=>d.classList.remove("hidden")),m.value=null,C.value=T.value;return}k.value.querySelectorAll("h2.dom").forEach(d=>d.classList.add("hidden"));const t=new Set;let r=0;y.forEach(d=>{const e=d.head.includes(n);let i=0;d.tbls.forEach(a=>{let E=0;a.rows.forEach(h=>{const g=e||h.text.includes(n);h.tr.classList.toggle("hidden",!(g||h.head)),g&&!h.head&&(E++,e||h.tr.classList.add("hit"))}),a.tw.classList.toggle("hidden",E===0),i+=E});const u=e||i>0;d.el.classList.toggle("hidden",!u),u&&(t.add(d.id),r+=i,d.heads.forEach(a=>x(a,n)),d.rows.forEach(a=>{a.tr.classList.contains("hidden")||x(a.tr,n)}))}),m.value=t,C.value=r}function tt(){clearTimeout(M),M=setTimeout(q,120)}function nt(){b.value.value="",q()}function V(n){n.key==="/"&&document.activeElement!==b.value&&(n.preventDefault(),b.value.focus()),n.key==="Escape"&&document.activeElement===b.value&&(nt(),b.value.blur())}function H(n){const t=document.getElementById(n);t&&(L==null||L.classList.remove("flash"),t.scrollIntoView({block:"start"}),t.offsetWidth,t.classList.add("flash"),L=t,R.value=n,matchMedia("(max-width:960px)").matches&&(v.value=!0))}function dt(n,t){n.preventDefault(),Q.replace({hash:`#${t}`}),H(t)}function et(n){var d,e;const t=(e=(d=n.target).closest)==null?void 0:e.call(d,"a");if(!t)return;const r=t.getAttribute("href")||"";r.startsWith("/")&&t.getAttribute("target")!=="_blank"&&(n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||n.button!==0||(n.preventDefault(),Q.push(r)))}return ct(()=>{Z(),typeof IntersectionObserver<"u"&&(S=new IntersectionObserver(n=>n.forEach(t=>{t.isIntersecting&&(R.value=t.target.id)}),{rootMargin:"0px 0px -75% 0px"}),y.forEach(n=>S.observe(n.el))),location.hash&&H(decodeURIComponent(location.hash.slice(1))),document.addEventListener("keydown",V)}),at(()=>{document.removeEventListener("keydown",V),S==null||S.disconnect(),clearTimeout(M)}),(n,t)=>{const r=it("router-link");return s(),o("div",lt,[c("div",gt,[c("aside",null,[t[2]||(t[2]=c("h1",null,"DP-300 · Bảng ôn nhanh",-1)),c("div",bt,l(A(_))+" mục · "+l(A(j))+" bảng, tổng hợp từ tài liệu DP-300",1),c("div",ut,[c("input",{ref_key:"qEl",ref:b,type:"search",placeholder:"Tìm trong bảng… (/)",autocomplete:"off",onInput:tt},null,544)]),G.value?(s(),o("p",pt,l(w.value)+"/"+l(A(_))+" mục · "+l(C.value)+"/"+l(T.value)+" dòng ",1)):(s(),o("p",mt,"Gõ “/” để tìm — kết quả lọc tới từng dòng của bảng.")),v.value?N("",!0):(s(),o("nav",yt,[(s(!0),o(f,null,U(A(B),d=>(s(),o(f,{key:d.id},[d.items.some(e=>K(e.id))?(s(),o("h4",vt,l(d.title),1)):N("",!0),c("ol",null,[(s(!0),o(f,null,U(d.items,e=>(s(),o("li",{key:e.id,class:W({hidden:!K(e.id)})},[c("a",{href:"#"+e.id,class:W({on:R.value===e.id}),onClick:i=>dt(i,e.id)},l(e.title),11,St)],2))),128))])],64))),128))]))]),c("main",null,[c("div",Et,[D(r,{to:"/dp-300/documents"},{default:O(()=>[...t[3]||(t[3]=[X("← Tài liệu",-1)])]),_:1}),D(r,{to:"/dp-300/practice"},{default:O(()=>[...t[4]||(t[4]=[X("Luyện tập",-1)])]),_:1}),t[6]||(t[6]=c("span",{class:"spacer"},null,-1)),c("button",{onClick:t[0]||(t[0]=d=>v.value=!v.value)},l(v.value?"Mở mục lục":"Thu gọn mục lục"),1),D(ot),D(r,{to:"/",style:{"text-decoration":"none"}},{default:O(()=>[...t[5]||(t[5]=[c("button",null,"🏠",-1)])]),_:1})]),t[7]||(t[7]=c("p",{class:"intro"}," Toàn bộ kiến thức trong tài liệu, viết lại thành bảng so sánh để ôn nhanh. Mỗi mục có link “note” dẫn sang phần giải thích đầy đủ. Trang này không nằm trong tài liệu và không sửa gì ở đó. ",-1)),t[1]||(F(-1,!0),(t[1]=c("div",{ref_key:"contentEl",ref:k,innerHTML:A(P),onClick:et},null,8,["innerHTML"])).cacheIndex=1,F(1),t[1]),G.value&&w.value===0?(s(),o("div",At,"Không tìm thấy dòng nào khớp.")):N("",!0)])])])}}});export{Dt as default};
