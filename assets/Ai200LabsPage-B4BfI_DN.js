import{_ as t}from"./NotesPage.vue_vue_type_script_setup_true_lang-aDP3p1Od.js";import{d as n,f as e,e as c,o}from"./index-BvUv8dKS.js";import"./ThemeToggle.vue_vue_type_script_setup_true_lang-Ca5tM9l2.js";import"./useStudyClock-y-4x9X8P.js";const d=`<h2 class="dom">0. Trang này là gì</h2>

<section id="l0">
<h3>0.1 Vì sao cần lab, khi đã có 507 câu hỏi và 8 bài tài liệu<a class="anch" href="#l0">#</a></h3>
<p>Repo đã có <a href="/ai-200/documents">tài liệu 4 domain</a>, <a href="/ai-200/services">36 mục dịch vụ</a> và <a href="/ai-200/practice">507 câu luyện</a>. Cái còn thiếu là <b>tay</b>. AI-200 hỏi rất nhiều câu dạng <i>"pod này vì sao Pending"</i>, <i>"index có được dùng không"</i>, <i>"lệnh nào, theo thứ tự nào"</i> — đọc thuộc thì quên, gõ một lần thì nhớ.</p>
<p>Năm mảng nặng nhất của đề đều dựng được <b>offline, miễn phí</b>, trên chính máy bạn:</p>
<table>
...
<div class="tip"><b>Mọi con số trên trang này đã được chạy thật</b> trên bộ lab ở <code>labs/ai-200/</code> — PostgreSQL 17 + pgvector 0.8.6, Redis Stack, Kubernetes v1.34 (kind), Cosmos DB emulator vNext (build EN20260907), Kusto emulator. Không có số nào chép từ tài liệu mà chưa kiểm.</div>
<p class="src"><b>Nguồn đối chiếu:</b> <a href="https://learn.microsoft.com/en-us/credentials/certifications/resources/study-guides/ai-200" target="_blank" rel="noopener">Study guide AI-200</a> (skills measured 15/04/2026) · <a href="https://github.com/pgvector/pgvector" target="_blank" rel="noopener">pgvector</a> · <a href="https://redis.io/docs/latest/develop/data-types/streams/" target="_blank" rel="noopener">Redis Streams</a> · <a href="https://kubernetes.io/docs/concepts/workloads/pods/pod-qos/" target="_blank" rel="noopener">Kubernetes docs</a> · Unit 4 "Full Orchestration – AKS" của khoá Azure Cloud Mastery. Chạy lab ngày 18/09/2026.</p>
</section>

<section id="l1">
<h3>0.2 Dựng môi trường — 3 lệnh<a class="anch" href="#l1">#</a></h3>
<pre><button class="copybtn">copy</button><code>cd labs/ai-200
docker compose up -d          # lần đầu kéo ~1 GB, sau đó vài giây
./psql "SELECT version()"     # Postgres đã lên?
./redis PING                  # Redis đã lên?
</code></pre>
<p>RedisInsight ở <code>http://localhost:8002</code>. Postgres ở <code>localhost:5433</code> (user/pass trong <code>.env</code>). Dựng lại từ đầu: <code>docker compose down -v &amp;&amp; docker compose up -d</code>.</p>
...
<h2 class="dom">6. Dọn dẹp</h2>

<section id="l17">
<h3>6.1 Xoá sạch khi học xong<a class="anch" href="#l17">#</a></h3>
<pre><button class="copybtn">copy</button><code>cd labs/ai-200
docker compose down -v                 # xoá container + dữ liệu Postgres/Redis/Cosmos/Kusto
...
`,g=n({__name:"Ai200LabsPage",setup(i){return(h,a)=>(o(),e(t,{certId:"ai200",html:c(d),title:"AI-200 · Thực hành",subtitle:"20 lab chạy offline — pgvector, Redis vector + Streams, Cosmos DB emulator, KQL trên Kusto emulator, và cluster Kubernetes 3 node bằng kind. Không cần Azure, không tốn tiền.",practiceRoute:"/ai-200/practice",practiceLabel:"Luyện thi AI-200",extraLinks:[{to:"/ai-200/documents",label:"Tài liệu"},{to:"/ai-200/services",label:"Dịch vụ Azure"}]},null,8,["html"]))}});export{g as default};
