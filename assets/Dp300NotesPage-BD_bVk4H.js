import{_ as Y}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-D-q5_PfG.js";import{d as K,Q as W,j as c,s as j,x as X,c as $,a as e,P as A,b as d,g as f,w as k,t as _,r as J,o as Z,h as P}from"./index-C6E142I_.js";import{u as aa}from"./useStudyClock-D4WPUQjn.js";const na=`<h2 class="dom" id="dom1">1 · Plan and implement data platform resources</h2>
...
`,ea={class:"layout"},la={class:"search"},ia={class:"topbar"},ta=["title"],ga=K({__name:"Dp300NotesPage",setup(ca){aa("dp300","notes");const p=W(),Q=c(),o=c(),E=c(),i=c(),R=c(),v=c(matchMedia("(max-width:860px)").matches);let r=[],m=[],T=[],g=null,u=null,D;const B=()=>document.documentElement.dataset.lang||"vi",I=n=>[...n.querySelectorAll(B()==="en"?".lang-en":".lang-vi")],w=n=>I(n).map(a=>a.textContent).join(" ").toLowerCase();function z(n){document.documentElement.dataset.lang=n,p.setLang(n),r.forEach(a=>a.text=w(a.el)),i.value.value&&L()}const x=n=>{n.querySelectorAll("mark").forEach(a=>a.replaceWith(document.createTextNode(a.textContent||""))),n.normalize()};function U(n,a){const s=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),l=[];let t;for(;t=s.nextNode();)(t.nodeValue||"").toLowerCase().includes(a)&&l.push(t);l.forEach(M=>{const b=document.createDocumentFragment(),y=M.nodeValue||"",H=y.toLowerCase();let S=0,h;for(;(h=H.indexOf(a,S))>-1;){b.appendChild(document.createTextNode(y.slice(S,h)));const O=document.createElement("mark");O.textContent=y.slice(h,h+a.length),b.appendChild(O),S=h+a.length}b.appendChild(document.createTextNode(y.slice(S))),M.replaceWith(b)})}const V=(n,a)=>I(n).forEach(s=>U(s,a));function L(){const n=i.value.value.trim().toLowerCase();let a=0;o.value.querySelectorAll("h2.dom").forEach(s=>s.classList.toggle("hidden",!!n)),r.forEach(s=>{x(s.el);const l=!n||s.text.includes(n);s.el.classList.toggle("hidden",!l),l&&(a++,n&&V(s.el,n))}),n||o.value.querySelectorAll("h2.dom").forEach(s=>s.classList.remove("hidden")),R.value.classList.toggle("hidden",a>0),m.forEach(s=>{const l=s.getAttribute("href").slice(1),t=document.getElementById(l);s.parentElement.classList.toggle("hidden",!!(t&&t.classList.contains("hidden")))})}function G(){clearTimeout(D),D=setTimeout(L,120)}function q(n){n.key==="/"&&document.activeElement!==i.value&&(n.preventDefault(),i.value.focus()),n.key==="Escape"&&document.activeElement===i.value&&(i.value.value="",L(),i.value.blur())}function C(){var s;const n=decodeURIComponent(location.hash.slice(1)),a=n?document.getElementById(n):null;u==null||u.classList.remove("flash"),u=null,!(!a||!((s=o.value)!=null&&s.contains(a)))&&(a.scrollIntoView({block:"start"}),a.offsetWidth,a.classList.add("flash"),u=a)}function N(){E.value.querySelectorAll("ol").forEach(n=>n.classList.toggle("hidden",v.value))}function F(){v.value=!v.value,N()}return j(()=>{document.documentElement.dataset.lang=p.lang,r=[...o.value.querySelectorAll("section")].map(a=>({el:a,text:""})),r.forEach(a=>a.text=w(a.el)),m=[...E.value.querySelectorAll("a")];const n={};m.forEach(a=>n[a.getAttribute("href").slice(1)]=a),typeof IntersectionObserver<"u"&&(g=new IntersectionObserver(a=>{a.forEach(s=>{const l=n[s.target.id];l&&s.isIntersecting&&(m.forEach(t=>t.classList.remove("on")),l.classList.add("on"),l.scrollIntoView({block:"nearest"}))})},{rootMargin:"0px 0px -75% 0px"}),r.forEach(a=>g.observe(a.el))),N(),location.hash&&C(),document.addEventListener("keydown",q),window.addEventListener("hashchange",C),T.push(()=>document.removeEventListener("keydown",q)),T.push(()=>window.removeEventListener("hashchange",C))}),X(()=>{T.forEach(n=>n()),g==null||g.disconnect(),delete document.documentElement.dataset.lang}),(n,a)=>{const s=J("router-link");return Z(),$("div",{ref_key:"rootEl",ref:Q,class:"notes-dp"},[e("div",ea,[e("aside",null,[a[3]||(a[3]=e("h1",null,"DP-300 · Notes",-1)),a[4]||(a[4]=e("div",{class:"sub"},"142 mục · 4106 dòng ghi chú",-1)),e("div",la,[e("input",{ref_key:"qEl",ref:i,type:"search",placeholder:"Tìm trong note… (/)",autocomplete:"off",onInput:G},null,544)]),a[0]||(A(-1,!0),(a[0]=e("nav",{ref_key:"tocEl",ref:E,class:"toc-nav",innerHTML:d(sa)},null,8,["innerHTML"])).cacheIndex=0,A(1),a[0]),a[5]||(a[5]=e("div",{class:"cov"},"Bản dịch tiếng Việt: 3571/3571 mục/dòng",-1))]),e("main",null,[e("div",ia,[f(s,{to:"/dp-300/practice"},{default:k(()=>[...a[6]||(a[6]=[P("← Về bài luyện tập",-1)])]),_:1}),f(s,{to:"/dp-300/tables"},{default:k(()=>[...a[7]||(a[7]=[P("Bảng ôn nhanh",-1)])]),_:1}),a[9]||(a[9]=e("span",{class:"spacer"},null,-1)),e("button",{class:"lang-btn",title:d(p).lang==="vi"?"Switch to English":"Chuyển sang tiếng Việt",onClick:a[1]||(a[1]=l=>z(d(p).lang==="vi"?"en":"vi"))},_(d(p).lang==="vi"?"EN":"VI"),9,ta),e("button",{onClick:F},_(v.value?"Mở mục lục":"Thu gọn mục lục"),1),f(Y),f(s,{to:"/",style:{"text-decoration":"none"}},{default:k(()=>[...a[8]||(a[8]=[e("button",null,"🏠",-1)])]),_:1})]),a[2]||(A(-1,!0),(a[2]=e("div",{ref_key:"contentEl",ref:o,innerHTML:d(na)},null,8,["innerHTML"])).cacheIndex=2,A(1),a[2]),e("div",{ref_key:"nohitEl",ref:R,class:"nohit hidden"},"Không tìm thấy kết quả nào.",512)])])],512)}}});export{ga as default};
