const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/packs-DL288Apc.js","assets/index-7FeyXGeK.js","assets/index-CA1nwlEg.css"])))=>i.map(i=>d[i]);
import{d as J,P as Z,j as c,s as aa,_ as na,x as sa,c as B,a as i,O as f,b as v,h as r,t as D,f as ea,g as E,w as I,r as la,m as ia,o as z}from"./index-7FeyXGeK.js";import{_ as ta}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-qxMXoqxY.js";import{u as ca}from"./useStudyClock-Df1f9Cvb.js";const pa=`<h2 class="dom" id="dom1">1 · Plan and implement data platform resources</h2>
...
`,ra={class:"layout"},ga={class:"search"},ua={class:"cov"},ha={key:0},da={class:"topbar"},va=["title"],Aa=J({__name:"Dp300NotesPage",setup(ma){ca("dp300","notes");const x=ia(),g=Z(),U=c(),p=c(),T=c(),t=c(),w=c(),m=c(matchMedia("(max-width:860px)").matches);let o=[],b=[],L=[],u=null,h=null,q;const V=()=>document.documentElement.dataset.lang||"vi",N=n=>[...n.querySelectorAll(V()==="en"?".lang-en":".lang-vi")],M=n=>N(n).map(a=>a.textContent).join(" ").toLowerCase();function G(n){document.documentElement.dataset.lang=n,g.setLang(n),o.forEach(a=>a.text=M(a.el)),t.value.value&&C()}const F=n=>{n.querySelectorAll("mark").forEach(a=>a.replaceWith(document.createTextNode(a.textContent||""))),n.normalize()};function H(n,a){const s=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),e=[];let l;for(;l=s.nextNode();)(l.nodeValue||"").toLowerCase().includes(a)&&e.push(l);e.forEach(P=>{const y=document.createDocumentFragment(),S=P.nodeValue||"",$=S.toLowerCase();let A=0,d;for(;(d=$.indexOf(a,A))>-1;){y.appendChild(document.createTextNode(S.slice(A,d)));const Q=document.createElement("mark");Q.textContent=S.slice(d,d+a.length),y.appendChild(Q),A=d+a.length}y.appendChild(document.createTextNode(S.slice(A))),P.replaceWith(y)})}const Y=(n,a)=>N(n).forEach(s=>H(s,a));function C(){const n=t.value.value.trim().toLowerCase();let a=0;p.value.querySelectorAll("h2.dom").forEach(s=>s.classList.toggle("hidden",!!n)),o.forEach(s=>{F(s.el);const e=!n||s.text.includes(n);s.el.classList.toggle("hidden",!e),e&&(a++,n&&Y(s.el,n))}),n||p.value.querySelectorAll("h2.dom").forEach(s=>s.classList.remove("hidden")),w.value.classList.toggle("hidden",a>0),b.forEach(s=>{const e=s.getAttribute("href").slice(1),l=document.getElementById(e);s.parentElement.classList.toggle("hidden",!!(l&&l.classList.contains("hidden")))})}function K(){clearTimeout(q),q=setTimeout(C,120)}function O(n){n.key==="/"&&document.activeElement!==t.value&&(n.preventDefault(),t.value.focus()),n.key==="Escape"&&document.activeElement===t.value&&(t.value.value="",C(),t.value.blur())}function k(){var s;const n=decodeURIComponent(location.hash.slice(1)),a=n?document.getElementById(n):null;h==null||h.classList.remove("flash"),h=null,!(!a||!((s=p.value)!=null&&s.contains(a)))&&(a.scrollIntoView({block:"start"}),a.offsetWidth,a.classList.add("flash"),h=a)}const R=c(0);function W(n){o.forEach(({el:a})=>{const s=n.get(a.id);if(!s)return;const e=a.querySelector("h3");if(!e)return;const l=document.createElement("a");l.className="ql",l.href="/dp-300/practice?note="+encodeURIComponent(a.id),l.target="_blank",l.rel="noopener",l.title=`Luyện ${s} câu hỏi thuộc mục này (mở tab mới)`,l.textContent=`ôn ${s} câu`,e.insertBefore(l,e.querySelector(".anch")),R.value++})}function j(n){var e,l;const a=(l=(e=n.target).closest)==null?void 0:l.call(e,"a");if(!a)return;const s=a.getAttribute("href")||"";s.startsWith("/")&&a.target!=="_blank"&&(n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||n.button!==0||(n.preventDefault(),x.push(s)))}function _(){T.value.querySelectorAll("ol").forEach(n=>n.classList.toggle("hidden",m.value))}function X(){m.value=!m.value,_()}return aa(()=>{document.documentElement.dataset.lang=g.lang,o=[...p.value.querySelectorAll("section")].map(a=>({el:a,text:""})),o.forEach(a=>a.text=M(a.el)),b=[...T.value.querySelectorAll("a")],na(async()=>{const{PACKS:a,countByNote:s}=await import("./packs-DL288Apc.js");return{PACKS:a,countByNote:s}},__vite__mapDeps([0,1,2])).then(({PACKS:a,countByNote:s})=>{p.value&&W(s(a.dp300))});const n={};b.forEach(a=>n[a.getAttribute("href").slice(1)]=a),typeof IntersectionObserver<"u"&&(u=new IntersectionObserver(a=>{a.forEach(s=>{const e=n[s.target.id];e&&s.isIntersecting&&(b.forEach(l=>l.classList.remove("on")),e.classList.add("on"),e.scrollIntoView({block:"nearest"}))})},{rootMargin:"0px 0px -75% 0px"}),o.forEach(a=>u.observe(a.el))),_(),location.hash&&k(),document.addEventListener("keydown",O),window.addEventListener("hashchange",k),L.push(()=>document.removeEventListener("keydown",O)),L.push(()=>window.removeEventListener("hashchange",k))}),sa(()=>{L.forEach(n=>n()),u==null||u.disconnect(),delete document.documentElement.dataset.lang}),(n,a)=>{const s=la("router-link");return z(),B("div",{ref_key:"rootEl",ref:U,class:"notes-dp"},[i("div",ra,[i("aside",null,[a[9]||(a[9]=i("h1",null,"DP-300 · Notes",-1)),a[10]||(a[10]=i("div",{class:"sub"},"142 mục · 4106 dòng ghi chú",-1)),i("div",ga,[i("input",{ref_key:"qEl",ref:t,type:"search",placeholder:"Tìm trong note… (/)",autocomplete:"off",onInput:K},null,544)]),a[0]||(f(-1,!0),(a[0]=i("nav",{ref_key:"tocEl",ref:T,class:"toc-nav",innerHTML:v(oa)},null,8,["innerHTML"])).cacheIndex=0,f(1),a[0]),a[11]||(a[11]=i("div",{class:"cov"},"Bản dịch tiếng Việt: 3571/3571 mục/dòng",-1)),i("div",ua,[a[3]||(a[3]=r(" Pill ",-1)),a[4]||(a[4]=i("b",null,"“ôn N câu”",-1)),a[5]||(a[5]=r(" ở tiêu đề mục mở ",-1)),a[6]||(a[6]=i("b",null,"tab mới",-1)),a[7]||(a[7]=r(" với đúng các câu hỏi thuộc mục đó",-1)),R.value?(z(),B("span",ha," — "+D(R.value)+" mục có câu hỏi",1)):ea("",!0),a[8]||(a[8]=r(". ",-1))])]),i("main",null,[i("div",da,[E(s,{to:"/dp-300/practice"},{default:I(()=>[...a[12]||(a[12]=[r("← Về bài luyện tập",-1)])]),_:1}),E(s,{to:"/dp-300/tables"},{default:I(()=>[...a[13]||(a[13]=[r("Bảng ôn nhanh",-1)])]),_:1}),a[15]||(a[15]=i("span",{class:"spacer"},null,-1)),i("button",{class:"lang-btn",title:v(g).lang==="vi"?"Switch to English":"Chuyển sang tiếng Việt",onClick:a[1]||(a[1]=e=>G(v(g).lang==="vi"?"en":"vi"))},D(v(g).lang==="vi"?"EN":"VI"),9,va),i("button",{onClick:X},D(m.value?"Mở mục lục":"Thu gọn mục lục"),1),E(ta),E(s,{to:"/",style:{"text-decoration":"none"}},{default:I(()=>[...a[14]||(a[14]=[i("button",null,"🏠",-1)])]),_:1})]),a[2]||(f(-1,!0),(a[2]=i("div",{ref_key:"contentEl",ref:p,innerHTML:v(pa),onClick:j},null,8,["innerHTML"])).cacheIndex=2,f(1),a[2]),i("div",{ref_key:"nohitEl",ref:w,class:"nohit hidden"},"Không tìm thấy kết quả nào.",512)])])],512)}}});export{Aa as default};
