import{_ as n}from"./NotesPage.vue_vue_type_script_setup_true_lang-zpeHL2-u.js";import{d as t,f as e,e as c,o}from"./index-1Ucv6_yv.js";import"./ThemeToggle.vue_vue_type_script_setup_true_lang-C4OQ5IAM.js";import"./useStudyClock-HDN1O_Cb.js";const d=`<h2 class="dom">0. Trang này là gì</h2>

<section id="l0">
<h3>0.1 Vì sao cần lab, khi đã có 563 câu hỏi và 8 bài tài liệu<a class="anch" href="#l0">#</a></h3>
<p>Repo đã có <a href="/ai-200/documents">tài liệu 4 domain</a>, <a href="/ai-200/services">36 mục dịch vụ</a> và <a href="/ai-200/practice">563 câu luyện</a>. Cái còn thiếu là <b>tay</b>. AI-200 hỏi rất nhiều câu dạng <i>"pod này vì sao Pending"</i>, <i>"index có được dùng không"</i>, <i>"lệnh nào, theo thứ tự nào"</i> — đọc thuộc thì quên, gõ một lần thì nhớ.</p>
