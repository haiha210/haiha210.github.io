const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/packs-BbR3gruQ.js","assets/index-BcG7APcn.js","assets/index-wh9l3C_0.css"])))=>i.map(i=>d[i]);
import{d as Aa,R as Ea,C as Ta,r as p,S as La,z as ka,_ as Ca,E as Ra,c as m,a as l,i as c,t as o,J as la,f as x,F as Da,h as Ia,n as ia,Q as M,b,g as _,w as U,q as V,k as wa,x as qa,U as Na,o as y}from"./index-BcG7APcn.js";import{_ as Ma}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-D3HZfqms.js";import{u as _a}from"./useStudyClock-pKQKYI-6.js";const Oa=`<h2 class="dom" id="dom1">1 · Plan and implement data platform resources</h2>
...
<section id="s-3"><h3><span class="n">4–6.</span> <span class="lang-en">evaluate the possible database offerings: deployment requirements, functionality, scalability, HA/DR and security</span><span class="lang-vi">đánh giá các lựa chọn database: yêu cầu triển khai, chức năng, khả năng mở rộng, HA/DR và bảo mật</span><a class="anch" href="#s-3" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">Skills 4 to 6 all compare the same three platforms, so their tables are gathered here.</span><span class="lang-vi">Các mục 4–6 đều so sánh cùng ba nền tảng, nên gom chung bảng về một mục.</span></li></ul>
...
<section id="s18a"><h3><span class="n">18a.</span> <span class="lang-en">troubleshoot a migration</span><span class="lang-vi">xử lý sự cố migration</span><a class="anch" href="#s18a" title="Link tới mục này">#</a></h3>
...
<section id="s28a"><h3><span class="n">28a.</span> <span class="lang-en">troubleshoot authentication and authorization issues</span><span class="lang-vi">xử lý sự cố xác thực và phân quyền</span><a class="anch" href="#s28a" title="Link tới mục này">#</a></h3>
...
<section id="s69"><h3><span class="n">69.</span> <span class="lang-en">troubleshoot SQL Server Agent jobs and automated deployments</span><span class="lang-vi">xử lý sự cố SQL Server Agent job và triển khai tự động</span><a class="anch" href="#s69" title="Link tới mục này">#</a></h3>
...
<section id="s95"><h3><span class="n">95.</span> <span class="lang-en">monitor and troubleshoot an HA/DR solution</span><span class="lang-vi">giám sát và xử lý sự cố giải pháp HA/DR</span><a class="anch" href="#s95" title="Link tới mục này">#</a></h3>
