import{d as rt,r as p,z as ct,M as at,c as h,a as c,t as l,e as A,F as f,h as U,g as N,b as _,w as O,Y as F,q as Y,k as it,x as ot,o as s,n as W,i as X}from"./index-BayMeIFK.js";import{_ as ht}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-DpoYyRK7.js";import{u as st}from"./useStudyClock-BRfRiEVg.js";const P=`<h2 class="dom" id="d0">Bản đồ đề thi · bản 24/04/2026</h2>

<section id="t001">
<h3>Đề DP-300 hiện tại — trọng số, phạm vi và chỗ ôn tương ứng<a class="nl" href="/dp-300/documents#dom1">docs</a></h3>
<p class="lead">Tổng hợp từ study guide chính thức trên Microsoft Learn (skills đo từ <b>24/04/2026</b> — change log ghi các thay đổi chỉ ở mức <i>Minor</i>, cấu trúc 5 phạm vi giữ nguyên). Thi <b>100 phút</b>, đạt từ <b>700/1000</b>, chứng chỉ gia hạn <b>miễn phí mỗi 12 tháng</b> bằng bài assessment online trên Learn.</p>
<p class="lead"><b>Trọng số ở bảng này lấy từ score report chính thức của kỳ thi ngày 18/08/2026</b> (bản in kèm điểm từng phạm vi) — không phải chép tay từ study guide. Trước ngày 11/09/2026 repo ghi phạm vi 1 là 15–20% và phạm vi 2 là 20–25%, tức <b>đảo ngược hai dòng đầu</b>; hệ quả là việc ôn bị dồn sai vào phạm vi 2. Nếu cần sửa lại, hãy đối chiếu score report hoặc trang study guide đang sống, đừng chép lại từ bản cũ.</p>
<div class="tw"><table class="cmp">
<tr><th>Phạm vi</th><th>Trọng số</th><th>Study guide nêu đích danh</th><th>Ôn ở đâu</th></tr>
<tr><td>1 · Nền tảng dữ liệu &amp; di trú</td><td>20–25%</td><td>Chọn database offering; deployment tự động; <b>Azure Arc-enabled SQL</b>; <b>Azure SQL Database trong Microsoft Fabric</b>; table partitioning; sharding; hybrid + patch IaaS; scale DB/MI/VM; data compression; migration online/offline; <b>MI database copy/move</b>; troubleshoot migration</td><td><a href="/dp-300/documents#s-sec1">bảng tổng hợp phạm vi 1</a> · nhóm <a href="#d1">Phạm vi 1</a> bên dưới</td></tr>
<tr><td>2 · Môi trường bảo mật</td><td>15–20%</td><td>Entra ID authentication (DB, MI, SQL Server); security principals; least privilege; phân quyền bằng T-SQL; TDE; object-level encryption; firewall rules; <b>Always Encrypted + VBS enclaves</b>; private link / service endpoint; data classification; audit; <b>change data tracking</b>; dynamic data masking; <b>ledger</b>; row-level security</td><td><a href="/dp-300/documents#s-sec2">bảng tổng hợp phạm vi 2</a> · nhóm <a href="#d2">Phạm vi 2</a></td></tr>
<tr><td>3 · Giám sát &amp; tinh chỉnh</td><td>20–25%</td><td>Baseline; nguồn metric; <b>database watcher</b>; Extended Events; Query Store; session blocking; DMV; index cho query; sửa cấu trúc query; execution plan; Intelligent Insights; index/statistics maintenance; integrity check; automatic tuning; server settings; <b>Resource Governor</b>; database-scoped configuration; scale compute/storage; <b>intelligent query processing (IQP)</b></td><td><a href="/dp-300/documents#s-sec3">bảng tổng hợp phạm vi 3</a> · nhóm <a href="#d3">Phạm vi 3</a></td></tr>
<tr><td>4 · Tự động hoá</td><td>15–20%</td><td>SQL Server Agent jobs (lịch bảo trì, alert, notification, troubleshoot); deployment bằng <b>ARM/Bicep</b>, Azure PowerShell, Azure CLI; <b>monitor và troubleshoot deployment</b>; <b>elastic jobs</b>; alert cho database task; troubleshoot task tự động</td><td><a href="/dp-300/documents#s-sec4">bảng tổng hợp phạm vi 4</a> · nhóm <a href="#d4">Phạm vi 4</a></td></tr>
<tr><td>5 · HA/DR</td><td>20–25%</td><td>Chiến lược theo RPO/RTO; HA/DR hybrid và Azure-specific; quy trình test; backup/restore bằng công cụ native và T-SQL; restore point-in-time; <b>long-term retention</b>; backup/restore với cloud storage; active geo-replication; <b>Always On AG trên MI và VM</b>; failover groups; FCI trên VM; log shipping; monitor + troubleshoot HA/DR</td><td><a href="/dp-300/documents#s-sec5">bảng tổng hợp phạm vi 5</a> · nhóm <a href="#d5">Phạm vi 5</a></td></tr>
</table></div>
<p class="lead">Các chủ đề <b>được nêu đích danh</b> trong bản study guide này đều đã có trong tài liệu của repo: database watcher, ledger, Always Encrypted với VBS enclaves, Change Tracking/CDC, IQP, Arc-enabled SQL (<a href="/dp-300/documents#s6a">mục 6a</a>), SQL Database trong Fabric (<a href="/dp-300/documents#s6b">mục 6b</a>), elastic jobs và Resource Governor — sai câu nào thuộc nhóm này thì lần theo link ở cột phải. Rà lại ngày <b>26/08/2026</b> đã bổ sung chín mục cho những gạch đầu dòng còn mỏng: <a href="#t112">configure table partitioning</a>, <a href="#t113">MI link</a>, <a href="#t214">phân quyền bằng T-SQL</a>, <a href="#t215">object-level encryption</a>, <a href="#t313">Extended Events</a>, <a href="#t314">server settings</a>, <a href="#t407">monitor và troubleshoot deployment</a>, <a href="#t510">replica đọc và AG trên MI</a>, <a href="#t511">contained AG</a>, <a href="#t216">xác thực trên Azure VM</a>, <a href="#t315">scale compute và storage</a>. Nguồn đối chiếu: study guide DP-300 và trang chứng chỉ Azure Database Administrator Associate trên Microsoft Learn, đọc ngày 21/08/2026.</p>
</section>
...
<tr><td>Dung lượng</td><td>Tới 4 TB, Hyperscale tới 128 TB (trong elastic pool: 100 TB)</td><td>Tới 16 TB / instance (Next-gen GP: 32 TB), 100 database (Next-gen GP: 500)</td><td>Instance tới 256 TB</td></tr>
...
<tr><td>Hyperscale</td><td>Database rất lớn, storage scale theo nhu cầu</td><td>Tới 128 TB — trong elastic pool là 100 TB; chỉ có ở SQL Database; SLA 99,9% (0 replica) / 99,95% (1 replica); vào rồi KHÔNG ra được</td></tr>
<tr><td>Managed Instance GP / BC</td><td>MI chỉ có đúng hai tier này</td><td>80 vCore, 400 GB memory, 100 database, 16 TB (Next-gen GP: 500 database, 32 TB); KHÔNG có Hyperscale, KHÔNG có DTU</td></tr>
</table></div>
<div class="tw"><table class="cmp">
...
<section id="t105">
<h3>Dòng VM và SLA<a class="nl" href="/dp-300/documents#s11">docs 1.10</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=SQL%20on%20VM,SLA" title="Ôn 16 câu: SQL on VM, SLA (tab mới)">ôn 16 câu</a></h3>
<div class="tw"><table class="cmp">
...
<tr><td>Giữ nhiều database đồng bộ</td><td>SQL Data Sync</td><td>Hub phải là Azure SQL Database; bảng cần primary key; KHÔNG dùng với MI. <b>Khai tử 30/09/2027</b> — hướng thay: replication, ADF, AG</td></tr>
...
<p class="lead">Đề nói "downtime tối thiểu", "đích là Business Critical" hoặc "fail back về SQL Server" thì đáp án là <a href="#t113">Managed Instance link</a>, không phải DMS hay backup/restore.</p>
</section>
...
<tr><td><b>SQL Data Sync</b></td><td><b>Đồng bộ lâu dài</b> · Giữ nhiều database <b>đồng bộ hai chiều</b> lâu dài</td><td>SQL DB ↔ SQL Server / SQL DB</td><td>Không áp dụng</td><td>Không</td><td>Hub phải là Azure SQL Database; bảng cần primary key; <b>KHÔNG dùng với MI</b>. <b>Khai tử 30/09/2027</b></td></tr>
</table></div>
...
<p class="lead">Phần triển khai bằng T-SQL — partition function, scheme, SPLIT/MERGE, SWITCH — nằm ở <a href="#t112">Table partitioning · triển khai</a>.</p>
</section>
...
<section id="t112">
<h3>Table partitioning — triển khai bằng T-SQL<a class="nl" href="/dp-300/documents#s7">docs 1.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Partitioning" title="Ôn 8 câu: Partitioning (tab mới)">ôn 8 câu</a></h3>
<p class="lead">Study guide tách riêng hai gạch đầu dòng: <i>Plan for table partitioning</i> (phạm vi 1, phần lập kế hoạch) và <b><i>Configure table partitioning</i></b> (phần triển khai). Phần lập kế hoạch nằm ở <a href="#t108">Phân vùng và sharding</a>; bảng này là phần triển khai. Nguồn: <i>Partitioned tables and indexes</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Bước</th><th>Lệnh</th><th>Ghi nhớ</th></tr>
<tr><td>1 · Filegroup (tùy chọn)</td><td><code>ALTER DATABASE … ADD FILEGROUP / ADD FILE</code></td><td>Chỉ cần khi muốn tiered storage hoặc backup/restore từng filegroup. Không có nhu cầu đó thì <b>một filegroup cho tất cả</b> là khuyến nghị chính thức</td></tr>
<tr><td>2 · Partition function</td><td><code>CREATE PARTITION FUNCTION pf (date) AS RANGE RIGHT FOR VALUES ('2026-01-01', …)</code></td><td>Định nghĩa <b>số partition và ranh giới</b>. n boundary value → n+1 partition. Nhận đúng <b>một</b> cột</td></tr>
<tr><td>3 · Partition scheme</td><td><code>CREATE PARTITION SCHEME ps AS PARTITION pf ALL TO ([PRIMARY])</code></td><td>Ánh xạ partition → filegroup. <code>ALL TO</code> = dồn hết vào một filegroup</td></tr>
<tr><td>4 · Gắn vào bảng/index</td><td><code>CREATE TABLE … ON ps(OrderDate)</code> hoặc <code>CREATE INDEX … ON ps(OrderDate)</code></td><td>Bảng đã có sẵn thì tạo lại clustered index <code>ON ps(col)</code> để chuyển bảng sang scheme</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>RANGE LEFT vs RIGHT</th><th>Boundary value thuộc về</th><th>Khi nào dùng</th></tr>
<tr><td>RANGE LEFT (<b>mặc định</b> nếu không ghi)</td><td>Partition <b>bên trái</b> — là giá trị lớn nhất của partition đó (<code>col &lt;= boundary</code>)</td><td>Ranh giới kiểu "cuối tháng" (31/01, 28/02…)</td></tr>
<tr><td>RANGE RIGHT</td><td>Partition <b>bên phải</b> — là giá trị nhỏ nhất của partition đó (<code>col &gt;= boundary</code>)</td><td>Cột <code>date</code>/<code>datetime</code>: ranh giới đặt ngày 1 đầu tháng, dòng lúc 00:00 nằm chung partition với cả ngày hôm đó</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Bảo trì partition</th><th>Lệnh</th><th>Bẫy</th></tr>
<tr><td>Thêm partition mới</td><td><code>ALTER PARTITION SCHEME ps NEXT USED [FG]</code> rồi <code>ALTER PARTITION FUNCTION pf() SPLIT RANGE ('2027-01-01')</code></td><td><b>NEXT USED phải chạy TRƯỚC SPLIT</b>, nếu không SPLIT lỗi. Luôn split một partition <b>rỗng</b>, split partition có dữ liệu là phải move dữ liệu và ghi log rất nhiều</td></tr>
<tr><td>Gộp partition</td><td><code>ALTER PARTITION FUNCTION pf() MERGE RANGE ('2025-01-01')</code></td><td>Xóa boundary value đó; dữ liệu hai bên dồn vào một partition</td></tr>
<tr><td>Đưa dữ liệu ra/vào (sliding window)</td><td><code>ALTER TABLE Sales SWITCH PARTITION 2 TO SalesArchive PARTITION 2</code></td><td>Chỉ đổi <b>metadata</b> nên gần như tức thì, kể cả với bảng rất lớn — đây là lý do chính người ta partition</td></tr>
<tr><td>Xóa dữ liệu một partition</td><td><code>TRUNCATE TABLE Sales WITH (PARTITIONS (2, 4 TO 6))</code></td><td>Nhanh hơn DELETE và không cần bảng staging như SWITCH</td></tr>
<tr><td>Xem dòng nằm ở partition nào</td><td><code>SELECT $PARTITION.pf(OrderDate), COUNT(*) FROM … GROUP BY $PARTITION.pf(OrderDate)</code></td><td>Cùng với <code>sys.partitions</code> / <code>sys.dm_db_index_physical_stats</code> là cách kiểm tra phân bố</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Điều kiện SWITCH được</th><th>Chi tiết</th></tr>
<tr><td>Cùng filegroup</td><td>Partition nguồn và đích — kể cả index tương ứng — phải nằm cùng filegroup</td></tr>
<tr><td>Đích rỗng</td><td>Partition (hoặc bảng) đích phải tồn tại và <b>không có dòng nào</b></td></tr>
<tr><td>Cùng cấu trúc</td><td>Cùng cột, cùng kiểu, cùng nullability, cùng collation; đích không được có FK trỏ tới</td></tr>
<tr><td>Index aligned</td><td>Mọi index của bảng phải nằm trên <b>cùng partition scheme</b>. Non-aligned index là lý do SWITCH thất bại phổ biến nhất</td></tr>
<tr><td>Có CHECK constraint</td><td>Bảng đích cần CHECK constraint đảm bảo dữ liệu rơi đúng khoảng của partition nhận</td></tr>
<tr><td>Chờ khóa lịch sự</td><td><code>WITH (WAIT_AT_LOW_PRIORITY (MAX_DURATION = 5 MINUTES, ABORT_AFTER_WAIT = BLOCKERS))</code></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Quy tắc và giới hạn</th><th>Nội dung</th></tr>
<tr><td>Cột partition phải nằm trong key</td><td>Clustered index <b>unique</b> và nonclustered index <b>unique</b>: phải tự tay đưa cột partition vào key. Index không unique: engine tự thêm cột partition (vào key với clustered, vào included column với nonclustered)</td></tr>
<tr><td>Kiểu dữ liệu không dùng được</td><td><code>timestamp</code>, các kiểu LOB (<code>varchar(max)</code>, <code>nvarchar(max)</code>, <code>xml</code>, <code>text</code>, <code>image</code>, <code>varbinary(max)</code>), CLR UDT và alias type. Computed column phải là <code>PERSISTED</code></td></tr>
<tr><td>Số partition tối đa</td><td><b>15.000</b> mỗi bảng/index. Microsoft khuyến cáo tránh thiết kế hàng trăm–hàng nghìn partition trừ khi thật cần; ≥16 GB RAM nếu dùng nhiều partition</td></tr>
<tr><td>Azure SQL Database</td><td>Mọi service tier đều partition được, nhưng <b>chỉ có filegroup PRIMARY</b> → luôn <code>ALL TO ([PRIMARY])</code>. MI và SQL Server thì tạo filegroup được</td></tr>
<tr><td>NULL nằm ở đâu</td><td>Partition ngoài cùng bên trái. Trừ khi boundary đầu tiên là NULL và dùng RANGE RIGHT — khi đó partition 1 rỗng và NULL rơi vào partition 2</td></tr>
<tr><td>Statistics</td><td>Tạo/rebuild index đã partition chỉ lấy statistics theo <b>default sampling</b>, không full scan như index không partition → cần <code>UPDATE STATISTICS … WITH FULLSCAN</code> nếu muốn chính xác</td></tr>
<tr><td>Giảm blocking</td><td><code>ALTER TABLE … SET (LOCK_ESCALATION = AUTO)</code> cho phép leo khóa dừng ở mức <b>partition</b> thay vì cả bảng</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> partition <i>không</i> tự làm query nhanh hơn — chỉ nhanh khi predicate có cột partition (partition elimination). Query lọc theo cột khác, hoặc <code>TOP/MIN/MAX</code> trên cột khác, phải quét mọi partition nên <b>chậm hơn</b> bảng không partition; vì thế OLTP hiếm khi hưởng lợi. Lợi ích chắc chắn là ở <b>bảo trì</b>: SWITCH, TRUNCATE theo partition, rebuild/nén từng partition.</p>
</section>

<section id="t113">
<h3>Managed Instance link — di trú online và DR hai chiều<a class="nl" href="/dp-300/documents#s15">docs 1.17</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Migration,Hybrid%20HADR" title="Ôn 24 câu: Migration, Hybrid HADR (tab mới)">ôn 24 câu</a></h3>
<p class="lead">Cách di trú lên MI có downtime thấp nhất hiện nay, đồng thời là giải pháp DR hybrid duy nhất cho phép <b>fail back về SQL Server</b>. Bên dưới chạy bằng <b>distributed availability group</b> — nên mọi giới hạn của DAG đều áp dụng. Nguồn: <i>Managed Instance link overview</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Phiên bản SQL Server</th><th>Làm được gì</th></tr>
<tr><td>2008 – 2014</td><td><b>Không hỗ trợ</b> — chưa có distributed availability group</td></tr>
<tr><td>2016 SP3 (+ Azure Connect pack), 2017 CU31 (+ pack), 2019 CU20</td><td>Replication <b>một chiều</b> SQL Server → MI. Fail over sang MI được nhưng <b>đứt link, không fail back</b>; muốn về phải dùng transactional replication hoặc bacpac. SQL Server 2016 chỉ chạy trên Windows</td></tr>
<tr><td>2022 (RTM trở lên), 2025</td><td><b>Hai chiều</b>: bên nào cũng có thể là primary ban đầu, fail over và <b>fail back online</b> qua chính link. Tạo link <i>từ</i> MI cần SQL Server 2022 <b>CU10</b>; fail over bằng T-SQL cần <b>CU13</b></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Yêu cầu</th><th>Chi tiết</th></tr>
<tr><td>Mạng</td><td>VPN hoặc ExpressRoute nếu SQL Server on-prem; VNet peering nếu trên Azure VM. Link <b>chỉ dùng VNet-local endpoint</b> của MI — public endpoint và private endpoint đều không tạo link được</td></tr>
<tr><td>Cổng</td><td>Database mirroring endpoint, mặc định <b>5022</b>. Nhiều instance trên một máy thì mỗi instance một endpoint và một cổng riêng</td></tr>
<tr><td>Xác thực</td><td><b>Chỉ certificate</b> — hai bên trao đổi public key. Không dùng được Windows authentication</td></tr>
<tr><td>Service tier của MI</td><td>General Purpose và Business Critical đều được. Link là lối duy nhất di trú <b>online thật sự vào Business Critical</b></td></tr>
<tr><td>Update policy của MI</td><td>Muốn tạo link <i>từ</i> MI hoặc fail back về SQL Server thì MI phải đặt update policy <b>SQL Server 2022</b> hoặc <b>2025</b> tương ứng. Policy <b>Always-up-to-date</b> thì fail over sang MI xong là <b>không quay lại được</b></td></tr>
<tr><td>TDE</td><td>DB nguồn có TDE: phải export key lên Azure Key Vault và bật <b>BYOK</b> ở MI trước khi tạo link. Chiều MI → SQL Server: DB mã hóa bằng <b>service-managed key</b> thì không link được, phải là customer-managed key</td></tr>
<tr><td>Công cụ</td><td>Wizard trong SSMS bản mới nhất (dễ nhất), hoặc script bằng Az.Sql / Azure CLI</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Giới hạn hay bị hỏi</th><th>Nội dung</th></tr>
<tr><td>Phạm vi link</td><td><b>Một link = một database</b>. Nhiều DB thì tạo nhiều link. AG có sẵn nhiều DB thì phải rút còn một DB mới link được</td></tr>
<tr><td>Số link tối đa</td><td><b>100</b> với General Purpose và Business Critical, <b>500</b> với Next-gen General Purpose</td></tr>
<tr><td>Kích thước DB</td><td>Bao nhiêu cũng được, miễn vừa storage đã chọn của MI</td></tr>
<tr><td>Không đi theo link</td><td>System database, login, SQL Agent job, object cấp server — phải chuyển tay</td></tr>
<tr><td>Xung khắc</td><td><b>Không dùng chung với failover group</b>: MI đang trong failover group thì không tạo link được và ngược lại</td></tr>
<tr><td>Không replicate được</td><td>DB có <b>nhiều log file</b>, FileTable/FILESTREAM. In-Memory OLTP chỉ vào được <b>Business Critical</b></td></tr>
<tr><td>DB ở MI khi đang link</td><td><b>Chỉ đọc</b> — dùng để offload báo cáo/analytics. MI vẫn chạy song song các DB read/write khác bình thường</td></tr>
<tr><td>Backup</td><td>MI tự backup DB đã replicate (full + log, <b>không có differential</b> → restore lâu hơn), PITR được như DB thường</td></tr>
<tr><td>Chi phí replica DR</td><td>MI thứ hai chỉ dùng làm DR passive thì được miễn phí license vCore theo <b>hybrid failover benefit</b></td></tr>
</table></div>
<p class="lead">So với các cách khác: <a href="#t106">bảng chọn công cụ di trú</a> — DMS/LRS đưa lên được General Purpose với downtime ngắn, backup/restore là offline; <b>link</b> là lựa chọn khi đề nói "downtime tối thiểu", "vẫn chạy production trong lúc di trú", hoặc "đích là Business Critical". Đề nhắc <i>fail back về SQL Server</i> thì đáp án buộc phải là <b>SQL Server 2022/2025</b>.</p>
</section>

<h2 class="dom" id="d2">Phạm vi 2 · Môi trường bảo mật</h2>

<section id="t201">
<h3>Bảo vệ dữ liệu — chọn cơ chế bằng câu hỏi "ai KHÔNG được đọc plaintext?"<a class="nl" href="/dp-300/documents#s-sec2">docs 2.1</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=TDE,Always%20Encrypted,Dynamic%20Data%20Masking,RLS,Ledger,Object%20encryption" title="Ôn 54 câu: TDE, Always Encrypted, Dynamic Data Masking, RLS, Ledger, Object encryption (tab mới)">ôn 54 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t202">
<h3>TDE — đặt ở đâu, bật bằng gì<a class="nl" href="/dp-300/documents#s30">docs 2.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=TDE,Key%20Vault" title="Ôn 13 câu: TDE, Key Vault (tab mới)">ôn 13 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t203">
<h3>Always Encrypted và secure enclave<a class="nl" href="/dp-300/documents#s33">docs 2.14</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Always%20Encrypted,Secure%20enclaves" title="Ôn 13 câu: Always Encrypted, Secure enclaves (tab mới)">ôn 13 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t204">
<h3>Dynamic Data Masking — các kiểu mask<a class="nl" href="/dp-300/documents#s34">docs 2.16</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Dynamic%20Data%20Masking" title="Ôn 9 câu: Dynamic Data Masking (tab mới)">ôn 9 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t208">
<h3>Row-Level Security — chuỗi 5 bước<a class="nl" href="/dp-300/documents#s42">docs 2.28</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=RLS" title="Ôn 15 câu: RLS (tab mới)">ôn 15 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t211">
<h3>Mạng và kết nối<a class="nl" href="/dp-300/documents#s32">docs 2.20</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Firewall,Private%20Link,TLS" title="Ôn 17 câu: Firewall, Private Link, TLS (tab mới)">ôn 17 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t213">
<h3>Khác biệt bảo mật giữa ba nền tảng — chỗ đề thi hay gài<a class="nl" href="/dp-300/documents#s6">docs 1.2</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=TDE,Auditing,Certificates" title="Ôn 19 câu: TDE, Auditing, Certificates (tab mới)">ôn 19 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t214">
<h3>Quản trị xác thực và phân quyền bằng T-SQL<a class="nl" href="/dp-300/documents#s29-2">docs 2.8</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Permissions,Users%20%26%20logins" title="Ôn 19 câu: Permissions, Users &amp; logins (tab mới)">ôn 19 câu</a></h3>
<p class="lead">Study guide bản 24/04/2026 thêm hẳn một gạch đầu dòng <i>Manage authentication and authorization by using T-SQL</i> — nghĩa là đề hỏi đúng câu lệnh chứ không chỉ hỏi khái niệm. Ai làm được gì thì xem <a href="#t206">server role</a> và <a href="#t207">database role</a>; bảng này là <b>cú pháp</b>. Nguồn: <i>GRANT</i>, <i>REVOKE</i>, <i>Troubleshoot orphaned users</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Việc</th><th>Lệnh</th><th>Chạy ở đâu / lưu ý</th></tr>
<tr><td>Tạo login SQL</td><td><code>CREATE LOGIN app WITH PASSWORD = '…'</code></td><td>Trong <b>master</b>. Azure SQL Database: master ảo, và <b>không USE được</b> — phải mở kết nối riêng tới master rồi kết nối lại vào user database</td></tr>
<tr><td>Tạo user map từ login</td><td><code>CREATE USER app FOR LOGIN app</code></td><td>Trong user database. Đây là user có thể bị <b>orphan</b> khi đổi server</td></tr>
<tr><td>Tạo contained user (không login)</td><td><code>CREATE USER app WITH PASSWORD = '…'</code></td><td>Azure SQL Database và contained database của SQL Server. <b>Không bao giờ orphan</b> — cách Microsoft khuyến nghị cho database hay bị di chuyển</td></tr>
<tr><td>User Entra ID</td><td>SQL DB: <code>CREATE USER [an@cty.com] FROM EXTERNAL PROVIDER</code> · MI/SQL Server: <code>CREATE LOGIN … FROM EXTERNAL PROVIDER</code> rồi <code>CREATE USER … FROM LOGIN</code></td><td>Người chạy phải đăng nhập <b>bằng chính danh tính Entra</b>, không dùng SQL auth được</td></tr>
<tr><td>User chỉ để mượn danh</td><td><code>CREATE USER kiemthu WITHOUT LOGIN</code></td><td>Dùng cho <code>EXECUTE AS USER</code> và cho ownership chaining — không đăng nhập từ ngoài được</td></tr>
<tr><td>Thêm/bớt thành viên role</td><td><code>ALTER ROLE db_datareader ADD MEMBER app</code> · <code>DROP MEMBER</code></td><td><code>sp_addrolemember</code> / <code>sp_droprolemember</code> đã <b>deprecated</b> — đáp án chọn chúng gần như luôn sai</td></tr>
<tr><td>Custom role</td><td><code>CREATE ROLE bao_cao</code> rồi <code>GRANT SELECT ON SCHEMA::Sales TO bao_cao</code></td><td>Cấp quyền cho <b>role</b> chứ không cho từng user — đó là cách áp least privilege</td></tr>
<tr><td>Server role dạng <code>##MS_…##</code></td><td><code>ALTER SERVER ROLE ##MS_ServerStateReader## ADD MEMBER [giam_sat]</code></td><td>Trong master của Azure SQL Database (và SQL Server 2022+). Đổi thành viên có hiệu lực trễ tới 5 phút — xem <a href="#t206">t206</a></td></tr>
<tr><td>Đổi mật khẩu / vô hiệu hoá login</td><td><code>ALTER LOGIN app WITH PASSWORD = '…'</code> · <code>ALTER LOGIN app DISABLE</code></td><td>Ai cũng đổi được mật khẩu của chính mình; đổi của người khác cần <b>ALTER ANY LOGIN</b>; đổi của thành viên sysadmin thì phải là sysadmin</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>GRANT / DENY / REVOKE</th><th>Nội dung</th></tr>
<tr><td>Khung chung</td><td><code>GRANT &lt;quyền&gt; ON &lt;class&gt;::&lt;object&gt; TO &lt;principal&gt;</code> — bỏ <code>class::</code> thì mặc định là object. Ví dụ <code>GRANT EXECUTE ON OBJECT::dbo.spTinhLuong TO bao_cao</code></td></tr>
<tr><td><code>WITH GRANT OPTION</code></td><td>Người nhận được phép <b>cấp tiếp</b> quyền đó cho người khác</td></tr>
<tr><td><code>AS &lt;principal&gt;</code></td><td>Ghi grantor là người khác. <b>Bắt buộc</b> khi quyền được cấp cho một role/Windows group kèm GRANT OPTION mà thành viên muốn cấp tiếp: <code>GRANT EXECUTE ON spX TO User2 AS TesterRole</code>. Dùng <code>AS</code> <b>không</b> đồng nghĩa với được mượn danh</td></tr>
<tr><td>DENY thắng GRANT</td><td>Đúng cho cùng scope và cho scope <b>rộng hơn</b> chứa securable đó. <b>Ngoại lệ ghi rõ trong docs</b>: DENY cấp bảng KHÔNG thắng GRANT cấp cột (bất nhất được giữ lại vì tương thích ngược)</td></tr>
<tr><td>GRANT xoá dấu vết cũ</td><td>Cấp lại một quyền sẽ gỡ luôn DENY/REVOKE của chính quyền đó trên securable đó — nhưng REVOKE ở scope rộng hơn thì không lan xuống</td></tr>
<tr><td><code>REVOKE</code></td><td>Gỡ cả GRANT lẫn DENY. <b>REVOKE ≠ DENY</b>: người đó vẫn có quyền nếu được cấp qua đường khác</td></tr>
<tr><td><code>GRANT OPTION FOR … CASCADE</code></td><td>Thu hồi quyền đã cấp kèm GRANT OPTION thì <b>bắt buộc</b> có CASCADE, không thì lệnh REVOKE <b>thất bại</b>. CASCADE gỡ luôn ở những người mà principal đó đã cấp tiếp — và gỡ cả GRANT lẫn DENY của họ. Chỉ muốn cấm cấp tiếp mà giữ quyền dùng thì dùng <code>REVOKE GRANT OPTION FOR</code></td></tr>
<tr><td><code>GRANT ALL</code></td><td><b>Deprecated</b> và không hề cấp mọi quyền — chỉ là một danh sách cố định (bảng: DELETE, INSERT, REFERENCES, SELECT, UPDATE)</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Orphaned user</th><th>Cách làm</th></tr>
<tr><td>Vì sao xảy ra</td><td>User trong database trỏ tới <b>SID</b> của một login không còn trong master — restore/attach sang instance khác, hoặc login bị xoá. Tạo lại login cùng tên vẫn <b>không cứu được</b> vì SID mới khác</td></tr>
<tr><td>Phát hiện (SQL Server, MI)</td><td><code>SELECT dp.name, dp.sid FROM sys.database_principals dp LEFT JOIN sys.server_principals sp ON dp.sid = sp.sid WHERE sp.sid IS NULL AND dp.authentication_type_desc = 'INSTANCE'</code></td></tr>
<tr><td>Phát hiện (Azure SQL Database)</td><td>Không có <code>sys.server_principals</code> — lấy SID từ <code>sys.sql_logins</code> trong master rồi so với <code>sys.database_principals</code> trong user database</td></tr>
<tr><td>Sửa — đã có login</td><td><code>ALTER USER nguoidung WITH LOGIN = login_moi</code></td></tr>
<tr><td>Sửa — login đã mất</td><td><code>CREATE LOGIN … WITH PASSWORD = '…', SID = 0x…</code> (lấy đúng SID của user) chạy trong master</td></tr>
<tr><td>Cách cũ đã bỏ</td><td><code>sp_change_users_login</code> ('Report' / 'Auto_Fix' / 'Update_One') — <b>deprecated</b>, thay bằng hai dòng trên</td></tr>
<tr><td>Phòng từ đầu</td><td>Dùng <b>contained database user</b> cho database có thể phải di chuyển</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề cho Azure SQL Database rồi đưa một script chạy liền mạch <code>CREATE LOGIN</code> → <code>CREATE USER</code> thì script đó <b>sai</b> — hai lệnh nằm ở hai database khác nhau và Azure SQL Database không có <code>USE</code>. Kiểm chứng quyền sau khi cấp thì chỉ có một cách đáng tin: <code>EXECUTE AS USER = '…'</code> … <code>REVERT</code> (xem <a href="#t207">t207</a>), không phải đọc <code>sys.database_permissions</code>.</p>
</section>

<section id="t215">
<h3>Mã hoá cấp cột và cây khoá — SMK, DMK, certificate, symmetric key<a class="nl" href="/dp-300/documents#s31">docs 2.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Object%20encryption,Certificates" title="Ôn 8 câu: Object encryption, Certificates (tab mới)">ôn 8 câu</a></h3>
<p class="lead">Study guide gọi là <i>Implement object-level encryption</i>, tài liệu gọi là column-level hoặc cell-level encryption. Chọn cơ chế nào thì xem <a href="#t201">bảng t201</a>; bảng này là cây khoá và chuỗi lệnh. Cây khoá cũng chính là thứ giải thích vì sao restore một database mã hoá sang server khác thì đọc ra rác. Nguồn: <i>Encryption hierarchy</i>, <i>Encrypt a column of data</i>, <i>CREATE MASTER KEY</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Tầng</th><th>Được cái gì bảo vệ</th><th>Lệnh liên quan</th></tr>
<tr><td><b>Service Master Key (SMK)</b> — gốc của cả cây, một cái cho mỗi instance</td><td>Windows <b>DPAPI</b>; SQL Server setup tạo tự động</td><td><code>BACKUP SERVICE MASTER KEY</code> (chỉ SQL Server/VM). Trên Azure SQL do nền tảng quản</td></tr>
<tr><td><b>Database Master Key (DMK)</b> — một cái cho mỗi database</td><td>Password bạn đặt, <b>và</b> một bản sao mã hoá bằng SMK (để mở tự động)</td><td><code>CREATE MASTER KEY ENCRYPTION BY PASSWORD = '…'</code> · <code>OPEN MASTER KEY DECRYPTION BY PASSWORD</code> · <code>BACKUP MASTER KEY</code> · <code>ALTER MASTER KEY ADD/DROP ENCRYPTION BY SERVICE MASTER KEY</code></td></tr>
<tr><td><b>Certificate</b> hoặc <b>asymmetric key</b></td><td>DMK</td><td><code>CREATE CERTIFICATE c WITH SUBJECT = '…'</code> · <code>BACKUP CERTIFICATE … WITH PRIVATE KEY</code></td></tr>
<tr><td><b>Symmetric key</b></td><td>Certificate / asymmetric key (hoặc password)</td><td><code>CREATE SYMMETRIC KEY k WITH ALGORITHM = AES_256 ENCRYPTION BY CERTIFICATE c</code></td></tr>
<tr><td><b>Dữ liệu</b></td><td>Symmetric key</td><td><code>ENCRYPTBYKEY</code> / <code>DECRYPTBYKEY</code></td></tr>
<tr><td>EKM / Azure Key Vault</td><td>Giữ symmetric hoặc asymmetric key <b>ngoài</b> SQL Server, thay cho khoá lưu trong database</td><td>Là cách TDE dùng customer-managed key (BYOK)</td></tr>
</table></div>
<p class="lead">Hai điều docs nói thẳng: (1) <b>mã hoá dữ liệu bằng symmetric key</b>, đừng mã hoá thẳng bằng certificate hay asymmetric key vì chậm hơn nhiều; (2) TDE là một ca đặc biệt của chính cây này — DEK là symmetric key, được certificate trong <code>master</code> (mà certificate ấy được DMK của master bảo vệ) hoặc asymmetric key trong EKM bảo vệ.</p>
<div class="tw"><table class="cmp">
<tr><th>Bước</th><th>Lệnh</th></tr>
<tr><td>1 · DMK (nếu database chưa có)</td><td><code>CREATE MASTER KEY ENCRYPTION BY PASSWORD = '…';</code> — password <b>tùy chọn</b> trên Azure SQL Database, bắt buộc trên SQL Server/MI</td></tr>
<tr><td>2 · Certificate</td><td><code>CREATE CERTIFICATE TheCC WITH SUBJECT = 'Credit card numbers';</code></td></tr>
<tr><td>3 · Symmetric key</td><td><code>CREATE SYMMETRIC KEY CC_Key WITH ALGORITHM = AES_256 ENCRYPTION BY CERTIFICATE TheCC;</code></td></tr>
<tr><td>4 · Cột chứa bản mã</td><td><code>ALTER TABLE Sales.CreditCard ADD CardNumber_Enc varbinary(160);</code> — bắt buộc <b>varbinary</b></td></tr>
<tr><td>5 · Mở khoá rồi ghi</td><td><code>OPEN SYMMETRIC KEY CC_Key DECRYPTION BY CERTIFICATE TheCC;</code> rồi <code>UPDATE … SET CardNumber_Enc = EncryptByKey(Key_GUID('CC_Key'), CardNumber);</code></td></tr>
<tr><td>6 · Đọc lại</td><td>Mở khoá như trên rồi <code>CONVERT(nvarchar, DecryptByKey(CardNumber_Enc))</code></td></tr>
<tr><td>7 · Đóng</td><td><code>CLOSE SYMMETRIC KEY CC_Key;</code> (hoặc <code>CLOSE ALL SYMMETRIC KEYS</code>) — khoá mở theo <b>phiên</b></td></tr>
<tr><td>Chống tráo giá trị giữa các dòng</td><td>Thêm authenticator: <code>EncryptByKey(Key_GUID('CC_Key'), CardNumber, 1, HASHBYTES('SHA2_256', CONVERT(varbinary, CreditCardID)))</code> — DECRYPTBYKEY phải truyền đúng ba tham số đó</td></tr>
<tr><td>Mã hoá một lần, không cần khoá</td><td><code>ENCRYPTBYPASSPHRASE</code> / <code>DECRYPTBYPASSPHRASE</code></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Chi tiết hay bị hỏi</th><th>Nội dung</th></tr>
<tr><td>Quyền cần có</td><td><b>CONTROL</b> trên database (đủ để <code>CREATE MASTER KEY</code>), <b>CREATE CERTIFICATE</b> trên database, <b>ALTER</b> trên bảng, và có quyền trên khoá (không bị DENY <code>VIEW DEFINITION</code>)</td></tr>
<tr><td>Ai sở hữu certificate được</td><td>Chỉ login Windows, login SQL Server và application role — <b>group và role không sở hữu certificate được</b></td></tr>
<tr><td>Kiểm tra khoá</td><td><code>SELECT * FROM sys.symmetric_keys</code> (DMK hiện ra với tên <code>##MS_DatabaseMasterKey##</code>) · <code>sys.certificates</code> · cột <code>is_master_key_encrypted_by_server</code> trong <code>sys.databases</code> cho biết DMK có mở tự động được không</td></tr>
<tr><td>Chuyển database sang server khác</td><td>Bản sao DMK trong database vẫn được <b>SMK của server cũ</b> mã hoá → ở server mới phải làm một trong ba: <code>OPEN MASTER KEY DECRYPTION BY PASSWORD</code> (rồi <code>ALTER MASTER KEY ADD ENCRYPTION BY SERVICE MASTER KEY</code> cho lần sau tự mở), restore bản backup của DMK, hoặc restore SMK cũ</td></tr>
<tr><td>Azure SQL Database</td><td>Password của DMK là tùy chọn vì phần bảo vệ bằng SMK do Azure quản; <b>không tạo được DMK trong master ảo</b>; DMK có thể được tạo tự động khi bạn tạo database scoped credential (cho audit, event_file…) với password ngẫu nhiên mà <b>không ai lấy lại được</b> — nên tạo DMK trước cho chủ động</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> quên <code>OPEN SYMMETRIC KEY</code> thì <code>DECRYPTBYKEY</code> trả về <b>NULL</b> chứ không báo lỗi — triệu chứng "cột bỗng nhiên rỗng" trong đề thường là chuyện này. Và cell-level encryption <b>không sargable</b>: cột đã mã hoá thì <code>WHERE</code>, <code>JOIN</code>, index trên giá trị gốc đều vô dụng — cần so sánh được thì đáp án là <a href="#t203">Always Encrypted deterministic</a>, không phải ENCRYPTBYKEY.</p>
</section>

<section id="t216">
<h3>Xác thực cho SQL Server trên Azure VM — Entra ID và Windows<a class="nl" href="/dp-300/documents#s23a">docs 2.3</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Authentication,SQL%20on%20VM" title="Ôn 18 câu: Authentication, SQL on VM (tab mới)">ôn 18 câu</a></h3>
<p class="lead">Study guide tách riêng <i>Configure authentication for SQL on Azure VMs and Azure SQL Managed Instance</i> — nhưng notes mục 2.3 chỉ ghi "xem mục 23", nên phần <b>VM</b> nằm ở đây. Phần Azure SQL Database và MI xem <a href="#t205">t205</a>. Nguồn: <i>Enable Microsoft Entra authentication — SQL Server on Azure VMs</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Nền tảng</th><th>Xác thực dùng được</th><th>Cơ chế</th></tr>
<tr><td>SQL Server trên Azure VM</td><td>Windows authentication (VM join domain) · SQL authentication · <b>Entra ID từ SQL Server 2022</b></td><td>Entra ID đi qua <b>SQL IaaS Agent extension</b> + <b>managed identity</b> của VM</td></tr>
<tr><td>SQL Server trên VM <b>ngoài</b> Azure hoặc máy chủ vật lý</td><td>Như trên, nhưng Entra ID đi đường khác</td><td>Phải là máy <b>Arc-enabled</b> — <a href="#t110">Azure Arc</a>, không phải SQL IaaS Agent extension</td></tr>
<tr><td>Managed Instance</td><td>SQL authentication · Entra ID</td><td><code>CREATE LOGIN … FROM EXTERNAL PROVIDER</code>; xem <a href="#t205">t205</a></td></tr>
<tr><td>Azure SQL Database</td><td>SQL authentication · Entra ID</td><td>Contained user: <code>CREATE USER … FROM EXTERNAL PROVIDER</code></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Điều kiện bật Entra ID trên SQL Server VM</th><th>Chi tiết</th></tr>
<tr><td>Phiên bản</td><td><b>SQL Server 2022 trở lên</b>, chạy trên <b>Windows</b>. Deploy ở cloud nào cũng được</td></tr>
<tr><td>Đăng ký extension</td><td>VM phải đăng ký với <b>SQL IaaS Agent extension</b>. Đây là chỗ đề hay gài: VM trong Azure <b>không</b> dùng Azure Arc</td></tr>
<tr><td>Managed identity</td><td>Cần một managed identity <b>cùng tenant</b>: <b>system-assigned</b> (đơn giản, sống chết theo VM) hoặc <b>user-assigned</b> (gắn được cho nhiều VM — chọn khi có nhiều SQL Server VM)</td></tr>
<tr><td>Quyền của identity đó</td><td>Ba app role của Microsoft Graph: <code>User.Read.All</code>, <code>GroupMember.Read.All</code>, <code>Application.Read.All</code> — <b>hoặc</b> gán role <b>Directory Readers</b> của Entra ID (gán thẳng, hoặc cho identity vào một group đã có role đó)</td></tr>
<tr><td>Mạng ra ngoài</td><td>SQL Server <b>và</b> client đều phải ra được Entra ID và Microsoft Graph: mở outbound <b>80, 443</b>; NSG cần rule Allow với service tag <b>AzureActiveDirectory</b></td></tr>
<tr><td>Bật bằng gì</td><td>Portal: SQL virtual machines → <b>Security Configuration</b> → Microsoft Entra authentication → chọn kiểu identity · CLI: <code>az sql vm enable-azure-ad-auth</code> (kiểm trước bằng <code>az sql vm validate-azure-ad-auth</code>) · PowerShell: <code>Update-AzSqlVM -IdentityType SystemAssigned|UserAssigned</code></td></tr>
<tr><td>Sau khi bật</td><td>Tạo principal như SQL Server thường: <code>CREATE LOGIN [an@cty.com] FROM EXTERNAL PROVIDER</code> rồi <code>CREATE USER … FROM LOGIN</code></td></tr>
<tr><td>Instance chưa đăng ký</td><td>Nhiều instance trên một VM: bật cho instance chưa đăng ký bằng <code>Set-AzVMExtension -ExtensionName "SqlIaasExtension"</code> với <code>EnableForGivenInstances</code> hoặc <code>EnableForAllInstances</code> — nhưng <b>vẫn phải có ít nhất một instance đã đăng ký</b></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Cách kết nối bằng Entra ID</th><th>Dùng khi</th></tr>
<tr><td>Password</td><td>Đăng nhập bằng chính tài khoản Entra</td></tr>
<tr><td>Universal with MFA</td><td>Bắt buộc xác thực đa yếu tố</td></tr>
<tr><td>Integrated</td><td>SSO qua federation provider (ADFS)</td></tr>
<tr><td>Service Principal</td><td>Ứng dụng Azure đăng nhập bằng app registration</td></tr>
<tr><td>Managed Identity</td><td>Ứng dụng có danh tính Entra gắn sẵn — không cần mật khẩu trong connection string</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Giới hạn</th><th>Nội dung</th></tr>
<tr><td>Failover cluster instance</td><td><b>Không hỗ trợ</b> Entra ID authentication</td></tr>
<tr><td>Bật rồi thì sao</td><td><b>Không có cách tắt</b> — chỉ đổi được sang managed identity khác</td></tr>
<tr><td>FIDO2</td><td>Chưa hỗ trợ</td></tr>
<tr><td>Quản trong portal</td><td>Chỉ với instance mà SQL IaaS Agent extension hỗ trợ (default instance hoặc một named instance) — instance khác phải dùng CLI/PowerShell</td></tr>
<tr><td>Lỗi hay gặp</td><td><i>"The selected managed identity does not have enough permissions for Microsoft Entra authentication"</i> = thiếu ba app role hoặc thiếu role Directory Readers</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề cho SQL Server <b>trên Azure VM</b> rồi đưa phương án "đăng ký máy với Azure Arc" — sai; Arc dành cho SQL Server <b>ngoài</b> Azure, còn VM trong Azure dùng <b>SQL IaaS Agent extension</b>. Ngược lại, đề cho SQL Server 2019 mà đáp án là bật Entra ID cũng sai: tính năng này bắt đầu từ <b>SQL Server 2022</b>.</p>
</section>

<h2 class="dom" id="d3">Phạm vi 3 · Giám sát &amp; tinh chỉnh</h2>

<section id="t301">
<h3>Công cụ giám sát nào trả lời câu hỏi nào<a class="nl" href="/dp-300/documents#s-sec3">docs 3.1</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Metrics,Query%20Store,Database%20watcher,Intelligent%20Insights,Query%20Perf%20Insight,SQL%20Insights" title="Ôn 36 câu: Metrics, Query Store, Database watcher, Intelligent Insights, Query Perf Insight, SQL Insights (tab mới)">ôn 36 câu</a></h3>
<div class="tw"><table class="cmp">
...
<tr><td><a href="#t313">Extended Events</a></td><td>Sự kiện chi tiết: blocking, deadlock, câu lệnh chạy lâu, missing column statistics</td><td>Có ở <b>cả ba</b> nền tảng — trên Azure SQL Database session là database-scoped (<code>ON DATABASE</code>); nhẹ hơn Profiler và là cách trace duy nhất còn được phát triển</td></tr>
...
<section id="t302">
<h3>DMV phải thuộc<a class="nl" href="/dp-300/documents#s60">docs 3.22</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=DMV" title="Ôn 33 câu: DMV (tab mới)">ôn 33 câu</a></h3>
<div class="tw"><table class="cmp">
...
<tr><td>sys.dm_user_db_resource_governance</td><td><b>Trần</b> mà resource governance đang áp cho database/elastic pool hiện tại: <code>primary_max_log_rate</code> và <code>pool_max_log_rate</code> (byte/giây), <code>primary_group_max_io</code> / <code>pool_max_io</code> (IOPS), <code>primary_group_max_workers</code>, <code>max_dop</code>. <b>Chỉ có trên Azure SQL Database</b> — MI dùng sys.dm_instance_resource_governance. Đây KHÔNG phải view về dung lượng lưu trữ</td></tr>
<tr><td>sys.server_resource_stats</td><td>Bản cho <b>Managed Instance</b> (MI không có sys.dm_db_resource_stats): một dòng mỗi 15 giây, giữ ~14 ngày, nhưng chỉ được gom và cập nhật mỗi 5–10 phút</td></tr>
<tr><td>sys.dm_db_wait_stats</td><td>Wait stats <b>cấp database</b> (Azure SQL Database / MI) — chỉ wait đã kết thúc của database hiện tại</td></tr>
<tr><td>sys.dm_exec_session_wait_stats</td><td>Cùng số liệu nhưng tách theo <code>session_id</code> (SQL Server 2016+) — dùng để soi một phiên cụ thể</td></tr>
<tr><td>sys.dm_db_log_space_usage + sys.databases.log_reuse_wait_desc</td><td>Log <b>to bao nhiêu / đã dùng bao nhiêu</b>, và <b>vì sao</b> không truncate được (ACTIVE_TRANSACTION, LOG_BACKUP, REPLICATION, AVAILABILITY_REPLICA…)</td></tr>
<tr><td>sys.dm_tran_active_snapshot_database_transactions</td><td><code>elapsed_time_seconds</code> — transaction snapshot chạy lâu nhất đang chặn dọn version store của tempdb</td></tr>
<tr><td>sys.dm_exec_query_memory_grants</td><td>Memory grant đang xin/đang giữ: <code>grant_time</code> NULL nghĩa là chưa được cấp, kèm <code>requested/granted/required_memory_kb</code> và <code>is_next_candidate</code></td></tr>
...
<section id="t303">
<h3>Wait type → nguyên nhân<a class="nl" href="/dp-300/documents#s60">docs 3.22</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Wait%20stats" title="Ôn 9 câu: Wait stats (tab mới)">ôn 9 câu</a></h3>
<div class="tw"><table class="cmp">
<tr><th>Wait type</th><th>Nghĩa là</th><th>Kiểm chứng / bước tiếp theo</th></tr>
<tr><td>LOG_RATE_GOVERNOR</td><td>Bị giới hạn tốc độ log — Azure SQL Database</td><td>So mức ghi thật với <code>primary_max_log_rate</code> trong sys.dm_user_db_resource_governance</td></tr>
<tr><td>POOL_LOG_RATE_GOVERNOR</td><td>Giới hạn log ở mức elastic pool</td><td><code>pool_max_log_rate</code> — trần của cả pool, không riêng database bạn</td></tr>
<tr><td>INSTANCE_LOG_GOVERNOR</td><td>Giới hạn log ở Managed Instance</td><td>sys.dm_instance_resource_governance</td></tr>
<tr><td>RBIO*</td><td>Log governance của Hyperscale</td><td>Chỉ gặp ở Hyperscale — nghẽn ở page server / log service</td></tr>
<tr><td>HADR_THROTTLE_LOG_RATE</td><td>Độ trễ ở Business Critical và geo-replication</td><td>Primary chờ replica bắt kịp — xem độ trễ replica</td></tr>
<tr><td>PAGEIOLATCH_*</td><td>Chờ <b>I/O</b> đọc page của file <b>data</b> lên buffer pool</td><td>Δ<code>io_stall_read_ms</code>/Δ<code>num_of_reads</code> trong sys.dm_io_virtual_file_stats. Có chữ <b>IO</b> trong tên mới là chuyện của đĩa</td></tr>
<tr><td>PAGELATCH_*</td><td>Tranh chấp latch <b>trong bộ nhớ</b> — kinh điển là allocation page của tempdb, nhưng <b>cũng có thể</b> là hot page của bảng người dùng</td><td>Đọc <code>wait_resource</code> trong sys.dm_exec_requests: chỉ khi có dạng <code>2:x:y</code> mới đúng là tempdb (2 = database_id của tempdb)</td></tr>
<tr><td>WRITELOG</td><td>Vấn đề I/O của <b>transaction log</b></td><td>Đo độ trễ ghi của file log (file_id 2); trên Azure còn phải loại trừ log rate governor</td></tr>
<tr><td>RESOURCE_SEMAPHORE</td><td>Đang chờ memory grant</td><td>sys.dm_exec_query_memory_grants — <code>grant_time</code> NULL là chưa được cấp</td></tr>
<tr><td>RESOURCE_SEMAPHORE_QUERY_COMPILE</td><td>Chờ memory để <b>biên dịch</b> plan — thường do quá nhiều câu ad-hoc</td><td>Cân nhắc <code>optimize for ad hoc workloads</code>, tham số hoá câu lệnh</td></tr>
<tr><td>CXPACKET</td><td>MAXDOP có thể quá cao, hoặc cần thêm index</td><td>Từ SQL Server 2017: chờ lành tính đã tách sang <b>CXCONSUMER</b>, nên CXPACKET còn lại mới đáng ngờ</td></tr>
<tr><td>SOS_SCHEDULER_YIELD</td><td>CPU cao, thường do thiếu index — hay xuất hiện cùng CXPACKET</td><td>Đối chiếu tỉ lệ <b>signal wait</b> và <code>avg_instance_cpu_percent</code></td></tr>
<tr><td>ASYNC_NETWORK_IO</td><td>SQL Server đã đẩy dữ liệu ra network buffer và đang <b>chờ client nhận/xử lý tiếp</b> — client đọc chậm (xử lý từng dòng, đổ ra UI) hoặc đường truyền chậm/độ trễ cao. <b>Không</b> phải lỗi index, tempdb hay log</td><td>CPU và disk I/O thấp mà wait này cao thì nghẽn nằm phía client/mạng — sửa ở ứng dụng, không sửa ở database</td></tr>
<tr><td>LCK_M_*</td><td>Bị <b>blocking</b> — đang chờ lock (S, U, X, IX…)</td><td>sys.dm_exec_requests với <code>blocking_session_id &lt;&gt; 0</code>; chi tiết lock ở sys.dm_tran_locks</td></tr>
<tr><td>THREADPOOL</td><td>Hết worker thread — request phải xếp hàng chờ thread, thường là hệ quả của blocking kéo dài</td><td><code>max_worker_percent</code> trong sys.dm_db_resource_stats; gỡ blocking trước, đừng vội nâng tier</td></tr>
<tr><td>ASYNC_IO_COMPLETION / BACKUPIO</td><td>Chờ I/O của các thao tác nền như backup/restore</td><td>Bình thường trong cửa sổ backup; chỉ đáng lo nếu kéo dài ngoài cửa sổ đó</td></tr>
<tr><td>SLEEP_*, BROKER_*, XE_TIMER_EVENT, LAZYWRITER_SLEEP…</td><td><b>Queue wait</b> — task nền đang ngồi rảnh chờ việc</td><td>Là nhiễu, phải lọc bỏ trước khi xếp hạng; Microsoft liệt kê hẳn một danh sách wait type chỉ mang tính thông tin</td></tr>
</table></div>
</section>

<section id="t303b">
<h3>Bẫy khi đọc DMV sức khoẻ — tích luỹ, mốc reset, NULL, quyền<a class="nl" href="/dp-300/documents#s60">docs 3.22</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=DMV,Wait%20stats" title="Ôn 42 câu: DMV, Wait stats (tab mới)">ôn 42 câu</a></h3>
<p class="lead">Phần lớn câu hỏi khó ở mục này không hỏi "DMV nào" mà hỏi "vì sao con số bạn đọc được lại sai".</p>
<div class="tw"><table class="cmp">
<tr><th>DMV</th><th>Số liệu tính từ đâu</th><th>Mất số liệu khi</th><th>Đọc đúng là</th></tr>
<tr><td>sys.dm_os_wait_stats</td><td>Tích luỹ từ lần engine khởi động gần nhất (đối chiếu <code>sqlserver_start_time</code> trong sys.dm_os_sys_info)</td><td>Engine restart; hoặc chủ động <code>DBCC SQLPERF('sys.dm_os_wait_stats', CLEAR)</code></td><td>Lấy <b>delta hai snapshot</b> quanh cửa sổ nghiệp vụ. <code>wait_time_ms</code> <b>đã bao gồm</b> <code>signal_wait_time_ms</code> → resource wait = hiệu hai cột</td></tr>
<tr><td>sys.dm_db_wait_stats</td><td>Tích luỹ, <b>chỉ database hiện tại</b>, chỉ wait đã kết thúc</td><td>Database bị move / đưa offline / failover</td><td>Dùng khi cần tách một database khỏi nhiễu của cả instance</td></tr>
<tr><td>sys.dm_exec_session_wait_stats</td><td>Tích luỹ theo từng <code>session_id</code> (SQL Server 2016+)</td><td>Session mở mới, <b>hoặc session bị reset bởi connection pooling</b></td><td>Bẫy hay gặp khi đo qua ứng dụng có pool: số về 0 giữa chừng</td></tr>
<tr><td>sys.dm_db_resource_stats</td><td>Một dòng mỗi <b>15 giây</b>, giữ ~<b>1 giờ</b>; % so với hạn mức của tier</td><td>Failover trong 60 phút gần nhất → chỉ còn dữ liệu <b>sau</b> failover</td><td>Lịch sử dài hơn: sys.resource_stats trong master (5 phút, ~14 ngày). MI: sys.server_resource_stats</td></tr>
<tr><td>sys.dm_io_virtual_file_stats</td><td>Tích luỹ từ lúc service khởi động; <code>sample_ms</code> để đối chiếu hai lần lấy mẫu</td><td>Restart service</td><td>Độ trễ = Δ<code>io_stall_read_ms</code> / Δ<code>num_of_reads</code>. <code>io_stall_queued_*_ms</code> là độ trễ do <b>IO resource governance</b> chèn vào — đụng trần tier chứ không phải đĩa chậm</td></tr>
<tr><td>sys.dm_os_performance_counters</td><td>Tuỳ <code>cntr_type</code></td><td>Engine restart</td><td><b>65792</b> = đọc thẳng (ảnh chụp). <b>272696320 / 272696576</b> = tích luỹ theo giây → lấy delta 2 mẫu cách 1 giây. <b>537003264</b> và <b>1073874176</b> = tỉ lệ → phải chia cho dòng <b>base</b> có <code>cntr_type</code> <b>1073939712</b></td></tr>
<tr><td>sys.dm_exec_query_stats</td><td>Một dòng cho mỗi câu lệnh thuộc <b>plan đang nằm trong cache</b></td><td>Plan rời cache (memory pressure, FREEPROCCACHE, failover); câu dùng <code>OPTION (RECOMPILE)</code> <b>không bao giờ</b> xuất hiện</td><td>Phân tích quá khứ thì dùng <b>Query Store</b>, đừng dựa vào DMV này</td></tr>
<tr><td>sys.dm_db_index_usage_stats</td><td>Tích luỹ số seek/scan/lookup/update kể từ lần engine khởi động</td><td>Restart / failover → trống cho tới khi workload chạm lại index</td><td>Đừng drop index chỉ vì DMV trống ngay sau failover</td></tr>
<tr><td>sys.dm_db_index_physical_stats</td><td>Quét thật lúc gọi; mode mặc định (NULL) là <b>LIMITED</b></td><td>—</td><td>LIMITED chỉ quét page trên leaf → <code>avg_page_space_used_in_percent</code>, <code>record_count</code>, <code>ghost_record_count</code>, <code>forwarded_record_count</code> trả <b>NULL</b>. Cần các cột đó thì SAMPLED (mẫu 1%) hoặc DETAILED</td></tr>
<tr><td>sys.dm_db_file_space_usage (tempdb)</td><td>Ảnh chụp hiện tại, tách theo <b>user object</b> / <b>internal object</b> / <b>version store</b></td><td>—</td><td>Version store phình → truy transaction snapshot dài nhất bằng sys.dm_tran_active_snapshot_database_transactions (<code>elapsed_time_seconds</code>)</td></tr>
</table></div>
<p class="lead"><b>Quyền:</b> Azure SQL Database cần <code>VIEW DATABASE STATE</code> <b>trong chính database đó</b> (hoặc role <code>##MS_ServerStateReader##</code> trong master ảo); MI và SQL Server cần <code>VIEW SERVER STATE</code>. <b>SQL Server 2022</b> tách thêm quyền hạt mịn <code>VIEW SERVER PERFORMANCE STATE</code> và <code>VIEW SERVER SECURITY STATE</code> (bản database: <code>VIEW DATABASE PERFORMANCE STATE</code> / <code>VIEW DATABASE SECURITY STATE</code>) — cả hai nằm <b>trong</b> <code>VIEW SERVER STATE</code>, và từ 2022 chính các DMV hiệu năng đòi quyền PERFORMANCE, nên đó mới là quyền tối thiểu cho công cụ giám sát.</p>
<p class="lead"><b>Bẫy hay gặp:</b> thấy một wait type đứng đầu bảng tích luỹ 90 ngày rồi kết luận "đang nghẽn" — con số đó có thể đến từ một sự cố tháng trước. Luôn đo bằng delta hoặc clear trước khi đo.</p>
<p class="lead">Nguồn: Microsoft Learn — <i>Monitor performance by using DMVs (Azure SQL Database)</i>, trang tham chiếu của sys.dm_db_resource_stats, sys.dm_db_wait_stats, sys.dm_os_wait_stats, sys.dm_io_virtual_file_stats, sys.dm_os_performance_counters, sys.dm_os_job_object, sys.dm_user_db_resource_governance, sys.dm_db_index_physical_stats, sys.dm_db_file_space_usage, sys.databases; đọc ngày 12/09/2026.</p>
</section>

<section id="t304">
<h3>Diễn giải metric → hành động<a class="nl" href="/dp-300/documents#s46">docs 3.5</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Metrics,Baseline" title="Ôn 11 câu: Metrics, Baseline (tab mới)">ôn 11 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t305">
<h3>Query Store — cấu hình và giá trị mặc định<a class="nl" href="/dp-300/documents#s50">docs 3.9</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Query%20Store" title="Ôn 18 câu: Query Store (tab mới)">ôn 18 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t306">
<h3>Blocking và isolation level<a class="nl" href="/dp-300/documents#s52">docs 3.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Blocking,Extended%20Events" title="Ôn 18 câu: Blocking, Extended Events (tab mới)">ôn 18 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t307">
<h3>Index — khi nào hữu ích, chọn loại nào<a class="nl" href="/dp-300/documents#s54">docs 3.17</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Index,Index%20maintenance" title="Ôn 16 câu: Index, Index maintenance (tab mới)">ôn 16 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t310">
<h3>DBCC — kiểm tra tính nhất quán<a class="nl" href="/dp-300/documents#s60-3">docs 3.24</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=DBCC" title="Ôn 18 câu: DBCC (tab mới)">ôn 18 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t312">
<h3>Intelligent Query Processing — bốn đợt theo compatibility level<a class="nl" href="/dp-300/documents#s66">docs 3.31</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=IQP" title="Ôn 11 câu: IQP (tab mới)">ôn 11 câu</a></h3>
<p class="lead">Mỗi tính năng gắn với một <b>compatibility level</b> và một hằng số <code>DATABASE SCOPED CONFIGURATION</code>. Đề hay hỏi đúng hai thứ đó, nên nhớ theo cột chứ đừng nhớ theo tên tính năng. Nâng level là bật cả cụm; muốn giữ level cũ mà vẫn có tính năng thì bật từng hằng số. Nguồn: <i>Intelligent query processing in SQL databases</i> trên Microsoft Learn, đối chiếu ngày 05/09/2026.</p>
<div class="tw"><table class="cmp">
...
<tr><td colspan="4"><b>Đợt 3 — SQL Server 2022, compatibility level 160 · "học từ lần chạy trước" (phần lớn cần Query Store — xem bảng dưới)</b></td></tr>
...
<tr><td>Degree of Parallelism feedback</td><td>160</td><td>Tự hạ DOP khi song song hoá không giúp gì mà chỉ tốn thêm CPU</td><td><code>DOP_FEEDBACK</code> — <b>mặc định OFF</b> trên SQL Server 2022, phải bật tay. Chỉ <b>hạ</b> DOP, thấp nhất là <b>2</b> (query chạy serial nằm ngoài phạm vi) và không bao giờ vượt MAXDOP; tắt cho một câu bằng hint <code>DISABLE_DOP_FEEDBACK</code></td></tr>
<tr><td>Memory grant feedback — persistence</td><td>140</td><td>Ghi feedback vào Query Store nên <b>không mất khi restart</b> hay khi plan bị đẩy khỏi cache</td><td><code>MEMORY_GRANT_FEEDBACK_PERSISTENCE</code> — engine phải là SQL Server 2022+, nhưng level chỉ cần <b>140</b>; trên Azure SQL Database thì bật sẵn cho mọi database</td></tr>
<tr><td>Memory grant feedback — percentile</td><td>140</td><td>Cấp memory theo phân vị của nhiều lần chạy thay vì chỉ lần gần nhất, hết dao động lên xuống</td><td><code>MEMORY_GRANT_FEEDBACK_PERCENTILE</code> — cũng chỉ cần level <b>140</b> trên engine 2022+</td></tr>
...
<tr><td colspan="4"><b>Đợt 4 — SQL Server 2025 / Azure SQL Database, mốc chính là level 170 · "một câu lệnh, nhiều plan"</b></td></tr>
<tr><td>Optional parameter plan optimization (OPPO)</td><td>170</td><td>Dùng lại hạ tầng multiplan của PSP: chọn plan lúc chạy tùy tham số là <code>NULL</code> hay <code>NOT NULL</code> — thuốc chữa câu "kitchen sink" kiểu <code>WHERE (@p IS NULL OR col = @p)</code></td><td>Bật bằng cách nâng level lên 170</td></tr>
<tr><td>CE feedback cho biểu thức</td><td>170 (Azure SQL DB) · 160 (SQL Server 2025)</td><td>Mở rộng CE feedback sang các <b>biểu thức lặp lại</b> giữa nhiều query, không chỉ từng query một</td><td><code>CE_FEEDBACK</code></td></tr>
<tr><td><code>OPTIMIZED_SP_EXECUTESQL</code></td><td>không phụ thuộc level</td><td>Cho <code>sp_executesql</code> hành xử như stored procedure về mặt compile — giảm <b>compilation storm</b></td><td>Cấu hình riêng, xem tài liệu <code>sp_executesql</code></td></tr>
<tr><td colspan="4"><b>Không đòi level mới — chỉ cần đúng phiên bản engine</b></td></tr>
...
<tr><td><code>APPROX_PERCENTILE_CONT / _DISC</code></td><td>≥ 110 — tức gần như mọi database</td><td>Percentile xấp xỉ trên tập lớn, nhanh hơn nhiều so với bản chính xác</td><td>SQL Server 2022+ / Azure SQL; cũng không có hằng số</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Tính năng IQP</th><th>Bắt buộc Query Store bật và ở <code>READ_WRITE</code>?</th></tr>
<tr><td>CE feedback · DOP feedback · Optimized plan forcing · Memory grant feedback (persistence và percentile)</td><td><b>Có</b> — tắt Query Store là mất sạch, học xong lại quên</td></tr>
<tr><td>Parameter Sensitive Plan optimization</td><td><b>Không bắt buộc</b>, nhưng Microsoft khuyến nghị bật — đây là chỗ đề hay gài</td></tr>
<tr><td>Adaptive joins · Interleaved execution · Batch mode on rowstore · Memory grant feedback (batch/row mode) · Scalar UDF inlining · Table variable deferred compilation · APPROX_*</td><td><b>Không</b></td></tr>
</table></div>
<div class="tw"><table class="cmp">
...
<tr><td>Vì sao đợt 3 cần Query Store</td><td>Feedback của CE, DOP và memory grant persistence được <b>lưu trong Query Store</b>; Query Store tắt thì học xong lại quên sau mỗi lần restart. DOP feedback ghi kết quả vào <code>sys.query_store_plan_feedback</code>, và chỉ feedback đã <b>kiểm chứng</b> mới được lưu — thoái lui thì quay về giá trị tốt gần nhất</td></tr>
<tr><td>Nâng lên level 170 thì được thêm gì</td><td>OPPO, CE feedback cho biểu thức, và PSP optimization mở rộng sang <b>câu DML</b> cùng <code>tempdb</code> chứ không chỉ câu SELECT như ở level 160</td></tr>
<tr><td>Kiểm tra đang bật những gì</td><td><code>SELECT * FROM sys.database_scoped_configurations</code></td></tr>
</table></div>
</section>

<section id="t313">
<h3>Extended Events — session, target và khác biệt trên Azure<a class="nl" href="/dp-300/documents#s52">docs 3.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Extended%20Events,Blocking" title="Ôn 18 câu: Extended Events, Blocking (tab mới)">ôn 18 câu</a></h3>
<p class="lead">Study guide bản 24/04/2026 ghi đích danh <i>Monitor by using Extended Events</i>. XE là cơ chế trace duy nhất còn được phát triển — SQL Trace và SQL Server Profiler đã <b>deprecated</b> và không có trên Azure SQL Database / MI. Nguồn: <i>Extended Events in Azure SQL</i> và <i>Extended Events targets</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Thành phần</th><th>Là gì</th></tr>
<tr><td>Event session</td><td>Đơn vị cấu hình. <code>CREATE / ALTER / DROP EVENT SESSION</code>; bật bằng <code>ALTER EVENT SESSION … STATE = START</code></td></tr>
<tr><td>Event</td><td>Điểm bắt trong engine, ví dụ <code>sql_batch_completed</code>, <code>error_reported</code>, <code>blocked_process_report</code>, <code>xml_deadlock_report</code>, <code>query_post_execution_showplan</code></td></tr>
<tr><td>Action</td><td>Dữ liệu bổ sung gắn kèm khi event xảy ra: <code>sqlserver.sql_text</code>, <code>session_id</code>, <code>client_hostname</code>, <code>plan_handle</code>… Càng nhiều action càng tốn</td></tr>
<tr><td>Predicate</td><td>Mệnh đề <code>WHERE</code> lọc ngay tại nguồn — cách chính để giảm chi phí của session</td></tr>
<tr><td>Target</td><td>Nơi nhận dữ liệu (bảng dưới)</td></tr>
<tr><td>Tùy chọn session</td><td><code>MAX_MEMORY</code>, <code>MAX_DISPATCH_LATENCY</code>, và <code>STARTUP_STATE = ON</code> để session tự chạy lại sau restart/failover — bắt buộc nếu muốn theo dõi liên tục</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Target</th><th>Dùng để</th><th>SQL Server</th><th>Azure SQL DB</th><th>MI</th></tr>
<tr><td><code>event_file</code></td><td>Ghi ra <code>.xel</code> để giữ lâu và mở bằng SSMS</td><td>File đĩa <b>hoặc</b> blob</td><td>Chỉ <b>blob</b> Azure Storage</td><td>Chỉ <b>blob</b></td></tr>
<tr><td><code>ring_buffer</code></td><td>Xem nhanh event gần nhất, chỉ trong bộ nhớ; dừng session là mất</td><td>Có</td><td>Có</td><td>Có</td></tr>
<tr><td><code>histogram</code></td><td>Đếm số lần theo từng giá trị (bucket). Xử lý <b>đồng bộ</b></td><td>Có</td><td>Có</td><td>Có</td></tr>
<tr><td><code>event_counter</code></td><td>Chỉ đếm tổng số lần mỗi event. Xử lý <b>đồng bộ</b></td><td>Có</td><td>Có</td><td>Có</td></tr>
<tr><td><code>event_stream</code></td><td>Đọc trực tiếp từ chương trình .NET; luôn có sẵn, không add bằng T-SQL</td><td>Có</td><td>Có</td><td>Có</td></tr>
<tr><td><code>pair_matching</code></td><td>Tìm event "mở" chưa có event "đóng" (lock_acquired thiếu lock_released)</td><td>Có</td><td><b>Không</b></td><td><b>Không</b></td></tr>
<tr><td><code>etw_classic_sync_target</code></td><td>Đẩy sang Event Tracing for Windows</td><td>Có</td><td><b>Không</b></td><td><b>Không</b></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Khác biệt theo nền tảng</th><th>SQL Server / SQL trên VM</th><th>Azure SQL Managed Instance</th><th>Azure SQL Database</th></tr>
<tr><td>Phạm vi session</td><td><code>ON SERVER</code></td><td><code>ON SERVER</code> và <code>ON DATABASE</code> — Microsoft khuyên dùng <b>server-scoped</b></td><td><b>Chỉ <code>ON DATABASE</code></b>; session của DB này không bắt được event của DB khác</td></tr>
<tr><td>DMV xem session đang chạy</td><td><code>sys.dm_xe_sessions</code>, <code>sys.dm_xe_session_targets</code></td><td>Như SQL Server</td><td><code>sys.dm_xe_database_sessions</code>, <code>sys.dm_xe_database_session_targets</code></td></tr>
<tr><td>Credential cho blob</td><td>Server-scoped <code>CREATE CREDENTIAL</code> (trong <code>master</code>)</td><td>Server-scoped credential</td><td><b>Database scoped credential</b>, tạo trong chính DB user</td></tr>
<tr><td>Trong SSMS</td><td>Management → Extended Events → Sessions</td><td>Như SQL Server</td><td>Nằm <b>dưới từng database</b>, không nằm ở Management</td></tr>
<tr><td>Profiler / SQL Trace</td><td>Còn chạy nhưng đã deprecated</td><td><b>Không có</b></td><td><b>Không có</b></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Con số cần nhớ</th><th>Giá trị</th></tr>
<tr><td>Bộ nhớ session, Azure SQL Database</td><td><b>128 MB</b> cho một single database; tổng <b>512 MB</b> cho cả elastic pool</td></tr>
<tr><td>Số session đang chạy, Azure SQL Database</td><td><b>100</b> cho một database, và 100 database-scoped session cho một elastic pool</td></tr>
<tr><td><code>MAX_MEMORY</code> mặc định của ring_buffer</td><td>Không giới hạn trên SQL Server; <b>32 MB</b> trên Azure SQL DB / MI. Khuyến nghị đặt <b>≤ 1.024 KB</b></td></tr>
<tr><td>Giới hạn khi đọc ring_buffer</td><td>Chuyển sang XML bị cắt ở <b>4 MB</b> — thấy <code>truncated="1"</code> nghĩa là đã mất bớt event dù ring buffer còn giữ</td></tr>
<tr><td>Slot của histogram</td><td>Mặc định <b>256</b>, làm tròn lên lũy thừa của 2, tối đa <b>16.384</b>. Có thể va chạm hash → đếm sai bucket</td></tr>
<tr><td>SAS token cho event_file</td><td>Quyền <b>rwdl</b> (Read, Write, Delete, List), thời hạn phủ trọn đời session, <b>không</b> giới hạn IP</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> storage account cho <code>event_file</code> phải là general-purpose v2, tier <b>Hot</b>, cùng region, và <b>tắt hierarchical namespace</b> — bật HNS thì session lỗi <i>"error 13: The data is invalid"</i>; immutability policy cũng gây đúng lỗi này. Lỗi <i>error 86</i> là chưa có credential trùng tên URL container (hoặc tên credential thừa dấu <code>/</code> ở cuối), <i>error 5</i> là thiếu RBAC <b>Storage Blob Data Contributor</b> cho managed identity, hoặc SAS hết hạn. Trên Azure SQL Database <b>đừng đọc session <code>dl</code> sẵn có</b> bằng <code>sys.fn_xe_file_target_read_file</code> để lấy deadlock — có thể gây out-of-memory ở <code>master</code> và chặn cả đăng nhập.</p>
</section>

<section id="t314">
<h3>Server setting cho hiệu năng — sp_configure và cấu hình Windows<a class="nl" href="/dp-300/documents#s62">docs 3.27</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Scoped%20config,DB%20options" title="Ôn 14 câu: Scoped config, DB options (tab mới)">ôn 14 câu</a></h3>
<p class="lead">Study guide ghi <i>Configure server settings for performance</i>. Cấp <b>server</b> (bảng này) khác cấp <b>database</b> (<a href="#t311">database-scoped configuration</a>) và cấp <b>query</b> (<a href="#t309">hint</a>) — quy tắc chung: mức càng hẹp càng thắng. Nguồn: checklist <i>Best practices for SQL Server on Azure VMs</i> và <i>Server configuration: max degree of parallelism</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Thiết lập</th><th>Mặc định</th><th>Khuyến nghị</th><th>Chỉnh được ở đâu</th></tr>
<tr><td><code>max degree of parallelism</code></td><td>SQL Server: <b>0</b> (dùng hết CPU); setup 2019+ tự gợi ý theo số core. Azure SQL DB / MI / Fabric: <b>8</b></td><td>≤8 logical processor: bằng số processor · &gt;8 trên 1 NUMA node: <b>8</b> · nhiều NUMA node, ≤16 processor/node: bằng số processor mỗi node · &gt;16/node: một nửa, tối đa <b>16</b></td><td>VM/on-prem: <code>sp_configure</code> · MI: <code>sp_configure</code> · Azure SQL DB: <b>chỉ</b> <code>ALTER DATABASE SCOPED CONFIGURATION SET MAXDOP</code>. Đè thêm được bằng query hint, Query Store hint, workload group của Resource Governor</td></tr>
<tr><td><code>cost threshold for parallelism</code></td><td><b>5</b> — quá thấp so với phần cứng hiện nay</td><td>Nâng lên (thường 25–50) để query rẻ không đi plan song song vô ích</td><td>VM/on-prem và MI: <code>sp_configure</code>. Azure SQL DB: <b>không chỉnh được</b></td></tr>
<tr><td><code>max server memory (MB)</code></td><td>Gần như không giới hạn</td><td>Chừa đủ RAM cho OS và các tiến trình khác; theo dõi <code>Memory\\Available Bytes</code></td><td>Chỉ VM/on-prem. MI và Azure SQL DB do nền tảng cấp theo service tier</td></tr>
<tr><td><code>optimize for ad hoc workloads</code></td><td>Off</td><td><b>Bật</b> với môi trường OLTP nhiều query dùng một lần — lần đầu chỉ lưu stub kế hoạch, đỡ phình plan cache</td><td>VM/on-prem, MI: <code>sp_configure</code>. Azure SQL DB: dùng database-scoped configuration cùng tên</td></tr>
<tr><td><code>backup compression default</code></td><td>Off</td><td><b>Bật</b></td><td>VM/on-prem (MI/SQL DB backup do nền tảng lo)</td></tr>
<tr><td>Instant file initialization</td><td>Off</td><td><b>Bật</b> — cấp quyền <b>Perform Volume Maintenance Tasks</b> cho service account. Data file lớn thêm/khôi phục gần như tức thì; <b>không</b> áp dụng cho log file</td><td>Chỉ VM/on-prem (Windows policy)</td></tr>
<tr><td>Lock Pages in Memory</td><td>Off</td><td><b>Bật</b> cho service account để OS không page bộ nhớ của SQL Server ra đĩa</td><td>Chỉ VM/on-prem (Windows policy)</td></tr>
<tr><td>Số file <code>tempdb</code></td><td>Theo lúc cài</td><td><b>1 file mỗi core, tối đa 8</b>, cùng kích thước và autogrowth; đặt trên ổ <b>D:</b> (local SSD) của Azure VM</td><td>Chỉ VM/on-prem</td></tr>
<tr><td>Autogrowth / autoshrink / autoclose</td><td>Autogrowth theo % ở DB cũ</td><td>Autogrowth theo <b>MB cố định</b>, đừng để %; <b>tắt</b> autoshrink và autoclose</td><td>VM/on-prem, MI</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Cách chạy sp_configure</th><th>Lệnh</th></tr>
<tr><td>Xem giá trị</td><td><code>EXEC sp_configure;</code> — mọi user chạy được</td></tr>
<tr><td>Hiện tùy chọn nâng cao</td><td><code>EXEC sp_configure 'show advanced options', 1; RECONFIGURE;</code></td></tr>
<tr><td>Đổi giá trị</td><td><code>EXEC sp_configure 'max degree of parallelism', 8; RECONFIGURE;</code> — quên <code>RECONFIGURE</code> là <code>run_value</code> chưa đổi</td></tr>
<tr><td>Quyền</td><td><b>ALTER SETTINGS</b> cấp server (có sẵn trong <b>sysadmin</b> và <b>serveradmin</b>)</td></tr>
<tr><td>Có phải restart không</td><td>MAXDOP và cost threshold: có hiệu lực <b>ngay</b>. Một số option khác cần restart — cột <code>is_dynamic</code> trong <code>sys.configurations</code> cho biết</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề đưa Azure SQL Database mà đáp án là <code>sp_configure</code> thì gần như chắc chắn sai — Azure SQL Database không có <code>sp_configure</code>, mọi thứ tương đương đi qua <code>ALTER DATABASE SCOPED CONFIGURATION</code>. Managed Instance thì <b>có</b> <code>sp_configure</code> nhưng chỉ một tập con; các thiết lập thuộc về Windows (IFI, Lock Pages in Memory, số file tempdb) chỉ tồn tại trên <b>SQL Server trên VM / on-prem</b>.</p>
</section>

<section id="t314b">
<h3>Chẩn đoán: triệu chứng đo được → tham số cấu hình nào<a class="nl" href="/dp-300/documents#s62">docs 3.27</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Server%20config" title="Ôn 12 câu: Server config (tab mới)">ôn 12 câu</a></h3>
<p class="lead">Study guide ghi <i>assess performance-related database configuration parameters</i> — chữ <b>assess</b> mới là phần bị hỏi: đề đưa một triệu chứng đo được rồi bắt bạn chỉ ra tham số sai, chứ hiếm khi hỏi định nghĩa suông. Bảng <a href="#t314">t314</a> là danh mục thiết lập; bảng này là chiều ngược lại. Nguồn: các trang <i>Server configuration</i>, <i>Database instant file initialization</i>, <i>tempdb database</i> và <i>Memory management architecture guide</i> trên Microsoft Learn, đối chiếu ngày 05/09/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Triệu chứng</th><th>Nghĩ ngay tới</th><th>Kiểm tra bằng</th><th>Xử lý</th></tr>
<tr><td><code>CXPACKET</code> + <code>CXCONSUMER</code> dẫn đầu wait stats · nhiều plan <code>is_parallel_plan = 1</code> trong Query Store · kèm <code>THREADPOOL</code></td><td><code>cost threshold for parallelism</code> <b>quá thấp</b> (và/hoặc MAXDOP quá cao)</td><td><code>sys.dm_os_wait_stats</code> · Query Store</td><td>Nâng cost threshold từng bước nhỏ khỏi mặc định <b>5</b>, quan sát trọn một chu kỳ nghiệp vụ; đặt MAXDOP theo quy tắc NUMA</td></tr>
<tr><td><code>SOS_SCHEDULER_YIELD</code> dẫn đầu <b>một mình</b> · CPU cao hơn mức tối ưu · rất ít query nặng đi song song</td><td><code>cost threshold for parallelism</code> <b>quá cao</b></td><td><code>sys.dm_os_wait_stats</code></td><td>Hạ dần cost threshold — đây là chiều ngược lại của dòng trên, đề hay đảo hai tình huống này</td></tr>
<tr><td><code>RESOURCE_SEMAPHORE</code> chiếm phần lớn thời gian chờ</td><td>Query xếp hàng chờ <b>memory grant</b> — <code>min memory per query</code> đặt quá cao, hoặc <code>max server memory</code> quá thấp</td><td><code>sys.dm_exec_query_memory_grants</code></td><td>Hạ <code>min memory per query</code> (đặt cao thì <b>mọi</b> câu giữ chỗ thừa, giết concurrency); xem lại max server memory; sửa plan sinh grant lớn</td></tr>
<tr><td>Error log có lỗi <b>17890</b> <i>"A significant part of SQL Server process memory has been paged out"</i></td><td>Chưa cấp <b>Lock pages in memory</b></td><td><code>SELECT sql_memory_model_desc FROM sys.dm_os_sys_info</code> → <code>CONVENTIONAL</code> nghĩa là chưa cấp</td><td>Cấp LPIM cho service account, <b>và bắt buộc</b> đặt <code>max server memory</code> một con số cụ thể — cấp LPIM mà để mặc định là công thức gây bất ổn</td></tr>
<tr><td><code>PAGELATCH_UP</code> trên trang cấp phát (GAM / SGAM / PFS) của database id 2</td><td>Thiếu file data <code>tempdb</code></td><td><code>sys.dm_exec_requests</code> + <code>sys.fn_PageResCracker</code> + <code>sys.dm_db_page_info</code></td><td>1 file mỗi logical processor, <b>tối đa 8</b>; còn contention thì tăng theo <b>bội số 4</b>. Mọi file cùng size và cùng growth (proportional fill)</td></tr>
<tr><td><code>PAGELATCH_*</code> trên <b>system table</b> của tempdb (object_id 3, 9, 34, 40, 41, 54, 55, 60, 74, 75)</td><td>Contention <b>metadata</b> của đối tượng tạm, không phải contention cấp phát</td><td>Query chẩn đoán trong tài liệu <i>tempdb database</i></td><td><code>ALTER SERVER CONFIGURATION SET MEMORY_OPTIMIZED TEMPDB_METADATA = ON</code> (SQL Server 2019+, <b>cần restart</b>; <b>không có</b> trên Azure SQL Database / MI)</td></tr>
<tr><td>Wait <code>PREEMPTIVE_OS_WRITEFILEGATHER</code> lúc file tự tăng · error log có <b>Msg 5144 / 5145</b> về autogrow lâu</td><td>Autogrow quá lớn, hoặc <b>IFI chưa bật</b></td><td>Error log lúc khởi động: <i>"Database Instant File Initialization: disabled"</i> · <code>sys.dm_server_services.instant_file_initialization_enabled</code></td><td>Cấp <i>Perform volume maintenance tasks</i> cho <b>service SID</b>; đặt <code>FILEGROWTH</code> theo MB cố định thay vì phần trăm</td></tr>
<tr><td>Plan cache đầy plan <code>Adhoc</code> có <code>usecounts = 1</code>, chiếm hàng GB</td><td><code>optimize for ad hoc workloads</code> chưa bật</td><td><code>sys.dm_exec_cached_plans</code> lọc <code>objtype = 'Adhoc' AND usecounts = 1</code></td><td>Bật ở cấp server (VM/MI) hoặc <code>OPTIMIZE_FOR_AD_HOC_WORKLOADS</code> ở cấp database (mặc định <b>OFF</b>). Chỉ áp cho plan <b>mới</b> — muốn hiệu lực ngay phải xoá plan cache</td></tr>
<tr><td>Câu đọc chặn câu ghi, lock wait dài trên <code>SELECT</code></td><td>Chưa bật <code>READ_COMMITTED_SNAPSHOT</code></td><td><code>sys.databases.is_read_committed_snapshot_on</code></td><td>Bật RCSI (Azure SQL Database đã <b>ON</b> sẵn; SQL Server và MI thì OFF). Đổi được chỉ khi không còn connection nào khác; đổi lấy chỗ chứa row version trong <code>tempdb</code></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Quyền Windows của service account Database Engine</th><th>Setup tự cấp?</th><th>Để làm gì</th></tr>
<tr><td><i>Log on as a service</i> · <i>Replace a process-level token</i> · <i>Bypass traverse checking</i> · <i>Adjust memory quotas for a process</i></td><td><b>Có</b> — cấp cho per-service SID (<code>NT SERVICE\\MSSQLSERVER</code>, instance có tên thì <code>NT Service\\MSSQL$&lt;tên&gt;</code>)</td><td>Chạy được dịch vụ; kèm quyền khởi động SQL Writer, đọc Event Log và RPC service</td></tr>
<tr><td><i>Perform volume maintenance tasks</i> (<code>SE_MANAGE_VOLUME_NAME</code>)</td><td><b>Không</b> — chỉ khi tick ô lúc cài hoặc truyền <code>/SQLSVCINSTANTFILEINIT</code></td><td>Bật <b>instant file initialization</b> cho data file. Cấp cho <b>service SID</b> để đổi account vẫn còn quyền</td></tr>
<tr><td><i>Lock pages in memory</i> (<code>SeLockMemoryPrivilege</code>)</td><td><b>Không bao giờ</b> — thêm tay trong <code>secpol.msc</code></td><td>Chặn OS page bộ nhớ SQL Server ra đĩa. Từ SQL Server 2012, Standard edition <b>không</b> cần trace flag 845 nữa</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Ba câu phải tự hỏi khi "assess" một tham số</th><th>Trả lời ở đâu</th></tr>
<tr><td>Nó nằm ở <b>cấp</b> nào — server, database hay query?</td><td><code>sys.configurations</code> · <code>sys.database_scoped_configurations</code> · query hint. Mức càng hẹp càng thắng</td></tr>
<tr><td>Đổi xong có <b>cần restart</b> không?</td><td>Cột <code>is_dynamic</code> của <code>sys.configurations</code>. MAXDOP, cost threshold, max/min server memory đều có hiệu lực ngay sau <code>RECONFIGURE</code></td></tr>
<tr><td>Nền tảng này có tham số đó không?</td><td>Azure SQL Database không có <code>sp_configure</code> · MI có nhưng chỉ một tập con · IFI, LPIM, số file tempdb là chuyện của Windows nên chỉ VM/on-prem</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> quên <code>RECONFIGURE</code> thì <code>sp_configure</code> mới chỉ đổi cột <code>value</code>, còn <code>value_in_use</code> vẫn là giá trị cũ — đề hay mô tả đúng cảnh "đã chạy sp_configure mà không thấy gì đổi". Cái bẫy thứ hai: từ SQL Server 2012, <code>max server memory</code> kiểm soát <b>mọi memory clerk</b> chứ không chỉ buffer pool, nhưng <b>thread stack</b> và <b>direct Windows allocation</b> vẫn nằm ngoài — nên vẫn phải trừ hao khi tính, và engine còn có thể tạm vượt ngưỡng khi bộ nhớ phân mảnh.</p>
</section>

<section id="t315">
<h3>Scale compute và storage — cách làm, mất bao lâu, đứt kết nối không<a class="nl" href="/dp-300/documents#s65">docs 3.32</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Azure%20SQL%20DB,Resource" title="Ôn 18 câu: Azure SQL DB, Resource (tab mới)">ôn 18 câu</a></h3>
<p class="lead">Study guide ghi <i>Configure compute and storage resources for scaling</i>, notes mục 3.32 chỉ có ba dòng. Chọn mô hình mua nào thì xem <a href="#t102">t102</a>, tier nào xem <a href="#t103">t103</a>; bảng này là <b>thao tác scale</b> và hệ quả của nó. Nguồn: <i>Scale resources</i>, <i>Scale single database resources</i>, <i>Serverless compute tier</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Scale bằng gì</th><th>Lệnh / nơi bấm</th></tr>
<tr><td>Portal</td><td>Database → <b>Compute + storage</b> → kéo thanh trượt</td></tr>
<tr><td>T-SQL</td><td><code>ALTER DATABASE db MODIFY (SERVICE_OBJECTIVE = 'S3')</code> · đổi dung lượng: <code>ALTER DATABASE db MODIFY (MAXSIZE = 500 GB)</code></td></tr>
<tr><td>PowerShell</td><td><code>Set-AzSqlDatabase -Edition … -RequestedServiceObjectiveName …</code></td></tr>
<tr><td>Azure CLI</td><td><code>az sql db update</code></td></tr>
<tr><td>Quyền cần có</td><td>T-SQL: server admin, Entra admin, <b>dbmanager</b> trong master, <b>db_owner</b> hoặc dbo của database đó. Portal/PowerShell/CLI: RBAC <b>Contributor</b>, <b>SQL DB Contributor</b> hoặc <b>SQL Server Contributor</b></td></tr>
<tr><td>Theo dõi / huỷ giữa chừng</td><td>Portal → Overview → banner "See more" → <b>Cancel this operation</b> · <code>az sql db op list</code> rồi <code>az sql db op cancel</code> · <code>Get-AzSqlDatabaseActivity</code> rồi <code>Stop-AzSqlDatabaseActivity</code> · <code>sys.dm_operation_status</code></td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Chuyện gì xảy ra khi scale</th><th>Chi tiết</th></tr>
<tr><td>Hai bước</td><td>(1) Dựng compute instance mới — database <b>vẫn online</b>, kết nối cũ vẫn chạy; (2) chuyển định tuyến sang instance mới — kết nối đang mở <b>bị ngắt</b>, giao dịch chưa commit bị rollback</td></tr>
<tr><td>Gián đoạn bao lâu</td><td>Thường <b>dưới 30 giây</b>, phần lớn chỉ vài giây. Có giao dịch dài đang chạy thì lâu hơn — <b>Accelerated Database Recovery</b> giảm được ảnh hưởng này</td></tr>
<tr><td>Bắt buộc phải có</td><td><b>Retry logic</b> trong ứng dụng. Không mất dữ liệu ở bất kỳ bước nào</td></tr>
<tr><td>Managed Instance</td><td><b>Đừng scale</b> khi đang có giao dịch dài (import, rebuild index) hoặc kết nối đang hoạt động — thao tác sẽ kéo dài bất thường</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Mất bao lâu</th><th>Con số</th></tr>
<tr><td>Cùng nhóm, không phải chép dữ liệu</td><td><b>Thời gian hằng số</b> — thường <b>dưới 5 phút</b> với single database (Basic/Standard S0–S1 với nhau; hoặc Standard S2–S12 / General Purpose với nhau)</td></tr>
<tr><td>Phải chép dữ liệu (đổi nhóm tier)</td><td>Tỉ lệ với <b>dung lượng đã dùng</b> — thường <b>dưới 1 phút mỗi GB</b></td></tr>
<tr><td>Hyperscale ↔ Hyperscale</td><td><b>Thời gian hằng số</b>, thường <b>dưới 2 phút</b>, không phụ thuộc dung lượng — đây là điểm bán hàng chính của Hyperscale</td></tr>
<tr><td>Elastic pool</td><td>Tỉ lệ với <b>số database</b> trong pool</td></tr>
<tr><td>Làm chậm thêm</td><td>Tải cao đúng lúc đang scale (ít tài nguyên còn lại cho việc chép), nhất là ở compute size nhỏ</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Ràng buộc khi đổi tier</th><th>Nội dung</th></tr>
<tr><td>In-Memory OLTP</td><td>Database dùng In-Memory OLTP <b>không</b> hạ từ Business Critical/Premium xuống General Purpose/Standard được</td></tr>
<tr><td>Hyperscale</td><td>Database <b>tạo mới</b> trong Hyperscale thì không đi tier khác được. Database <b>chuyển vào</b> Hyperscale thì <b>reverse-migrate về General Purpose trong 45 ngày</b>; muốn sang Business Critical phải về GP trước rồi mới đi tiếp</td></tr>
<tr><td>Hạ tier</td><td>Dung lượng <b>đã dùng</b> phải nhỏ hơn max size của tier đích. Nâng tier <b>không</b> tự tăng max size — phải khai <code>maxsize</code> rõ ràng</td></tr>
<tr><td>Có geo-replica</td><td><b>Nâng: nâng secondary trước.</b> <b>Hạ: hạ primary trước.</b> Đổi khác edition thì đây là <b>bắt buộc</b>, không phải khuyến nghị. Đổi max size thì đổi ở primary, secondary tự theo</td></tr>
<tr><td>Zone redundancy</td><td>Scale BC → GP mặc định <b>giữ nguyên</b> thuộc tính zone redundant; đổi zone redundancy của GP thì thời gian tỉ lệ với kích thước database</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Storage</th><th>Nội dung</th></tr>
<tr><td>vCore</td><td>Bước <b>1 GB</b>, tối thiểu 1 GB, tăng/giảm max size bằng portal/T-SQL/PowerShell/CLI</td></tr>
<tr><td>DTU</td><td>Đã kèm sẵn một lượng storage; mua thêm theo bước <b>250 GB tới 1 TB</b>, sau đó bước <b>256 GB</b></td></tr>
<tr><td>Log</td><td>Azure tự cộng thêm <b>30%</b> dung lượng data cho transaction log và tính tiền phần đó</td></tr>
<tr><td><code>tempdb</code></td><td>Tự cấp <b>32 GB mỗi vCore</b>, nằm trên SSD cục bộ ở mọi tier, đã tính trong giá</td></tr>
<tr><td>Hạ Premium → Standard</td><td>Có thể phát sinh <b>phí storage thêm</b> nếu max size vượt lượng storage kèm theo của tier đích — giảm max size xuống thì tránh được</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Serverless — tự scale thay bạn</th><th>Giá trị</th></tr>
<tr><td>Có ở tier nào</td><td><b>General Purpose</b> và <b>Hyperscale</b>; <b>không</b> có ở Business Critical. Chỉ mô hình <b>vCore</b>, phần cứng <b>standard-series (Gen5)</b>, chỉ <b>single database</b></td></tr>
<tr><td>Auto-pause</td><td>Hiện <b>chỉ General Purpose</b> mới auto-pause/auto-resume</td></tr>
<tr><td>Min / max vCore</td><td>Khai một dải; memory và IO tỉ lệ theo dải đó. Min vCore mặc định <b>0,5</b></td></tr>
<tr><td>Auto-pause delay</td><td>Mặc định <b>60 phút</b>; tối thiểu <b>15 phút</b>, tối đa <b>10.080 phút</b> (7 ngày), bước 1 phút; đặt <b>-1</b> để tắt auto-pause</td></tr>
<tr><td>Tính tiền</td><td>Theo <b>giây</b>. Dùng dưới mức min thì vẫn trả theo min; lúc pause thì compute = <b>0</b>, chỉ trả storage</td></tr>
<tr><td>Đánh thức</td><td>Login hoặc hoạt động kế tiếp tự resume — nên <b>retry logic là bắt buộc</b>, lỗi kết nối lúc auto-resume là chuyện đoán trước được</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề hỏi "cách nào tăng hiệu năng mà không sửa code" thì scale là đáp án đúng; nhưng đề nói "<b>không được có downtime</b>" thì scale <i>không</i> phải đáp án sạch — luôn có một nhịp ngắt kết nối ở cuối. Đề hỏi "database 4 TB, cần đổi compute size nhanh nhất" thì đáp án là <b>Hyperscale</b> (hằng số, dưới 2 phút) chứ không phải Business Critical.</p>
</section>

<h2 class="dom" id="d4">Phạm vi 4 · Tự động hoá</h2>

<section id="t401">
<h3>Cơ chế tự động hoá nào có ở đâu — phần lớn câu hỏi nằm ở đây<a class="nl" href="/dp-300/documents#s-sec4">docs 4.1</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=SQL%20Agent,Elastic%20Jobs,Multi-server" title="Ôn 48 câu: SQL Agent, Elastic Jobs, Multi-server (tab mới)">ôn 48 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t402">
<h3>SQL Server Agent job — lịch và thông báo<a class="nl" href="/dp-300/documents#s67">docs 4.2</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=SQL%20Agent,Notifications,Database%20Mail" title="Ôn 36 câu: SQL Agent, Notifications, Database Mail (tab mới)">ôn 36 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t403">
<h3>Elastic Job — thay SQL Agent cho Azure SQL Database<a class="nl" href="/dp-300/documents#s74">docs 4.9</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Elastic%20Jobs" title="Ôn 20 câu: Elastic Jobs (tab mới)">ôn 20 câu</a></h3>
<div class="tw"><table class="cmp">
<tr><th>Thành phần</th><th>Yêu cầu</th></tr>
...
<section id="t404">
<h3>Triển khai tự động<a class="nl" href="/dp-300/documents#s70">docs 4.5</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=ARM%2FBicep,PowerShell,Azure%20CLI,Deployment" title="Ôn 40 câu: ARM/Bicep, PowerShell, Azure CLI, Deployment (tab mới)">ôn 40 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t405">
<h3>Cảnh báo — SQL Agent alert và Azure Monitor alert rule<a class="nl" href="/dp-300/documents#s77">docs 4.15</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Alerts,Config%20changes" title="Ôn 16 câu: Alerts, Config changes (tab mới)">ôn 16 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t406">
<h3>Policy-based management và automated backup trên VM<a class="nl" href="/dp-300/documents#s75-4">docs 4.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Policies,VM%20backup,Automation,Maintenance,Logic%20Apps" title="Ôn 25 câu: Policies, VM backup, Automation, Maintenance, Logic Apps (tab mới)">ôn 25 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t407">
<h3>Giám sát và xử lý sự cố triển khai — mode, what-if, mã lỗi<a class="nl" href="/dp-300/documents#s69">docs 4.4</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Deployment,ARM/Bicep" title="Ôn 27 câu: Deployment, ARM/Bicep (tab mới)">ôn 27 câu</a></h3>
<p class="lead">Study guide bản 24/04/2026 đổi gạch đầu dòng deployment thành <i>ARM <b>and Bicep</b> templates</i> và thêm <b><i>Monitor and troubleshoot deployments</i></b>. Cách viết template nằm ở <a href="#t404">t404</a>; bảng này là chuyện chạy rồi thì xem ở đâu và hỏng thì đọc mã lỗi nào. Nguồn: <i>Deployment modes</i> và <i>Troubleshoot common Azure deployment errors</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Kiểm trước khi chạy</th><th>Azure CLI</th><th>PowerShell</th><th>Cho biết gì</th></tr>
<tr><td>Validate</td><td><code>az deployment group validate</code></td><td><code>Test-AzResourceGroupDeployment</code></td><td>Cú pháp template và tham số có hợp lệ không — <b>không</b> nói tài nguyên sẽ đổi thế nào</td></tr>
<tr><td>What-if</td><td><code>az deployment group what-if</code></td><td><code>New-AzResourceGroupDeployment -WhatIf</code> (hoặc <code>-Confirm</code>)</td><td>Liệt kê tài nguyên sẽ <b>Create / Delete / Modify / Deploy / Ignore / NoChange</b>. Docs nói <b>luôn chạy what-if trước khi deploy ở Complete mode</b></td></tr>
<tr><td>Bicep</td><td><code>az bicep build</code> · <code>az bicep decompile</code></td><td>—</td><td>Biên dịch Bicep → ARM JSON, hoặc ngược lại từ JSON sang Bicep</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Deployment mode</th><th>Tài nguyên có trong resource group nhưng KHÔNG có trong template</th><th>Giới hạn</th></tr>
<tr><td><b>Incremental</b> — mặc định, và là mode được khuyến nghị</td><td><b>Giữ nguyên</b></td><td>Không có</td></tr>
<tr><td><b>Complete</b> — <code>--mode Complete</code> / <code>-Mode Complete</code></td><td><b>Bị xoá</b></td><td>Chỉ template <b>gốc</b> (linked/nested luôn phải Incremental) · <b>subscription-level deployment không hỗ trợ</b> · portal không hỗ trợ · resource group bị lock thì không xoá được · deploy nhiều resource group thì chỉ group đích mới bị xoá</td></tr>
</table></div>
<p class="lead"><b>Hiểu nhầm số một về Incremental:</b> nó <i>không</i> có nghĩa "chỉ cập nhật property bạn ghi". Khi deploy lại một tài nguyên, <b>mọi property đều được áp lại</b> — property không ghi trong template bị đưa về giá trị mặc định. Template luôn mô tả <b>trạng thái cuối</b>, không mô tả được một bản vá từng phần. Ngoài ra Microsoft nay khuyến nghị dùng <b>deployment stacks</b> khi cần xoá tài nguyên, và ghi rõ Complete mode <b>sẽ dần bị khai tử</b>.</p>
<div class="tw"><table class="cmp">
<tr><th>Hỏng rồi thì xem ở đâu</th><th>Cách</th></tr>
<tr><td>Portal</td><td>Resource group → <b>Deployments</b> (deployment history) → chọn lần deploy → Operation details</td></tr>
<tr><td>CLI</td><td><code>az deployment group list</code> để xem lịch sử, <code>az deployment operation group list --name &lt;tên&gt;</code> để xem lỗi của <b>từng operation</b></td></tr>
<tr><td>Activity log</td><td>Ai chạy, lúc nào, mã lỗi — dùng khi cần truy vết thay đổi ngoài ý muốn</td></tr>
<tr><td>Debug log</td><td><code>az deployment group create --debug</code> · <code>-DeploymentDebugLogLevel All</code> — chỉ bật khi cần, vì log ghi cả giá trị request</td></tr>
<tr><td>Bẫy đọc lỗi</td><td><code>DeploymentFailed</code> là <b>lỗi bao</b>, không nói gì cả — phải mở inner error mới ra mã thật</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Mã lỗi</th><th>Nguyên nhân và cách xử lý</th></tr>
<tr><td><code>DeploymentQuotaExceeded</code></td><td>Vượt <b>800 deployment mỗi resource group</b> trong lịch sử — xoá bớt bản ghi cũ (lịch sử deployment, không phải tài nguyên)</td></tr>
<tr><td><code>InvalidTemplate</code> / <code>InvalidTemplateDeployment</code></td><td>Sai cú pháp hoặc sai expression trong template</td></tr>
<tr><td><code>AuthorizationFailed</code></td><td>Tài khoản/service principal thiếu quyền ở scope đang deploy — <b>hoặc</b> resource provider chưa được đăng ký</td></tr>
<tr><td><code>MissingSubscriptionRegistration</code>, <code>NoRegisteredProviderFound</code>, <code>InvalidSubscriptionRegistrationState</code></td><td>Chưa đăng ký provider: <code>az provider register --namespace Microsoft.Sql</code>. Nên đăng ký trước để tránh lỗi chập chờn</td></tr>
<tr><td><code>SkuNotAvailable</code></td><td>SKU (kích cỡ VM, service objective) không có ở region đã chọn — đổi SKU hoặc đổi region</td></tr>
<tr><td><code>ResourceQuotaExceeded</code>, <code>OperationNotAllowed</code>, <code>AllocationFailed</code></td><td>Vượt quota subscription/region, hoặc region hết chỗ cho kích cỡ VM đó — xin tăng quota hoặc thử lại/đổi size</td></tr>
<tr><td><code>NotFound</code>, <code>ResourceNotFound</code>, <code>ParentResourceNotFound</code>, <code>InvalidResourceReference</code></td><td>Thiếu <code>dependsOn</code> nên tài nguyên con được tạo song song với cha; hoặc hàm <code>reference()</code> thiếu tham số</td></tr>
<tr><td><code>TemplateResourceCircularDependency</code></td><td><code>dependsOn</code> vòng tròn — bỏ bớt phụ thuộc thừa</td></tr>
<tr><td><code>RequestDisallowedByPolicy</code></td><td>Azure Policy chặn — sửa template cho hợp policy, đừng sửa policy trước khi hiểu vì sao có nó</td></tr>
<tr><td><code>DeploymentFailedCleanUp</code></td><td>Chạy Complete mode nhưng không đủ quyền xoá hết — chuyển về <b>Incremental</b></td></tr>
<tr><td><code>DeploymentActiveAndUneditable</code>, <code>AnotherOperationInProgress</code></td><td>Đang có deployment khác chạy trên cùng resource group — chờ</td></tr>
<tr><td><code>DeploymentNameLengthLimitExceeded</code> / <code>DeploymentNameInvalidCharacters</code></td><td>Tên deployment tối đa <b>64 ký tự</b>, chỉ chữ, số, <code>-</code>, <code>.</code>, <code>_</code></td></tr>
<tr><td><code>SubscriptionRequestsThrottled</code></td><td>Bị throttle ở cấp subscription — HTTP <b>429</b> kèm <code>Retry-After</code>, chờ đúng số giây đó rồi gửi lại</td></tr>
<tr><td><code>PasswordTooLong</code></td><td>Tham số <code>securestring</code> thì truyền <b>text thường</b>, đừng tự convert sang secure string trước</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề mô tả "deploy lại template nhưng subnet/site config biến mất" — đó là hệ quả của Incremental áp lại toàn bộ property, không phải Complete mode. Với virtual network, docs dặn khai subnet ở property <code>subnets</code> của chính VNet chứ đừng khai bằng resource con <code>virtualNetworks/subnets</code>.</p>
</section>

<h2 class="dom" id="d5">Phạm vi 5 · HA/DR</h2>

<section id="t501">
<h3>Backup — ai làm và bạn được chạy gì<a class="nl" href="/dp-300/documents#s86">docs 5.9</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Backup,LTR,Cloud%20backup" title="Ôn 30 câu: Backup, LTR, Cloud backup (tab mới)">ôn 30 câu</a></h3>
<div class="tw"><table class="cmp">
<tr><th></th><th>Azure SQL Database</th><th>Managed Instance</th><th>SQL Server trên VM</th></tr>
...
<section id="t502">
<h3>Chọn giải pháp HA/DR theo RPO/RTO<a class="nl" href="/dp-300/documents#s79">docs 5.2</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=SLA%20%2F%20RPO%20%2F%20RTO,Failover%20group,Geo-replication,Hybrid%20HADR,FCI,Site%20Recovery" title="Ôn 52 câu: SLA / RPO / RTO, Failover group, Geo-replication, Hybrid HADR, FCI, Site Recovery (tab mới)">ôn 52 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t503">
<h3>SLA và quorum<a class="nl" href="/dp-300/documents#s92">docs 5.16</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=SLA,SLA%20%2F%20RPO%20%2F%20RTO,Quorum" title="Ôn 18 câu: SLA, SLA / RPO / RTO, Quorum (tab mới)">ôn 18 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t504">
<h3>Always On availability group<a class="nl" href="/dp-300/documents#s90">docs 5.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Availability%20Group,AG%20setup,AG%20listener" title="Ôn 28 câu: Availability Group, AG setup, AG listener (tab mới)">ôn 28 câu</a></h3>
<div class="tw"><table class="cmp">
<tr><th>Chủ đề</th><th>Chi tiết</th></tr>
...
<section id="t505">
<h3>Auto-failover group và geo-replication<a class="nl" href="/dp-300/documents#s91">docs 5.18</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Failover%20group,Geo-replication" title="Ôn 29 câu: Failover group, Geo-replication (tab mới)">ôn 29 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t507">
<h3>RESTORE — các tùy chọn<a class="nl" href="/dp-300/documents#s85">docs 5.7</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Restore,PITR,MI%20restore" title="Ôn 26 câu: Restore, PITR, MI restore (tab mới)">ôn 26 câu</a></h3>
<div class="tw"><table class="cmp">
...
<section id="t509">
<h3>Log shipping<a class="nl" href="/dp-300/documents#s94-2">docs 5.20</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Log%20shipping" title="Ôn 10 câu: Log shipping (tab mới)">ôn 10 câu</a></h3>
<div class="tw"><table class="cmp">
<tr><th>Chủ đề</th><th>Chi tiết</th></tr>
...
<section id="t510">
<h3>Replica đọc và availability group trên Managed Instance<a class="nl" href="/dp-300/documents#s90">docs 5.12</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=Azure%20SQL%20MI,Availability%20Group" title="Ôn 24 câu: Azure SQL MI, Availability Group (tab mới)">ôn 24 câu</a></h3>
<p class="lead">Study guide ghi <i>Configure Always On availability groups on <b>SQL Managed Instance</b> and Azure virtual machines</i>. Trên MI bạn không dựng AG bằng tay như trên VM — nền tảng đã có sẵn AG bên trong Business Critical, và thứ bạn thật sự cấu hình là <b>replica đọc</b> cùng <a href="#t113">MI link</a>. Nguồn: <i>Read queries on replicas (read scale-out)</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Service tier</th><th>Có replica đọc không</th><th>Bật/tắt thế nào</th></tr>
<tr><td>Business Critical / Premium</td><td><b>Có</b> — 1 primary đọc-ghi + ít nhất 1 secondary chỉ đọc, <b>cùng compute size</b>, <b>không tính thêm tiền</b></td><td>SQL Database: bật mặc định, tắt/bật được ở portal (Compute + storage) hoặc <code>Set-AzSqlDatabase -ReadScale Disabled</code>. <b>MI Business Critical: luôn bật, không tắt được</b></td></tr>
<tr><td>Hyperscale</td><td>Có khi thêm ít nhất <b>1 secondary replica</b>; nhiều HA replica thì được cân tải, ngoài ra còn <b>named replica</b> để tách hẳn workload</td><td>Bật mặc định; 0 secondary replica thì tự tắt</td></tr>
<tr><td>General Purpose / Standard / Basic</td><td><b>Không có replica nào</b> → không có read scale-out</td><td>Thay thế: <b>geo-replica</b> (Azure SQL Database) hoặc <b>read-only listener của failover group</b> (Managed Instance)</td></tr>
</table></div>
<div class="tw"><table class="cmp">
<tr><th>Chủ đề</th><th>Chi tiết</th></tr>
<tr><td>Định tuyến</td><td>Connection string có <code>ApplicationIntent=ReadOnly</code> thì đi vào replica đọc; <code>ReadWrite</code> hoặc không ghi gì thì vào primary. SSMS: Options → <b>Additional Connection Parameters</b></td></tr>
<tr><td>Kiểm tra đang ở đâu</td><td><code>SELECT DATABASEPROPERTYEX(DB_NAME(), 'Updateability');</code> → trả <b>READ_ONLY</b> nghĩa là đang ở replica đọc</td></tr>
<tr><td>Số replica truy cập được</td><td>Premium/Business Critical: <b>chỉ một</b> replica đọc tại một thời điểm. Hyperscale: nhiều replica</td></tr>
<tr><td>Độ trễ dữ liệu</td><td>Đọc trên replica <b>luôn bất đồng bộ</b> so với primary; thường vài chục ms đến vài giây nhưng <b>không có giới hạn trên</b>. Cần đọc thấy ngay cái vừa ghi thì phải dùng primary</td></tr>
<tr><td>Isolation level</td><td>Trên replica đọc <b>luôn là snapshot</b>, bỏ qua isolation level của session và mọi hint</td></tr>
<tr><td>tempdb</td><td>Mỗi replica có <code>tempdb</code> riêng, không replicate — object tạm phải tạo ngay trong chính workload đang chạy trên replica đó</td></tr>
<tr><td>Query Store, auditing, auto-tuning</td><td>Query Store trên secondary <b>có hỗ trợ</b> (SQL DB và MI); auditing trên replica đọc <b>tự bật</b>; automatic plan correction chạy được trên replica nếu bật riêng</td></tr>
<tr><td>Extended Events</td><td><b>Không tạo</b> session khi đang nối vào replica đọc. Định nghĩa session database-scoped tạo ở primary sẽ replicate xuống. Trên <b>MI</b> phải start trace ở primary <i>trước</i> rồi mới start ở replica, không thì lỗi <i>Msg 3906 … database "master" is read-only</i></td></tr>
<tr><td>Không hỗ trợ</td><td><b>SQL Profiler</b> trên replica đọc</td></tr>
<tr><td>Lỗi hay gặp trên replica</td><td><b>3961</b> (metadata bị DDL sửa ở primary), <b>1219</b>, <b>3947</b> (không kịp redo), <b>3948</b> (ghost record đã bị dọn) — cách xử lý chung là <b>chạy lại query</b>, và tránh đổi schema/index/statistics ở primary khi đang có query dài trên replica</td></tr>
<tr><td>Kèm geo-replication</td><td>Nối vào geo-secondary với <code>ApplicationIntent=ReadOnly</code> thì được đưa tiếp sang HA replica của chính geo-secondary → mỗi geo-replica cho thêm một bộ replica đọc. <b>Không có round-robin</b> giữa các replica (trừ geo-replica Hyperscale có nhiều HA replica)</td></tr>
<tr><td>Giám sát độ trễ</td><td><code>sys.dm_database_replica_states</code> — cột <code>redo_queue_size</code> và <code>redo_rate</code>; thêm <code>sys.dm_db_resource_stats</code>, <code>sys.dm_os_wait_stats</code></td></tr>
<tr><td>"AG" trên MI nghĩa là gì</td><td>MI <b>không cho tạo/cấu hình AG bằng tay</b>: Business Critical dùng AG nội bộ do nền tảng quản (đó là nguồn của replica đọc và của SLA cao hơn). Muốn có availability group nối với một SQL Server thật thì dùng <a href="#t113">MI link</a> — bên dưới là <b>distributed availability group</b>. Còn <a href="#t505">auto-failover group</a> là chuyện khác: DR giữa hai region, có <b>read-only listener</b> riêng</td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> đề nói "báo cáo nặng làm chậm giao dịch, ngân sách không tăng" trên Business Critical/Premium → đáp án là <b>thêm <code>ApplicationIntent=ReadOnly</code></b>, không phải scale lên hay tạo geo-replica. Nhưng đề nói tier là <b>General Purpose</b> thì phương án đó vô nghĩa — ở đó không có replica nào để đọc.</p>
</section>

<section id="t511">
<h3>Contained availability group — SQL Server 2022 trở lên<a class="nl" href="/dp-300/documents#s90-2">docs 5.13</a><a class="ql" target="_blank" rel="noopener" href="/dp-300/practice?topic=AG%20setup,AG%20listener" title="Ôn 14 câu: AG setup, AG listener (tab mới)">ôn 14 câu</a></h3>
<p class="lead">Vấn đề kinh điển của AG thường: login, SQL Agent job, quyền — những thứ nằm trong <code>master</code>/<code>msdb</code> — <b>không</b> đi theo AG, phải chép tay sang từng replica. Contained AG là câu trả lời chính thức cho chuyện đó. Nguồn: <i>What is a contained availability group?</i> trên Microsoft Learn, đối chiếu ngày 26/08/2026.</p>
<div class="tw"><table class="cmp">
<tr><th>Chủ đề</th><th>Chi tiết</th></tr>
<tr><td>Từ phiên bản nào</td><td><b>SQL Server 2022 (16.x)</b> trở lên. SQL Server 2025 thêm hỗ trợ <b>distributed AG</b> giữa hai contained AG</td></tr>
<tr><td>Chứa gì</td><td>Ngoài user database, AG có <code>master</code> và <code>msdb</code> <b>riêng</b>, tên là <code>&lt;TênAG&gt;_master</code> và <code>&lt;TênAG&gt;_msdb</code>. Login, user, quyền, Agent job tạo ở cấp AG <b>tự đồng nhất</b> trên mọi replica</td></tr>
<tr><td>Tạo</td><td><code>CREATE AVAILABILITY GROUP … WITH (CONTAINED)</code>. Thêm <code>REUSE_SYSTEM_DATABASES</code> để dùng lại system database của một contained AG cùng tên trước đó; <code>AUTOSEEDING_SYSTEM_DATABASES</code> (SQL Server 2025) khi AG này sẽ làm <b>forwarder</b> trong distributed AG</td></tr>
<tr><td>Listener là bắt buộc</td><td>Chỉ khi kết nối qua <b>listener</b> (hoặc kết nối thẳng vào một database thuộc AG) bạn mới ở trong môi trường contained. Nối vào instance thì bạn đang ở môi trường của instance — login tạo trong contained AG <b>không đăng nhập được</b></td></tr>
<tr><td>System database ban đầu</td><td>Là <b>template rỗng</b>, không phải bản sao của instance. Chỉ các login thuộc <b>sysadmin</b> của instance được chép sang. User cũ của instance <b>mất quyền ngay</b> khi database gia nhập AG — phải tạo lại bên trong contained AG</td></tr>
<tr><td>Seeding</td><td>System database contained <b>chỉ dùng automatic seeding</b>. Ở 2022 trở về trước: lúc tạo AG chỉ đưa vào các user database seed tự động được, database lớn thì thêm sau bằng <code>JOIN ONLY</code></td></tr>
<tr><td>Agent job</td><td>Job của contained AG <b>chỉ chạy trên primary</b>, không chạy trên secondary</td></tr>
<tr><td>Không phải ranh giới bảo mật</td><td>Docs nói thẳng: contained AG chỉ để đồng nhất cấu hình. Kết nối vào contained AG vẫn chạm được database ngoài AG bằng tên ba phần hoặc <code>USE</code></td></tr>
<tr><td>Nhìn thấy gì khi kết nối</td><td>Chỉ database trong AG cộng <code>tempdb</code>. Bên trong AG, hai system database mang tên <code>master</code>/<code>msdb</code> và database ID của master là <b>1</b>; nhìn từ instance thì tên là <code>&lt;AG&gt;_master</code>/<code>&lt;AG&gt;_msdb</code></td></tr>
<tr><td><code>sp_configure</code></td><td><b>Đọc</b> được từ kết nối contained, chỉ <b>ghi</b> được từ kết nối cấp instance</td></tr>
<tr><td>Audit</td><td>Audit cấp server phải tạo <b>lại trong từng contained AG</b> — vì master là riêng</td></tr>
<tr><td>TDE</td><td>Phải tự cài DMK vào contained <code>master</code>; SQL Server tìm certificate ở cả master của instance lẫn contained master, không thấy thì database không online được</td></tr>
<tr><td>Read-only routing</td><td>Connection string phải nêu <b>một database thuộc AG</b> cùng với <code>ApplicationIntent=ReadOnly</code>, và user phải có quyền trên database đó</td></tr>
<tr><td>Resource Governor</td><td>Chỉ dùng được từ <b>SQL Server 2022 CU18</b>; cấu hình ở cấp instance, và phải cấu hình <b>giống nhau trên mọi replica</b> (không tự lan theo AG)</td></tr>
<tr><td>Change data capture</td><td>Cần SQL Agent chạy trên <b>mọi</b> replica; cấu hình CDC khi đang nối qua listener để metadata nằm trong system database contained</td></tr>
<tr><td><b>Không hỗ trợ</b></td><td>Replication mọi loại (transactional, merge, snapshot) · log shipping mà <b>đích</b> nằm trong contained AG (nguồn thì được) · SSIS package và maintenance plan</td></tr>
<tr><td>Catalog view</td><td><code>sys.availability_groups.is_contained</code> · <code>sys.dm_exec_sessions.contained_availability_group_id</code></td></tr>
</table></div>
<p class="lead"><b>Bẫy hay gặp:</b> nhầm contained AG với <b>contained database</b>. Contained database chỉ đưa user vào trong chính database đó và phạm vi gói gọn ở database ấy; contained AG đưa login, quyền và job vào <b>cấp AG</b> và tự đồng bộ sang mọi replica. Khôi phục system database contained không restore đè được: phải drop AG → restore contained master/msdb ở primary → drop chúng ở secondary → tạo lại AG cùng tên với <code>WITH (CONTAINED, REUSE_SYSTEM_DATABASES)</code> và <code>SEEDING_MODE = AUTOMATIC</code>.</p>
</section>
...
<tr><td>4 TB (Hyperscale 128 TB) / 256 TB</td><td>SQL Database / instance trên VM</td></tr>
...
`,lt={class:"tables-dp"},gt={class:"layout"},bt={class:"sub"},ut={class:"search"},pt={key:0,class:"cnt"},mt={key:1,class:"cnt"},yt={key:2,class:"toc-nav"},vt={key:0},St=["href","onClick"],Et={class:"topbar"},At={key:0,class:"nohit"},_t=rt({__name:"Dp300TablesPage",setup(kt){st("dp300","notes");const Q=ot(),k=p(),b=p(),v=p(matchMedia("(max-width:960px)").matches),B=(()=>{const n=new DOMParser().parseFromString(P,"text/html"),t=[];return n.body.childNodes.forEach(r=>{if(r instanceof HTMLElement){if(r.tagName==="H2")t.push({id:r.id,title:r.textContent||"",items:[]});else if(r.tagName==="SECTION"&&t.length){const d=r.querySelector("h3");if(!d)return;const e=d.cloneNode(!0);e.querySelectorAll(".nl, .ql").forEach(i=>i.remove()),t[t.length-1].items.push({id:r.id,title:(e.textContent||"").trim()})}}}),t})(),R=B.reduce((n,t)=>n+t.items.length,0),j=(P.match(/<table class="cmp"/g)||[]).length,D=p(""),m=p(null),C=p(0),T=p(0),w=Y(()=>m.value!==null),G=Y(()=>{var n;return((n=m.value)==null?void 0:n.size)??R}),K=n=>!m.value||m.value.has(n);let y=[],S=null,L=null,M;const I=n=>(n||"").toLowerCase();function J(n){const t=n.cloneNode(!0);return t.querySelectorAll(".nl, .ql").forEach(r=>r.remove()),t.textContent}function Z(){y=[...k.value.querySelectorAll("section")].map(n=>{const t=[...n.querySelectorAll("h3, p.lead")],r=[...n.querySelectorAll(".tw")].map(d=>({tw:d,rows:[...d.querySelectorAll("tr")].map(e=>({tr:e,text:I(e.textContent),head:!!e.querySelector("th")}))}));return{el:n,id:n.id,head:t.map(d=>I(d.querySelector(".nl, .ql")?J(d):d.textContent)).join(" "),heads:t,tbls:r,rows:r.flatMap(d=>d.rows)}}),T.value=y.reduce((n,t)=>n+t.rows.filter(r=>!r.head).length,0),C.value=T.value}function $(n){n.querySelectorAll("mark").forEach(t=>t.replaceWith(document.createTextNode(t.textContent||""))),n.normalize()}function x(n,t){const r=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),d=[];let e;for(;e=r.nextNode();)I(e.nodeValue).includes(t)&&d.push(e);d.forEach(i=>{const u=document.createDocumentFragment(),a=i.nodeValue||"",E=a.toLowerCase();let o=0,g;for(;(g=E.indexOf(t,o))>-1;){u.appendChild(document.createTextNode(a.slice(o,g)));const z=document.createElement("mark");z.textContent=a.slice(g,g+t.length),u.appendChild(z),o=g+t.length}u.appendChild(document.createTextNode(a.slice(o))),i.replaceWith(u)})}function q(){const n=b.value.value.trim().toLowerCase();if(y.forEach(d=>{$(d.el),d.rows.forEach(e=>e.tr.classList.remove("hit"))}),!n){y.forEach(d=>{d.el.classList.remove("hidden"),d.tbls.forEach(e=>e.tw.classList.remove("hidden")),d.rows.forEach(e=>e.tr.classList.remove("hidden"))}),k.value.querySelectorAll("h2.dom").forEach(d=>d.classList.remove("hidden")),m.value=null,C.value=T.value;return}k.value.querySelectorAll("h2.dom").forEach(d=>d.classList.add("hidden"));const t=new Set;let r=0;y.forEach(d=>{const e=d.head.includes(n);let i=0;d.tbls.forEach(a=>{let E=0;a.rows.forEach(o=>{const g=e||o.text.includes(n);o.tr.classList.toggle("hidden",!(g||o.head)),g&&!o.head&&(E++,e||o.tr.classList.add("hit"))}),a.tw.classList.toggle("hidden",E===0),i+=E});const u=e||i>0;d.el.classList.toggle("hidden",!u),u&&(t.add(d.id),r+=i,d.heads.forEach(a=>x(a,n)),d.rows.forEach(a=>{a.tr.classList.contains("hidden")||x(a.tr,n)}))}),m.value=t,C.value=r}function tt(){clearTimeout(M),M=setTimeout(q,120)}function nt(){b.value.value="",q()}function V(n){n.key==="/"&&document.activeElement!==b.value&&(n.preventDefault(),b.value.focus()),n.key==="Escape"&&document.activeElement===b.value&&(nt(),b.value.blur())}function H(n){const t=document.getElementById(n);t&&(L==null||L.classList.remove("flash"),t.scrollIntoView({block:"start"}),t.offsetWidth,t.classList.add("flash"),L=t,D.value=n,matchMedia("(max-width:960px)").matches&&(v.value=!0))}function dt(n,t){n.preventDefault(),Q.replace({hash:`#${t}`}),H(t)}function et(n){var d,e;const t=(e=(d=n.target).closest)==null?void 0:e.call(d,"a");if(!t)return;const r=t.getAttribute("href")||"";r.startsWith("/")&&t.getAttribute("target")!=="_blank"&&(n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||n.button!==0||(n.preventDefault(),Q.push(r)))}return ct(()=>{Z(),typeof IntersectionObserver<"u"&&(S=new IntersectionObserver(n=>n.forEach(t=>{t.isIntersecting&&(D.value=t.target.id)}),{rootMargin:"0px 0px -75% 0px"}),y.forEach(n=>S.observe(n.el))),location.hash&&H(decodeURIComponent(location.hash.slice(1))),document.addEventListener("keydown",V)}),at(()=>{document.removeEventListener("keydown",V),S==null||S.disconnect(),clearTimeout(M)}),(n,t)=>{const r=it("router-link");return s(),h("div",lt,[c("div",gt,[c("aside",null,[t[2]||(t[2]=c("h1",null,"DP-300 · Bảng ôn nhanh",-1)),c("div",bt,l(A(R))+" mục · "+l(A(j))+" bảng, tổng hợp từ tài liệu DP-300",1),c("div",ut,[c("input",{ref_key:"qEl",ref:b,type:"search",placeholder:"Tìm trong bảng… (/)",autocomplete:"off",onInput:tt},null,544)]),w.value?(s(),h("p",pt,l(G.value)+"/"+l(A(R))+" mục · "+l(C.value)+"/"+l(T.value)+" dòng ",1)):(s(),h("p",mt,"Gõ “/” để tìm — kết quả lọc tới từng dòng của bảng.")),v.value?N("",!0):(s(),h("nav",yt,[(s(!0),h(f,null,U(A(B),d=>(s(),h(f,{key:d.id},[d.items.some(e=>K(e.id))?(s(),h("h4",vt,l(d.title),1)):N("",!0),c("ol",null,[(s(!0),h(f,null,U(d.items,e=>(s(),h("li",{key:e.id,class:W({hidden:!K(e.id)})},[c("a",{href:"#"+e.id,class:W({on:D.value===e.id}),onClick:i=>dt(i,e.id)},l(e.title),11,St)],2))),128))])],64))),128))]))]),c("main",null,[c("div",Et,[_(r,{to:"/dp-300/documents"},{default:O(()=>[...t[3]||(t[3]=[X("← Tài liệu",-1)])]),_:1}),_(r,{to:"/dp-300/practice"},{default:O(()=>[...t[4]||(t[4]=[X("Luyện tập",-1)])]),_:1}),t[6]||(t[6]=c("span",{class:"spacer"},null,-1)),c("button",{onClick:t[0]||(t[0]=d=>v.value=!v.value)},l(v.value?"Mở mục lục":"Thu gọn mục lục"),1),_(ht),_(r,{to:"/",style:{"text-decoration":"none"}},{default:O(()=>[...t[5]||(t[5]=[c("button",null,"🏠",-1)])]),_:1})]),t[7]||(t[7]=c("p",{class:"intro"}," Toàn bộ kiến thức trong tài liệu, viết lại thành bảng so sánh để ôn nhanh. Mỗi mục có link “note” dẫn sang phần giải thích đầy đủ. Trang này không nằm trong tài liệu và không sửa gì ở đó. ",-1)),t[1]||(F(-1,!0),(t[1]=c("div",{ref_key:"contentEl",ref:k,innerHTML:A(P),onClick:et},null,8,["innerHTML"])).cacheIndex=1,F(1),t[1]),w.value&&G.value===0?(s(),h("div",At,"Không tìm thấy dòng nào khớp.")):N("",!0)])])])}}});export{_t as default};
