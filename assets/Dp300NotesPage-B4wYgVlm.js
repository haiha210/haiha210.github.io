const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/packs-yV1C62D9.js","assets/index-BdShzq7_.js","assets/index-XuT8dMLP.css"])))=>i.map(i=>d[i]);
import{d as Aa,Z as Ea,K as Ta,r as o,J as La,z as ka,$ as Ca,M as Ra,c as m,a as l,i as c,t as p,E as la,g as x,F as Da,h as Ia,n as ia,Y as q,e as b,b as _,w as U,q as V,k as wa,x as Ma,a0 as Na,o as y}from"./index-BdShzq7_.js";import{_ as qa}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-Rk4BaiI0.js";import{u as _a}from"./useStudyClock-D-nq-JX3.js";const Oa=`<h2 class="dom" id="dom1">1 · Plan and implement data platform resources</h2>
<section id="s-sec1"><h3><span class="n">1.1.</span> <span class="lang-en">Domain 1 at a glance — platform and migration summary tables</span><span class="lang-vi">Tổng hợp phạm vi 1 — bảng ôn nhanh về nền tảng và di trú</span><a class="anch" href="#s-sec1" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A synthesis of every section in domain 1 for revision; the platform comparison tables (PaaS vs IaaS, features, scale, HA/DR, security) already live in section 1.2 just below.</span><span class="lang-vi">Tổng hợp toàn bộ các mục của phạm vi 1 để ôn nhanh; các bảng so sánh nền tảng (PaaS vs IaaS, tính năng, khả năng mở rộng, HA/DR, bảo mật) đã có sẵn ở mục 1.2 ngay bên dưới.</span></li>
</ul>
...
<section id="s6a"><h3><span class="n">1.3.</span> <span class="lang-en">Identify use cases for Azure Arc-enabled SQL services</span><span class="lang-vi">Xác định các tình huống dùng Azure Arc-enabled SQL services</span><a class="anch" href="#s6a" title="Link tới mục này">#</a></h3>
...
<section id="s6b"><h3><span class="n">1.4.</span> <span class="lang-en">Identify use cases for Azure SQL Database in Microsoft Fabric</span><span class="lang-vi">Xác định các tình huống dùng Azure SQL Database trong Microsoft Fabric</span><a class="anch" href="#s6b" title="Link tới mục này">#</a></h3>
...
<section id="s1"><h3><span class="n">1.5.</span> <span class="lang-en">deploy database offerings on selected platforms</span><span class="lang-vi">triển khai database trên các nền tảng được chọn</span><a class="anch" href="#s1" title="Link tới mục này">#</a></h3>
...
<li class="stale"><span class="lang-en"><b>12 is the virtual machine number, not the Azure SQL number.</b> 12–123 characters is what the Azure portal demands for the admin password of a <i>VM</i>. Azure SQL asks for something else: the admin password of an Azure SQL Database logical server must be at least <b>8</b> characters (up to 128), and the admin password of an Azure SQL Managed Instance must be at least <b>16</b> characters. A 12-character password is rejected by MI validation, so the deployment never starts. All of them must also meet complexity — characters from three of the four categories (uppercase, lowercase, digit, special). Per Microsoft Learn, August 2026.</span><span class="lang-vi"><b>12 là con số của máy ảo, không phải của Azure SQL.</b> 12–123 ký tự là yêu cầu của Azure portal cho mật khẩu admin của <i>VM</i>. Azure SQL đòi con số khác: mật khẩu admin của logical server Azure SQL Database tối thiểu <b>8</b> ký tự (tối đa 128), còn của Azure SQL Managed Instance tối thiểu <b>16</b> ký tự. Đặt 12 ký tự thì MI báo lỗi validation, deployment không chạy. Cả ba đều phải thoả độ phức tạp — ký tự thuộc 3 trong 4 nhóm (chữ hoa, chữ thường, chữ số, ký tự đặc biệt). Theo Microsoft Learn, 8/2026.</span></li>
...
<li class="stale"><span class="lang-en"><b>What the portal validates on these three values.</b> The <b>instance name</b> must be unique across all of Azure, not merely inside the resource group — it becomes the public FQDN <code>&lt;name&gt;.&lt;dns-zone&gt;.database.windows.net</code>. The <b>admin login</b> cannot be <code>sa</code> (Azure SQL has no <code>sa</code> login) or a reserved name such as <code>admin</code>, <code>administrator</code>, <code>root</code>, <code>guest</code>; Microsoft also says not to use <code>serveradmin</code>, the name of a server-level role. The <b>admin password</b> must be at least 16 characters. Getting any of them wrong means the portal refuses to submit the deployment.</span><span class="lang-vi"><b>Ba giá trị này bị portal kiểm trước khi cho deploy.</b> <b>Tên instance</b> phải duy nhất trên toàn Azure chứ không chỉ trong resource group — nó trở thành FQDN công khai <code>&lt;name&gt;.&lt;dns-zone&gt;.database.windows.net</code>. <b>Login admin</b> không được đặt là <code>sa</code> (Azure SQL không có login <code>sa</code>) hay các tên dành riêng như <code>admin</code>, <code>administrator</code>, <code>root</code>, <code>guest</code>; Microsoft còn dặn tránh <code>serveradmin</code> vì trùng tên một server-level role. <b>Mật khẩu admin</b> tối thiểu 16 ký tự. Sai một trong ba là portal không cho submit deployment.</span></li>
...
<section id="s2"><h3><span class="n">1.6.</span> <span class="lang-en">Choose an automated deployment method</span><span class="lang-vi">Chọn phương thức triển khai tự động</span><a class="anch" href="#s2" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topics 1.8–1.10.</span><span class="lang-vi">Xem các mục 1.8–1.10.</span></li>
</ul></section>
<section id="s3"><h3><span class="n">1.7.</span> <span class="lang-en">apply patches and updates for hybrid and IaaS deployment</span><span class="lang-vi">áp dụng patch và bản cập nhật cho triển khai hybrid và IaaS</span><a class="anch" href="#s3" title="Link tới mục này">#</a></h3>
...
<section id="s9"><h3><span class="n">1.8.</span> <span class="lang-en">configure Azure SQL Database for scale and performance</span><span class="lang-vi">cấu hình Azure SQL Database để mở rộng và tối ưu hiệu năng</span><a class="anch" href="#s9" title="Link tới mục này">#</a></h3>
...
<section id="s10"><h3><span class="n">1.9.</span> <span class="lang-en">configure Azure SQL Managed Instance for scale and performance</span><span class="lang-vi">cấu hình Azure SQL Managed Instance để mở rộng và tối ưu hiệu năng</span><a class="anch" href="#s10" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en">See topic 1.8 for more details of the vCore compute model.</span><span class="lang-vi">Xem mục 1.8 để biết chi tiết về mô hình compute theo vCore.</span></li>
...
<section id="s11"><h3><span class="n">1.10.</span> <span class="lang-en">configure SQL Server in Azure VMs for scale and performance</span><span class="lang-vi">cấu hình SQL Server trên Azure VM để mở rộng và tối ưu hiệu năng</span><a class="anch" href="#s11" title="Link tới mục này">#</a></h3>
...
<section id="s11-2"><h3><span class="n">1.11.</span> <span class="lang-en">configure storage and infrastructure resources</span><span class="lang-vi">cấu hình lưu trữ và tài nguyên hạ tầng</span><a class="anch" href="#s11-2" title="Link tới mục này">#</a></h3>
...
<section id="s-16"><h3><span class="n">1.12.</span> <span class="lang-en">calculate resource requirements</span><span class="lang-vi">tính toán yêu cầu tài nguyên</span><a class="anch" href="#s-16" title="Link tới mục này">#</a></h3>
...
<section id="s7"><h3><span class="n">1.13.</span> <span class="lang-en">Plan for table partitioning</span><span class="lang-vi">Lập kế hoạch phân vùng bảng</span><a class="anch" href="#s7" title="Link tới mục này">#</a></h3>
...
<section id="s8"><h3><span class="n">1.14.</span> <span class="lang-en">evaluate database partitioning techniques, such as database sharding</span><span class="lang-vi">đánh giá các kỹ thuật phân vùng database, chẳng hạn database sharding</span><a class="anch" href="#s8" title="Link tới mục này">#</a></h3>
...
<section id="s13"><h3><span class="n">1.15.</span> <span class="lang-en">evaluate the use of compression for tables and indexes</span><span class="lang-vi">đánh giá việc dùng compression cho bảng và index</span><a class="anch" href="#s13" title="Link tới mục này">#</a></h3>
...
<section id="s14"><h3><span class="n">1.16.</span> <span class="lang-en">evaluate requirements for the migration</span><span class="lang-vi">đánh giá yêu cầu cho việc migration</span><a class="anch" href="#s14" title="Link tới mục này">#</a></h3>
...
<section id="s15"><h3><span class="n">1.17.</span> <span class="lang-en">evaluate offline or online migration strategies</span><span class="lang-vi">đánh giá chiến lược migration offline hay online</span><a class="anch" href="#s15" title="Link tới mục này">#</a></h3>
...
<section id="s16"><h3><span class="n">1.18.</span> <span class="lang-en">implement an online migration strategy</span><span class="lang-vi">triển khai chiến lược migration online</span><a class="anch" href="#s16" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topic 20.</span><span class="lang-vi">Xem mục 20.</span></li>
</ul></section>
<section id="s16-2"><h3><span class="n">1.19.</span> <span class="lang-en">implement an offline migration strategy</span><span class="lang-vi">triển khai chiến lược migration offline</span><a class="anch" href="#s16-2" title="Link tới mục này">#</a></h3>
...
<section id="s18"><h3><span class="n">1.20.</span> <span class="lang-en">Perform post migration validations</span><span class="lang-vi">Thực hiện kiểm định sau migration</span><a class="anch" href="#s18" title="Link tới mục này">#</a></h3>
...
<section id="s18a"><h3><span class="n">1.21.</span> <span class="lang-en">troubleshoot a migration</span><span class="lang-vi">xử lý sự cố migration</span><a class="anch" href="#s18a" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">DMS online to MI stuck at 'Restoring': check that you supplied <b>full + log backups</b> (DMS never takes its own backups and ignores differentials), each backup set is in its own folder, and no backup uses multiple stripes with mixed order.</span><span class="lang-vi">DMS online sang MI kẹt ở 'Restoring': kiểm tra đã cung cấp <b>full + log backup</b> (DMS không tự backup và bỏ qua differential), mỗi bộ backup một thư mục riêng, và không có backup chia stripe lộn thứ tự.</span></li>
<li><span class="lang-en">Cutover never completes: the tail-log backup is missing or new transactions keep arriving — quiesce the source, take the final log backup, then cut over.</span><span class="lang-vi">Cutover mãi không xong: thiếu tail-log backup hoặc giao dịch mới vẫn đổ vào — chặn ghi ở nguồn, lấy log backup cuối cùng rồi mới cutover.</span></li>
<li><span class="lang-en">Connectivity failures: DMS needs outbound 443/1433 (and 3342 for MI public endpoint); check NSG, firewall and that the storage account allows the DMS subnet.</span><span class="lang-vi">Lỗi kết nối: DMS cần outbound 443/1433 (và 3342 cho public endpoint của MI); kiểm tra NSG, firewall và storage account có cho subnet của DMS không.</span></li>
<li><span class="lang-en">App is slow right after migration: statistics are stale and the compatibility level may have jumped — run <code>UPDATE STATISTICS</code>/<code>sp_updatestats</code>, keep the old compatibility level until Query Store has a baseline, then raise it and compare.</span><span class="lang-vi">App chậm ngay sau migration: statistics cũ và compatibility level có thể vừa nhảy — chạy <code>UPDATE STATISTICS</code>/<code>sp_updatestats</code>, giữ compatibility level cũ tới khi Query Store có baseline rồi mới nâng và so sánh.</span></li>
<li><span class="lang-en">Login failures after migration: SQL logins moved but their SIDs do not match database users (orphaned users) — remap with <code>ALTER USER ... WITH LOGIN</code>.</span><span class="lang-vi">Lỗi đăng nhập sau migration: SQL login đã chuyển nhưng SID không khớp user trong database (orphaned user) — ánh xạ lại bằng <code>ALTER USER ... WITH LOGIN</code>.</span></li>
</ul>
<ul><li class="stale"><span class="lang-en">Section added from the official study guide (skills as of April 24, 2026) — the original notes did not cover this task statement. Per Microsoft Learn, August 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc chưa phủ task statement này. Theo Microsoft Learn, 8/2026.</span></li></ul></section>
<section id="s20"><h3><span class="n">1.22.</span> <span class="lang-en">set up SQL Data Sync</span><span class="lang-vi">thiết lập SQL Data Sync</span><a class="anch" href="#s20" title="Link tới mục này">#</a></h3><ul><li class="stale"><span class="lang-en"><b>SQL Data Sync is scheduled for retirement on 30 September 2027.</b> Learn the constraints below for exam questions that still reference it, but for new designs Microsoft recommends transactional replication, Azure Data Factory, Azure Functions or availability-group readable secondaries instead. Per Microsoft Learn, August 2026.</span><span class="lang-vi"><b>SQL Data Sync đã có lịch khai tử: ngừng hoạt động ngày 30/09/2027.</b> Vẫn nên nắm các ràng buộc bên dưới vì câu hỏi thi còn nhắc tới, nhưng thiết kế mới thì Microsoft khuyến nghị dùng transactional replication, Azure Data Factory, Azure Functions hoặc secondary đọc được của availability group. Theo Microsoft Learn, 8/2026.</span></li></ul>
...
<section id="s22"><h3><span class="n">1.23.</span> <span class="lang-en">Implement a migration between Azure SQL services</span><span class="lang-vi">Thực hiện migration giữa các dịch vụ Azure SQL</span><a class="anch" href="#s22" title="Link tới mục này">#</a></h3>
...
<section id="s22a"><h3><span class="n">1.24.</span> <span class="lang-en">implement Azure SQL Managed Instance database copy and move</span><span class="lang-vi">thực hiện copy và move database của Azure SQL Managed Instance</span><a class="anch" href="#s22a" title="Link tới mục này">#</a></h3>
...
<section id="s-sec2"><h3><span class="n">2.1.</span> <span class="lang-en">Domain 2 at a glance — security summary tables</span><span class="lang-vi">Tổng hợp phạm vi 2 — bảng ôn nhanh về bảo mật</span><a class="anch" href="#s-sec2" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A synthesis of every section in domain 2 for revision; every row links to the section that explains it in full.</span><span class="lang-vi">Đây là bản tổng hợp toàn bộ các mục của phạm vi 2 để ôn nhanh; mỗi dòng có link dẫn tới mục giải thích đầy đủ.</span></li>
...
<section id="s23"><h3><span class="n">2.2.</span> <span class="lang-en">configure authentication by using Active Directory and Entra ID</span><span class="lang-vi">cấu hình xác thực bằng Active Directory và Entra ID</span><a class="anch" href="#s23" title="Link tới mục này">#</a></h3>
...
<section id="s23a"><h3><span class="n">2.3.</span> <span class="lang-en">Configure authentication for SQL on Azure VMs and Azure SQL Managed</span><span class="lang-vi">Cấu hình xác thực cho SQL trên Azure VM và Azure SQL Managed</span><a class="anch" href="#s23a" title="Link tới mục này">#</a></h3>
...
<section id="s24"><h3><span class="n">2.4.</span> <span class="lang-en">create users from Entra ID identities</span><span class="lang-vi">tạo user từ danh tính Entra ID</span><a class="anch" href="#s24" title="Link tới mục này">#</a></h3>
...
<section id="s25"><h3><span class="n">2.5.</span> <span class="lang-en">configure security principals</span><span class="lang-vi">cấu hình security principal</span><a class="anch" href="#s25" title="Link tới mục này">#</a></h3>
...
<section id="s26"><h3><span class="n">2.6.</span> <span class="lang-en">configure database and object-level permissions using graphical tools</span><span class="lang-vi">cấu hình quyền cấp database và cấp object bằng công cụ đồ họa</span><a class="anch" href="#s26" title="Link tới mục này">#</a></h3>
...
<section id="s27"><h3><span class="n">2.7.</span> <span class="lang-en">apply principle of least privilege for all securables</span><span class="lang-vi">áp dụng nguyên tắc đặc quyền tối thiểu cho mọi securable</span><a class="anch" href="#s27" title="Link tới mục này">#</a></h3>
...
<section id="s29-2"><h3><span class="n">2.8.</span> <span class="lang-en">manage security principals</span><span class="lang-vi">quản lý security principal</span><a class="anch" href="#s29-2" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en">You can give permissions on a stored procedure/function without giving permissions on the underlying tables/views through ownership chaining (see topic 2.7).</span><span class="lang-vi">Bạn có thể cấp quyền trên stored procedure/function mà không cần cấp quyền trên bảng/view bên dưới, nhờ ownership chaining (xem mục 2.7).</span></li>
...
<section id="s29-3"><h3><span class="n">2.9.</span> <span class="lang-en">configure permissions for users to access database objects</span><span class="lang-vi">cấu hình quyền cho user truy cập các object trong database</span><a class="anch" href="#s29-3" title="Link tới mục này">#</a></h3>
...
<section id="s29-4"><h3><span class="n">2.10.</span> <span class="lang-en">configure permissions by using custom roles</span><span class="lang-vi">cấu hình quyền bằng custom role</span><a class="anch" href="#s29-4" title="Link tới mục này">#</a></h3>
...
<section id="s28a"><h3><span class="n">2.11.</span> <span class="lang-en">troubleshoot authentication and authorization issues</span><span class="lang-vi">xử lý sự cố xác thực và phân quyền</span><a class="anch" href="#s28a" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">Error <b>18456</b> 'Login failed': the state number in the error log tells the cause — 5 = login does not exist, 7 = disabled, 8 = wrong password, 38/40 = default database unavailable.</span><span class="lang-vi">Lỗi <b>18456</b> 'Login failed': con số state trong error log chỉ ra nguyên nhân — 5 = login không tồn tại, 7 = bị disable, 8 = sai mật khẩu, 38/40 = default database không truy cập được.</span></li>
<li><span class="lang-en">Entra ID login fails on Azure SQL: the contained user was never created — run <code>CREATE USER [user@domain] FROM EXTERNAL PROVIDER</code> in the target database; also check the server has an Entra admin set.</span><span class="lang-vi">Đăng nhập Entra ID thất bại trên Azure SQL: contained user chưa được tạo — chạy <code>CREATE USER [user@domain] FROM EXTERNAL PROVIDER</code> trong database đích; kiểm tra server đã đặt Entra admin chưa.</span></li>
<li><span class="lang-en">Connection rejected before authentication: firewall — error 40615 (IP not allowed) means server/database firewall rules, not credentials; with Private Link check the private DNS zone resolves to the private IP.</span><span class="lang-vi">Bị chặn trước cả bước xác thực: firewall — lỗi 40615 (IP không được phép) là do firewall rule cấp server/database, không phải sai mật khẩu; dùng Private Link thì kiểm tra private DNS zone có trả về private IP không.</span></li>
<li><span class="lang-en">'Permission denied' although the role looks right: check effective permissions with <code>fn_my_permissions</code> / <code>HAS_PERMS_BY_NAME</code>; remember an explicit <b>DENY</b> (often via a role) overrides every GRANT.</span><span class="lang-vi">'Permission denied' dù role có vẻ đúng: kiểm tra quyền hiệu lực bằng <code>fn_my_permissions</code> / <code>HAS_PERMS_BY_NAME</code>; nhớ rằng một <b>DENY</b> tường minh (thường qua role) đè lên mọi GRANT.</span></li>
<li><span class="lang-en">Works in SSMS but fails from the app: different connection string (database, authentication mode, token audience) — capture the failure with an Extended Events session on <code>error_reported</code>.</span><span class="lang-vi">SSMS vào được nhưng app thì không: connection string khác nhau (database, chế độ xác thực, token audience) — bắt lỗi bằng phiên Extended Events trên event <code>error_reported</code>.</span></li>
</ul>
<ul><li class="stale"><span class="lang-en">Section added from the official study guide (skills as of April 24, 2026) — the original notes did not cover this task statement. Per Microsoft Learn, August 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc chưa phủ task statement này. Theo Microsoft Learn, 8/2026.</span></li></ul></section>
<section id="s30"><h3><span class="n">2.12.</span> <span class="lang-en">implement Transparent Data Encryption (TDE)</span><span class="lang-vi">triển khai Transparent Data Encryption (TDE)</span><a class="anch" href="#s30" title="Link tới mục này">#</a></h3>
...
<section id="s31"><h3><span class="n">2.13.</span> <span class="lang-en">implement object-level encryption</span><span class="lang-vi">triển khai mã hóa ở cấp object</span><a class="anch" href="#s31" title="Link tới mục này">#</a></h3>
...
<section id="s33"><h3><span class="n">2.14.</span> <span class="lang-en">implement Always Encrypted</span><span class="lang-vi">triển khai Always Encrypted</span><a class="anch" href="#s33" title="Link tới mục này">#</a></h3>
...
<section id="s33a"><h3><span class="n">2.15.</span> <span class="lang-en">implement Always Encrypted with VBS enclaves</span><span class="lang-vi">triển khai Always Encrypted với VBS enclave</span><a class="anch" href="#s33a" title="Link tới mục này">#</a></h3>
...
<section id="s34"><h3><span class="n">2.16.</span> <span class="lang-en">implement Dynamic Data Masking</span><span class="lang-vi">triển khai Dynamic Data Masking</span><a class="anch" href="#s34" title="Link tới mục này">#</a></h3>
...
<section id="s34-2"><h3><span class="n">2.17.</span> <span class="lang-en">implement Azure Key Vault and disk encryption for Azure VMs</span><span class="lang-vi">triển khai Azure Key Vault và mã hóa đĩa cho Azure VM</span><a class="anch" href="#s34-2" title="Link tới mục này">#</a></h3>
...
<section id="s29"><h3><span class="n">2.18.</span> <span class="lang-en">manage certificates</span><span class="lang-vi">quản lý certificate</span><a class="anch" href="#s29" title="Link tới mục này">#</a></h3>
...
<section id="s35"><h3><span class="n">2.19.</span> <span class="lang-en">Configure Transport Layer Security (TLS)</span><span class="lang-vi">Cấu hình Transport Layer Security (TLS)</span><a class="anch" href="#s35" title="Link tới mục này">#</a></h3>
...
<section id="s32"><h3><span class="n">2.20.</span> <span class="lang-en">configure server and database-level firewall rules</span><span class="lang-vi">cấu hình firewall rule cấp server và cấp database</span><a class="anch" href="#s32" title="Link tới mục này">#</a></h3>
...
<section id="s34a"><h3><span class="n">2.21.</span> <span class="lang-en">Configure Private Link and Service Endpoints</span><span class="lang-vi">Cấu hình Private Link và Service Endpoint</span><a class="anch" href="#s34a" title="Link tới mục này">#</a></h3>
...
<section id="s36"><h3><span class="n">2.22.</span> <span class="lang-en">apply a data classification strategy</span><span class="lang-vi">áp dụng chiến lược phân loại dữ liệu</span><a class="anch" href="#s36" title="Link tới mục này">#</a></h3>
...
<section id="s37"><h3><span class="n">2.23.</span> <span class="lang-en">configure server and database audits</span><span class="lang-vi">cấu hình audit ở cấp server và cấp database</span><a class="anch" href="#s37" title="Link tới mục này">#</a></h3>
...
<section id="s38"><h3><span class="n">2.24.</span> <span class="lang-en">implement data change tracking</span><span class="lang-vi">triển khai theo dõi thay đổi dữ liệu (change tracking)</span><a class="anch" href="#s38" title="Link tới mục này">#</a></h3>
...
<section id="s39"><h3><span class="n">2.25.</span> <span class="lang-en">perform a vulnerability assessment</span><span class="lang-vi">thực hiện đánh giá lỗ hổng bảo mật</span><a class="anch" href="#s39" title="Link tới mục này">#</a></h3>
...
<section id="s40"><h3><span class="n">2.26.</span> <span class="lang-en">Manage database resources by using Azure Purview</span><span class="lang-vi">Quản lý tài nguyên database bằng Azure Purview</span><a class="anch" href="#s40" title="Link tới mục này">#</a></h3>
...
<section id="s41"><h3><span class="n">2.27.</span> <span class="lang-en">Implement Azure SQL Database ledger</span><span class="lang-vi">Triển khai Azure SQL Database ledger</span><a class="anch" href="#s41" title="Link tới mục này">#</a></h3>
...
<section id="s42"><h3><span class="n">2.28.</span> <span class="lang-en">Implement row-level security</span><span class="lang-vi">Triển khai row-level security</span><a class="anch" href="#s42" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en"><b>Test</b> — impersonate with EXECUTE AS USER, check what each user sees, then REVERT. Testing as yourself proves nothing: sysadmin and dbo get no exemption — the same predicate applies to them, and USER_NAME() returns dbo, so they normally see zero rows.</span><span class="lang-vi"><b>Test</b> — mượn danh bằng EXECUTE AS USER, xem từng user thấy gì, rồi REVERT. Thử bằng chính tài khoản của bạn không chứng minh được gì: sysadmin và dbo không hề được miễn lọc — vẫn đúng predicate đó áp lên họ, mà USER_NAME() trả về dbo nên thường ra 0 dòng.</span></li>
...
<li><span class="lang-en">Grant the end users SELECT on the target table. They need no permission on the predicate function.</span><span class="lang-vi">Cấp cho user cuối quyền SELECT trên bảng đích. Họ không cần quyền gì trên hàm predicate.</span></li>
...
GO
-- Add SELECT permissions to the table:
...
SELECT * FROM Customers.Customers
REVERT</span></pre></li>
</ul></ul><li class="stale"><span class="lang-en"><b>Two RLS patterns the exam asks about that this topic never shows.</b> <b>(1) Exempting an admin.</b> A policy filters <i>everyone</i>, <code>dbo</code> and <code>db_owner</code> included — Microsoft: "if high privileged users, such as sysadmin or db_owner, need to see all rows … the security policy <b>must be written to allow that</b>". You do it inside the predicate, typically <code>… WHERE @SalesRep = USER_NAME() OR IS_ROLEMEMBER('db_owner') = 1</code>. There is no switch outside the function. <b>(2) One pooled login for every end user</b> — the middle-tier pattern. When the app connects as a single low-privileged login, <code>USER_NAME()</code> is the same for everybody and is useless as a predicate. Instead the app calls <code>EXEC sp_set_session_context @key = N'UserId', @value = &lt;id&gt;, @read_only = 1</code> right after opening the connection — <code>@read_only = 1</code> stops the value being changed again until the connection is closed and returned to the pool — and the predicate reads it back: <code>WHERE DATABASE_PRINCIPAL_ID() = DATABASE_PRINCIPAL_ID('AppUser') AND CAST(SESSION_CONTEXT(N'UserId') AS int) = @AppUserId</code>. The <code>DATABASE_PRINCIPAL_ID()</code> half matters: it makes the predicate return nothing for anyone who is <i>not</i> the application account, so a DBA connecting directly does not silently inherit whatever value is in session context. Round it off with <code>ADD BLOCK PREDICATE … AFTER INSERT</code> so the app cannot write rows belonging to another tenant, plus <code>DENY UPDATE ON &lt;table&gt;(&lt;tenant column&gt;)</code>. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Hai mẫu RLS đề hay hỏi mà mục này không hề trình bày.</b> <b>(1) Miễn lọc cho admin.</b> Policy lọc <i>tất cả mọi người</i>, kể cả <code>dbo</code> và <code>db_owner</code> — Microsoft ghi: nếu người dùng quyền cao như sysadmin hay db_owner cần thấy mọi dòng thì <b>phải viết điều đó vào chính security policy</b>. Cách làm là thêm vào predicate, thường là <code>… WHERE @SalesRep = USER_NAME() OR IS_ROLEMEMBER('db_owner') = 1</code>. Không có công tắc nào bên ngoài hàm cả. <b>(2) Một login dùng chung cho mọi người dùng cuối</b> — mẫu middle-tier. Khi ứng dụng kết nối bằng đúng một login ít quyền, <code>USER_NAME()</code> giống nhau với mọi người nên vô dụng làm predicate. Thay vào đó, mở connection xong ứng dụng gọi <code>EXEC sp_set_session_context @key = N'UserId', @value = &lt;id&gt;, @read_only = 1</code> — <code>@read_only = 1</code> khoá không cho đổi lại giá trị cho tới khi connection đóng và trả về pool — rồi predicate đọc ngược ra: <code>WHERE DATABASE_PRINCIPAL_ID() = DATABASE_PRINCIPAL_ID('AppUser') AND CAST(SESSION_CONTEXT(N'UserId') AS int) = @AppUserId</code>. Vế <code>DATABASE_PRINCIPAL_ID()</code> rất quan trọng: nó khiến predicate trả về rỗng với bất kỳ ai <i>không phải</i> tài khoản ứng dụng, nên một DBA kết nối thẳng vào không vô tình thừa hưởng giá trị đang nằm trong session context. Hoàn chỉnh bằng <code>ADD BLOCK PREDICATE … AFTER INSERT</code> để ứng dụng không ghi được dòng của tenant khác, kèm <code>DENY UPDATE ON &lt;bảng&gt;(&lt;cột tenant&gt;)</code>. Theo Microsoft Learn, 9/2026.</span></li>
</section>
<section id="s43"><h3><span class="n">2.29.</span> <span class="lang-en">Configure Microsoft Defender for SQL</span><span class="lang-vi">Cấu hình Microsoft Defender for SQL</span><a class="anch" href="#s43" title="Link tới mục này">#</a></h3>
...
<section id="s-sec3"><h3><span class="n">3.1.</span> <span class="lang-en">Domain 3 at a glance — monitoring and tuning summary tables</span><span class="lang-vi">Tổng hợp phạm vi 3 — bảng ôn nhanh về giám sát và tinh chỉnh</span><a class="anch" href="#s-sec3" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A synthesis of every section in domain 3 for revision.</span><span class="lang-vi">Tổng hợp toàn bộ các mục của phạm vi 3 để ôn nhanh.</span></li>
</ul>
...
<section id="s44"><h3><span class="n">3.2.</span> <span class="lang-en">prepare an operational performance baseline</span><span class="lang-vi">chuẩn bị baseline hiệu năng vận hành</span><a class="anch" href="#s44" title="Link tới mục này">#</a></h3>
...
<section id="s45"><h3><span class="n">3.3.</span> <span class="lang-en">determine sources for performance metrics — by Azure layer</span><span class="lang-vi">xác định nguồn của các chỉ số hiệu năng — theo tầng Azure</span><a class="anch" href="#s45" title="Link tới mục này">#</a></h3>
...
<section id="s45-2"><h3><span class="n">3.4.</span> <span class="lang-en">determine sources for performance metrics — MI and VM metrics</span><span class="lang-vi">xác định nguồn của các chỉ số hiệu năng — metric của MI và VM</span><a class="anch" href="#s45-2" title="Link tới mục này">#</a></h3>
...
<section id="s46"><h3><span class="n">3.5.</span> <span class="lang-en">interpret performance metrics</span><span class="lang-vi">diễn giải các chỉ số hiệu năng</span><a class="anch" href="#s46" title="Link tới mục này">#</a></h3>
...
<section id="s47"><h3><span class="n">3.6.</span> <span class="lang-en">configure and monitor activity and performance at the infrastructure, server,</span><span class="lang-vi">cấu hình và giám sát hoạt động cùng hiệu năng ở cấp hạ tầng, server,</span><a class="anch" href="#s47" title="Link tới mục này">#</a></h3>
...
<section id="s48"><h3><span class="n">3.7.</span> <span class="lang-en">Monitor by using SQL Insights</span><span class="lang-vi">Giám sát bằng SQL Insights</span><a class="anch" href="#s48" title="Link tới mục này">#</a></h3>
<ul><li class="stale"><span class="lang-en"><b>Retired – kept for reference only.</b> Azure Monitor SQL Insights (preview) was retired on 31 December 2024 and is no longer available in the Azure portal. Do not build anything new on it. The Microsoft-recommended replacement for Azure SQL Database and Azure SQL Managed Instance is <b>database watcher</b> (topic 3.8 below); for SQL Server on Azure VMs, use VM insights with Data Collection Rules.</span><span class="lang-vi"><b>Đã khai tử – chỉ giữ để tham khảo.</b> Azure Monitor SQL Insights (preview) đã bị khai tử ngày 31/12/2024 và không còn xuất hiện trong Azure portal. Đừng xây gì mới trên nó. Giải pháp thay thế Microsoft khuyến nghị cho Azure SQL Database và Azure SQL Managed Instance là <b>database watcher</b> (mục 3.8 bên dưới); còn với SQL Server trên Azure VM thì dùng VM insights kèm Data Collection Rules.</span></li>
...
<section id="s48a"><h3><span class="n">3.8.</span> <span class="lang-en">Monitor by using database watcher</span><span class="lang-vi">Giám sát bằng database watcher</span><a class="anch" href="#s48a" title="Link tới mục này">#</a></h3>
...
<section id="s50"><h3><span class="n">3.9.</span> <span class="lang-en">configure Query Store to collect performance data</span><span class="lang-vi">cấu hình Query Store để thu thập dữ liệu hiệu năng</span><a class="anch" href="#s50" title="Link tới mục này">#</a></h3>
...
<section id="s53"><h3><span class="n">3.10.</span> <span class="lang-en">determine the appropriate Dynamic Management Views (DMVs) to gather query</span><span class="lang-vi">chọn Dynamic Management View (DMV) phù hợp để thu thập</span><a class="anch" href="#s53" title="Link tới mục này">#</a></h3>
...
<section id="s53-2"><h3><span class="n">3.11.</span> <span class="lang-en">identify performance issues using DMVs</span><span class="lang-vi">phát hiện vấn đề hiệu năng bằng DMV</span><a class="anch" href="#s53-2" title="Link tới mục này">#</a></h3>
...
<section id="s52"><h3><span class="n">3.12.</span> <span class="lang-en">identify sessions that cause blocking</span><span class="lang-vi">xác định các session gây blocking</span><a class="anch" href="#s52" title="Link tới mục này">#</a></h3>
...
<section id="s57"><h3><span class="n">3.13.</span> <span class="lang-en">determine the appropriate type of execution plan</span><span class="lang-vi">chọn loại execution plan phù hợp</span><a class="anch" href="#s57" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en">More in topic 3.13.</span><span class="lang-vi">Xem thêm ở mục 3.13.</span></li>
</ul></ul></section>
<section id="s57-2"><h3><span class="n">3.14.</span> <span class="lang-en">identify problem areas in execution plans</span><span class="lang-vi">phát hiện điểm có vấn đề trong execution plan</span><a class="anch" href="#s57-2" title="Link tới mục này">#</a></h3>
...
<section id="s57-3"><h3><span class="n">3.15.</span> <span class="lang-en">extract query plans from the Query Store</span><span class="lang-vi">trích xuất query plan từ Query Store</span><a class="anch" href="#s57-3" title="Link tới mục này">#</a></h3>
...
<section id="s57a"><h3><span class="n">3.16.</span> <span class="lang-en">assess database performance by using Intelligent Insights for Azure SQL Database</span><span class="lang-vi">đánh giá hiệu năng database bằng Intelligent Insights cho Azure SQL Database</span><a class="anch" href="#s57a" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en">Uses data from the Query Store (see topic 3.9), which is enabled by default in Azure SQL Database.</span><span class="lang-vi">Dùng dữ liệu từ Query Store (xem mục 3.9), vốn được bật mặc định trên Azure SQL Database.</span></li>
...
<section id="s54"><h3><span class="n">3.17.</span> <span class="lang-en">identify and implement index changes for queries</span><span class="lang-vi">xác định và triển khai thay đổi index cho query</span><a class="anch" href="#s54" title="Link tới mục này">#</a></h3>
...
<section id="s55"><h3><span class="n">3.18.</span> <span class="lang-en">recommend query construct modifications based on resource usage</span><span class="lang-vi">đề xuất sửa cấu trúc query dựa trên mức tiêu thụ tài nguyên</span><a class="anch" href="#s55" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">Missing indexes:</span><span class="lang-vi">Index bị thiếu:</span></li>
...
<section id="s56"><h3><span class="n">3.19.</span> <span class="lang-en">assess the use of hints for query performance</span><span class="lang-vi">đánh giá việc dùng hint cho hiệu năng query</span><a class="anch" href="#s56" title="Link tới mục này">#</a></h3>
...
</ul><li class="stale"><span class="lang-en"><b>Query Store hints — cách áp hint mà không sửa được câu lệnh.</b> This topic only covers hints written into the query text, which is useless when the statement lives inside a vendor application or a compiled procedure. <code>sys.sp_query_store_set_hints @query_id, @query_hints</code> (SQL Server 2022 and later, Azure SQL Database, Managed Instance, SQL database in Fabric) attaches hints to a <code>query_id</code> from <code>sys.query_store_query</code>, with no change to application code or database objects. The string must start with <code>OPTION</code>, and inside <code>USE HINT</code> the single quotes are doubled: <code>N'OPTION (MAXDOP = 1, USE HINT(''FORCE_LEGACY_CARDINALITY_ESTIMATION''))'</code>. Setting hints again <b>replaces</b> the previous set rather than adding to it; a nonexistent <code>query_id</code> raises an error; and if any one hint would stop a plan being produced, <b>all</b> the hints are ignored — the reason shows in <code>sys.query_store_query_hints.last_query_hint_failure_reason_desc</code>. Remove them with <code>sys.sp_query_store_clear_hints</code>. Requires <code>ALTER</code> on the database. Not supported as Query Store hints: <code>OPTIMIZE FOR (@var = val)</code>, <code>MAXRECURSION</code>, <code>USE PLAN</code>, <code>DISABLE_DEFERRED_COMPILATION_TV</code>, <code>DISABLE_TSQL_SCALAR_UDF_INLINING</code>, and every table hint (<code>FORCESEEK</code>, <code>INDEX</code>, …). Don't confuse it with <code>sp_query_store_force_plan</code>: forcing pins one <i>already existing</i> plan, hints steer the next compilation. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Query Store hints — cách áp hint khi không sửa được câu lệnh.</b> Mục này chỉ nói tới hint viết thẳng vào câu query, mà cách đó vô dụng khi câu lệnh nằm trong ứng dụng của hãng thứ ba hoặc trong stored procedure đã biên dịch. <code>sys.sp_query_store_set_hints @query_id, @query_hints</code> (SQL Server 2022 trở lên, Azure SQL Database, Managed Instance, SQL database trong Fabric) gắn hint vào một <code>query_id</code> lấy từ <code>sys.query_store_query</code>, không phải đụng vào mã ứng dụng hay object nào. Chuỗi hint phải bắt đầu bằng <code>OPTION</code>, và trong <code>USE HINT</code> thì dấu nháy đơn phải nhân đôi: <code>N'OPTION (MAXDOP = 1, USE HINT(''FORCE_LEGACY_CARDINALITY_ESTIMATION''))'</code>. Gọi lại lần nữa là <b>thay thế</b> toàn bộ hint cũ chứ không cộng thêm; <code>query_id</code> không tồn tại thì báo lỗi; và nếu chỉ một hint khiến không sinh được plan thì <b>toàn bộ</b> hint bị bỏ qua — lý do xem ở <code>sys.query_store_query_hints.last_query_hint_failure_reason_desc</code>. Gỡ bằng <code>sys.sp_query_store_clear_hints</code>. Cần quyền <code>ALTER</code> trên database. Những thứ <b>không</b> dùng được dưới dạng Query Store hint: <code>OPTIMIZE FOR (@var = val)</code>, <code>MAXRECURSION</code>, <code>USE PLAN</code>, <code>DISABLE_DEFERRED_COMPILATION_TV</code>, <code>DISABLE_TSQL_SCALAR_UDF_INLINING</code>, và mọi table hint (<code>FORCESEEK</code>, <code>INDEX</code>…). Đừng lẫn với <code>sp_query_store_force_plan</code>: force là ghim một plan <i>đã có sẵn</i>, còn hint là lái lần biên dịch kế tiếp. Theo Microsoft Learn, 9/2026.</span></li>
</section>
<section id="s58"><h3><span class="n">3.20.</span> <span class="lang-en">implement index maintenance tasks</span><span class="lang-vi">triển khai các tác vụ bảo trì index</span><a class="anch" href="#s58" title="Link tới mục này">#</a></h3>
...
<section id="s59"><h3><span class="n">3.21.</span> <span class="lang-en">implement statistics maintenance tasks</span><span class="lang-vi">triển khai các tác vụ bảo trì statistics</span><a class="anch" href="#s59" title="Link tới mục này">#</a></h3>
...
<section id="s60"><h3><span class="n">3.22.</span> <span class="lang-en">evaluate database health using DMVs</span><span class="lang-vi">đánh giá sức khỏe database bằng DMV</span><a class="anch" href="#s60" title="Link tới mục này">#</a></h3>
...
</ul><li class="stale"><span class="lang-en"><b>Wait types this list leaves out, and one it mislabels.</b> <code>PAGELATCH_*</code> is latch contention <i>in memory</i>, not I/O: classically the allocation pages of tempdb, but a hot data page in a user table raises it too — confirm tempdb by checking that <code>wait_resource</code> in <code>sys.dm_exec_requests</code> starts with <code>2:</code> (2 is the database_id of tempdb). The list also omits four types the exam does ask about: <code>ASYNC_NETWORK_IO</code> — SQL Server has already pushed rows into the network buffer and is waiting for the <i>client</i> to consume them, so the bottleneck is slow client code (row-by-row processing, rendering into a UI) or a slow/high-latency link, not a missing index, tempdb or the log; <code>LCK_M_*</code> — plain blocking, follow <code>blocking_session_id</code> in <code>sys.dm_exec_requests</code>; <code>THREADPOOL</code> — no worker thread left, usually a consequence of long blocking rather than a reason to scale up; <code>RESOURCE_SEMAPHORE_QUERY_COMPILE</code> — memory waits during <i>compilation</i>, typically too many ad-hoc statements. Since SQL Server 2017 the benign half of parallelism waits is reported separately as <code>CXCONSUMER</code>, so the <code>CXPACKET</code> that remains is the one worth investigating. Queue waits such as <code>SLEEP_*</code>, <code>BROKER_*</code>, <code>XE_TIMER_EVENT</code> and <code>LAZYWRITER_SLEEP</code> are idle background tasks and must be filtered out before ranking. Per Microsoft Learn, 09/2026.</span><span class="lang-vi"><b>Những wait type danh sách trên bỏ sót, và một cái bị gán sai.</b> <code>PAGELATCH_*</code> là tranh chấp latch <i>trong bộ nhớ</i>, không phải I/O: kinh điển là allocation page của tempdb, nhưng một page dữ liệu nóng của bảng người dùng cũng gây ra nó — muốn khẳng định là tempdb thì xem <code>wait_resource</code> trong <code>sys.dm_exec_requests</code> có bắt đầu bằng <code>2:</code> không (2 là database_id của tempdb). Danh sách cũng thiếu bốn loại đề thi có hỏi: <code>ASYNC_NETWORK_IO</code> — SQL Server đã đẩy dữ liệu ra network buffer và đang chờ <i>client</i> nhận/xử lý tiếp, nên nghẽn nằm ở phía client đọc chậm (xử lý từng dòng, đổ ra UI) hoặc đường truyền chậm/độ trễ cao, chứ không phải thiếu index, tempdb hay log; <code>LCK_M_*</code> — bị blocking, lần theo <code>blocking_session_id</code> trong <code>sys.dm_exec_requests</code>; <code>THREADPOOL</code> — hết worker thread, thường là <i>hệ quả</i> của blocking kéo dài chứ không phải lý do để nâng tier; <code>RESOURCE_SEMAPHORE_QUERY_COMPILE</code> — chờ memory để <i>biên dịch</i> plan, thường do quá nhiều câu ad-hoc. Từ SQL Server 2017, phần chờ lành tính của song song được tách ra thành <code>CXCONSUMER</code>, nên phần <code>CXPACKET</code> còn lại mới là cái đáng điều tra. Các queue wait như <code>SLEEP_*</code>, <code>BROKER_*</code>, <code>XE_TIMER_EVENT</code>, <code>LAZYWRITER_SLEEP</code> chỉ là task nền ngồi rảnh chờ việc — phải lọc bỏ trước khi xếp hạng. Per Microsoft Learn, 09/2026.</span></li><li class="stale"><span class="lang-en"><b>How to read these counters without drawing the wrong conclusion.</b> Every figure in <code>sys.dm_os_wait_stats</code> is <i>cumulative</i> since the database engine last started (check <code>sqlserver_start_time</code> in <code>sys.dm_os_sys_info</code>) — it does not reset daily and it is not limited to the last hour, so a wait type at the top of a 90-day total may come from an incident last month. Measure the delta between two snapshots around the business window, or clear the counters first with <code>DBCC SQLPERF ('sys.dm_os_wait_stats', CLEAR)</code>. <code>wait_time_ms</code> <i>already includes</i> <code>signal_wait_time_ms</code>, so resource wait is the difference between the two, and a high proportion of signal wait points at CPU/scheduler pressure rather than a resource bottleneck. The database-scoped <code>sys.dm_db_wait_stats</code> shows only the current database and only completed waits; its counters go to zero when the database is moved or taken offline and are not kept across a failover. <code>sys.dm_exec_session_wait_stats</code> (SQL Server 2016 and later) breaks the same data down by <code>session_id</code>, but it resets when a session is opened <i>or reset by connection pooling</i> — which is why measuring one ETL run through a pooled application often reports almost nothing. Per Microsoft Learn, 09/2026.</span><span class="lang-vi"><b>Đọc các counter này thế nào để không kết luận sai.</b> Mọi con số trong <code>sys.dm_os_wait_stats</code> là <i>tích luỹ</i> kể từ lần engine khởi động gần nhất (đối chiếu <code>sqlserver_start_time</code> trong <code>sys.dm_os_sys_info</code>) — nó không tự reset theo ngày, cũng không giới hạn một giờ, nên một wait type đứng đầu bảng tổng 90 ngày có thể đến từ sự cố tháng trước. Hãy đo delta giữa hai snapshot quanh cửa sổ nghiệp vụ, hoặc xoá counter trước bằng <code>DBCC SQLPERF ('sys.dm_os_wait_stats', CLEAR)</code>. <code>wait_time_ms</code> <i>đã bao gồm</i> <code>signal_wait_time_ms</code>, nên resource wait là hiệu của hai cột, và tỉ lệ signal wait cao là dấu hiệu áp lực CPU/scheduler chứ không phải nghẽn tài nguyên. Bản cấp database <code>sys.dm_db_wait_stats</code> chỉ hiển thị database hiện tại và chỉ tính wait đã kết thúc; counter về 0 khi database bị move hoặc đưa offline, và không được giữ qua failover. <code>sys.dm_exec_session_wait_stats</code> (SQL Server 2016 trở lên) tách cùng số liệu đó theo <code>session_id</code>, nhưng bị reset khi session mở mới <i>hoặc khi connection pooling tái sử dụng connection</i> — đó là lý do đo một lần chạy ETL qua ứng dụng có pool thường ra gần như bằng 0. Per Microsoft Learn, 09/2026.</span></li></ul></ul><li><span class="lang-en">Possible blocking</span><span class="lang-vi">Có thể đang bị blocking</span></li>
...
<section id="s60-2"><h3><span class="n">3.23.</span> <span class="lang-en">evaluate server health using DMVs</span><span class="lang-vi">đánh giá sức khỏe server bằng DMV</span><a class="anch" href="#s60-2" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topic 61.</span><span class="lang-vi">Xem mục 61.</span></li>
...
<section id="s60-3"><h3><span class="n">3.24.</span> <span class="lang-en">perform database consistency checks by using DBCC — what DBCC CHECKDB does</span><span class="lang-vi">kiểm tra tính nhất quán của database bằng DBCC — DBCC CHECKDB làm gì</span><a class="anch" href="#s60-3" title="Link tới mục này">#</a></h3>
...
<section id="s60-4"><h3><span class="n">3.25.</span> <span class="lang-en">perform database consistency checks by using DBCC — arguments and how to run it</span><span class="lang-vi">kiểm tra tính nhất quán của database bằng DBCC — đối số và cách chạy</span><a class="anch" href="#s60-4" title="Link tới mục này">#</a></h3>
...
</ul></ul><li><span class="lang-en">What it should do?</span><span class="lang-vi">Đối số thứ hai: CHECKDB nên làm gì — chỉ dò lỗi, hay sửa lỗi</span></li>
<ul><li><code><span class="lang-en">DBCC CHECKDB (0, NOINDEX)</span><span class="lang-vi">DBCC CHECKDB (0, NOINDEX)</span></code></li>
<ul><li><span class="lang-en">Detect errors only. Smaller execution time, as it does not do intensive checks of nonclustered indexes for user tables</span><span class="lang-vi">Chỉ dò lỗi chứ không sửa. Chạy nhanh hơn vì bỏ qua phần kiểm tra kỹ các nonclustered index của bảng người dùng.</span></li>
...
<ul><li><span class="lang-en">Do only repairs which have no chance of data loss. Includes quick repairs (e.g. missing rows in non-clustered indexes), and time-consuming repairs (building an index).</span><span class="lang-vi">Chỉ làm những phép sửa không có nguy cơ mất dữ liệu — có loại sửa nhanh (như vá dòng bị thiếu trong nonclustered index), cũng có loại tốn thời gian (dựng lại nguyên một index).</span></li>
<li><span class="lang-en">Needs to be in single user mode beforehand, i.e. ALTER DATABASE MyDatabase SET SINGLE_USER WITH ROLLBACK IMMEDIATE GO DBCC CHECKDB … GO ALTER DATABASE MyDatabase SET MULTI_USER GO</span><span class="lang-vi">Phải đưa database về single user mode trước khi chạy, và trả lại multi user sau khi xong — ba bước, mỗi bước kết thúc bằng <code>GO</code>: <code>ALTER DATABASE MyDatabase SET SINGLE_USER WITH ROLLBACK IMMEDIATE</code> → <code>DBCC CHECKDB …</code> → <code>ALTER DATABASE MyDatabase SET MULTI_USER</code></span></li>
</ul><li><code><span class="lang-en">DBCC CHECKDB (0, REPAIR_FAST)</span><span class="lang-vi">DBCC CHECKDB (0, REPAIR_FAST)</span></code></li>
<ul><li><span class="lang-en">No repair actions are performed. Only use for Backward compatibility reasons only.</span><span class="lang-vi">Không sửa gì cả. Cú pháp này chỉ còn được giữ cho tương thích ngược.</span></li>
...
<li><span class="lang-en">Needs to be in single user mode beforehand. Additionally, before that, run ALTER DATABASE MyDatabase SET EMERGENCY This marks it as READ_ONLY, logging is disabled, and access is limited to sysadmins.</span><span class="lang-vi">Cũng phải đưa về single user mode, nhưng trước cả bước đó còn phải chạy <code>ALTER DATABASE MyDatabase SET EMERGENCY</code> — thứ tự là EMERGENCY rồi mới tới SINGLE_USER. Lệnh EMERGENCY đánh dấu database là READ_ONLY, tắt logging, và chỉ sysadmin mới vào được.</span></li>
...
<section id="s61"><h3><span class="n">3.26.</span> <span class="lang-en">configure database auto-tuning</span><span class="lang-vi">cấu hình auto-tuning cho database</span><a class="anch" href="#s61" title="Link tới mục này">#</a></h3>
...
<section id="s62"><h3><span class="n">3.27.</span> <span class="lang-en">configure server and service account settings for performance</span><span class="lang-vi">cấu hình thiết lập server và service account cho hiệu năng</span><a class="anch" href="#s62" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topic 9.</span><span class="lang-vi">Xem mục 9.</span></li>
<li class="stale"><span class="lang-en"><b>Topic 9 (1.10) is about VM size and storage, not about server settings — the settings this objective actually asks about are listed here.</b> At the <b>server</b> level, through <code>EXEC sp_configure '&lt;option&gt;', &lt;value&gt;; RECONFIGURE;</code> (needs <code>ALTER SETTINGS</code>, held by <b>sysadmin</b> and <b>serveradmin</b>): <code>max degree of parallelism</code> (default <b>0</b> = all processors; guidance: ≤8 logical processors → the number of processors, &gt;8 on one NUMA node → <b>8</b>, multiple NUMA nodes with ≤16 processors per node → the number per node, &gt;16 per node → half of them, maximum <b>16</b>); <code>cost threshold for parallelism</code> (default <b>5</b>, range 0–32,767 — a starting point, not a recommendation; raise it in small increments); <code>max server memory (MB)</code> (default <b>2,147,483,647</b> MB, minimum 128 MB, recommended about <b>75%</b> of system memory not used by other processes); <code>min server memory (MB)</code> (default 0); <code>optimize for ad hoc workloads</code> (default off); <code>backup compression default</code> (default off). MAXDOP and cost threshold take effect <b>immediately</b>; the <code>is_dynamic</code> column of <code>sys.configurations</code> tells you which options need a restart. At the <b>Windows</b> level, Setup grants the Database Engine service SID only <i>Log on as a service</i>, <i>Replace a process-level token</i>, <i>Bypass traverse checking</i> and <i>Adjust memory quotas for a process</i> — <i>Perform volume maintenance tasks</i> (instant file initialization) is granted only if you tick the box during setup or pass <code>/SQLSVCINSTANTFILEINIT</code>, and <i>Lock pages in memory</i> is <b>never</b> granted automatically. Always change a service account with <b>SQL Server Configuration Manager</b>, never with the Windows Services applet. None of this exists in Azure SQL Database, where <code>sp_configure</code> is absent. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Mục 9 (1.10) nói về kích thước VM và lưu trữ, không phải về server setting — các thiết lập mà mục tiêu này thật sự hỏi nằm ở đây.</b> Ở cấp <b>server</b>, chỉnh bằng <code>EXEC sp_configure '&lt;tùy chọn&gt;', &lt;giá trị&gt;; RECONFIGURE;</code> (cần quyền <code>ALTER SETTINGS</code>, có sẵn trong <b>sysadmin</b> và <b>serveradmin</b>): <code>max degree of parallelism</code> (mặc định <b>0</b> = dùng hết processor; khuyến nghị: ≤8 logical processor → bằng số processor, &gt;8 trên một NUMA node → <b>8</b>, nhiều NUMA node với ≤16 processor mỗi node → bằng số processor mỗi node, &gt;16 mỗi node → một nửa, tối đa <b>16</b>); <code>cost threshold for parallelism</code> (mặc định <b>5</b>, dải 0–32.767 — Microsoft nói đây là điểm xuất phát chứ không phải khuyến nghị; nâng từng bước nhỏ); <code>max server memory (MB)</code> (mặc định <b>2.147.483.647</b> MB, thấp nhất 128 MB, khuyến nghị khoảng <b>75%</b> bộ nhớ hệ thống mà tiến trình khác không dùng); <code>min server memory (MB)</code> (mặc định 0); <code>optimize for ad hoc workloads</code> (mặc định tắt); <code>backup compression default</code> (mặc định tắt). MAXDOP và cost threshold có hiệu lực <b>ngay</b>; cột <code>is_dynamic</code> trong <code>sys.configurations</code> cho biết tùy chọn nào cần restart. Ở cấp <b>Windows</b>, Setup chỉ cấp cho service SID của Database Engine bốn quyền <i>Log on as a service</i>, <i>Replace a process-level token</i>, <i>Bypass traverse checking</i> và <i>Adjust memory quotas for a process</i> — <i>Perform volume maintenance tasks</i> (instant file initialization) chỉ được cấp nếu bạn tick ô lúc cài hoặc truyền <code>/SQLSVCINSTANTFILEINIT</code>, còn <i>Lock pages in memory</i> thì <b>không bao giờ</b> tự được cấp. Đổi service account phải dùng <b>SQL Server Configuration Manager</b>, đừng dùng applet Services của Windows. Toàn bộ phần này không tồn tại trên Azure SQL Database vì nơi đó không có <code>sp_configure</code>. Theo Microsoft Learn, 9/2026.</span></li>
</ul></section>
<section id="s63"><h3><span class="n">3.28.</span> <span class="lang-en">configure Resource Governor for performance</span><span class="lang-vi">cấu hình Resource Governor cho hiệu năng</span><a class="anch" href="#s63" title="Link tới mục này">#</a></h3>
...
<ul><li><span class="lang-en">Guaranteed average and maximum average CPU.</span><span class="lang-vi"><b>MIN_CPU_PERCENT</b> — mức CPU trung bình được <b>đảm bảo</b> cho pool. <b>MAX_CPU_PERCENT</b> — mức CPU trung bình <b>tối đa</b> pool được dùng.</span></li>
...
</ul><li><span class="lang-en">MIN_ and MAX_MEMORY_PERCENT</span><span class="lang-vi">MIN_MEMORY_PERCENT và MAX_MEMORY_PERCENT</span></li>
<ul><li><span class="lang-en">Memory may remain in a pool, even with no requests.</span><span class="lang-vi"><b>MIN_MEMORY_PERCENT</b> là sàn, <b>MAX_MEMORY_PERCENT</b> là trần phần memory của pool. Vì có sàn nên memory có thể vẫn nằm lại trong pool ngay cả khi không có request nào.</span></li>
</ul><li><span class="lang-en">MIN_ and MAX_IOPS_PER_VOLUME</span><span class="lang-vi">MIN_IOPS_PER_VOLUME và MAX_IOPS_PER_VOLUME</span></li>
<ul><li><span class="lang-en">The physical I/O operations per seconds (IOPS).</span><span class="lang-vi"><b>MIN_IOPS_PER_VOLUME</b> là sàn, <b>MAX_IOPS_PER_VOLUME</b> là trần, tính theo số thao tác I/O vật lý mỗi giây (IOPS).</span></li>
...
</ul></ul></ul><li class="stale"><span class="lang-en"><b>The workload group settings this topic leaves out — and the one the exam asks about.</b> <code>REQUEST_MAX_MEMORY_GRANT_PERCENT</code> caps the query workspace memory <b>a single request</b> may take, and it is a percentage <b>of the pool</b> (of <code>MAX_MEMORY_PERCENT</code>), not of the server. Default <b>25</b>. From SQL Server 2019 it accepts fractional values (0–100); on 2017 and earlier it is an integer 1–100. When a query needs more than the cap, a <b>user-defined</b> group first lowers DOP step by step, and if it still doesn't fit the query fails with <b>error 8657</b>; the <code>internal</code> and <code>default</code> groups are allowed to exceed the cap instead. Setting it above ~70 is discouraged — it starves concurrent queries and invites memory-grant timeouts (error 8645). The other group settings: <code>IMPORTANCE</code> (LOW/MEDIUM/HIGH, default MEDIUM — only relative <i>within the same pool</i>), <code>REQUEST_MAX_CPU_TIME_SEC</code> (0 = unlimited; on <b>Managed Instance</b> exceeding it <b>aborts</b> the request with error 10961, on SQL Server it only raises an event unless trace flag 2422 is on), <code>REQUEST_MEMORY_GRANT_TIMEOUT_SEC</code>, <code>MAX_DOP</code>, <code>GROUP_MAX_REQUESTS</code>, and <code>GROUP_MAX_TEMPDB_DATA_MB</code>/<code>_PERCENT</code> (exceeding aborts with error 1138). MAXDOP precedence: a query hint wins but only up to the group's <code>MAX_DOP</code>; the group's <code>MAX_DOP</code> overrides both the server setting and the database-scoped one. Nothing takes effect until <code>ALTER RESOURCE GOVERNOR RECONFIGURE</code>, and changing <code>MAX_DOP</code> only reaches cached plans after <code>DBCC FREEPROCCACHE (&lt;pool_name&gt;)</code>. Requires <code>CONTROL SERVER</code>. On Managed Instance you must be in <code>master</code> on the primary replica. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Những thiết lập của workload group mục này bỏ sót — và cái đề thi có hỏi.</b> <code>REQUEST_MAX_MEMORY_GRANT_PERCENT</code> chặn lượng query workspace memory mà <b>một request đơn lẻ</b> được lấy, và nó là phần trăm <b>của pool</b> (của <code>MAX_MEMORY_PERCENT</code>), không phải của cả server. Mặc định <b>25</b>. Từ SQL Server 2019 nhận giá trị thập phân (0–100); bản 2017 trở về trước chỉ nhận số nguyên 1–100. Khi một query cần nhiều hơn mức trần, group <b>do người dùng định nghĩa</b> sẽ hạ dần DOP; vẫn không vừa thì query hỏng với <b>lỗi 8657</b> — trong khi group <code>internal</code> và <code>default</code> lại được phép vượt trần. Đặt trên khoảng 70 là không nên: nó bỏ đói các query chạy song song và dễ gây memory grant timeout (lỗi 8645). Các thiết lập còn lại của group: <code>IMPORTANCE</code> (LOW/MEDIUM/HIGH, mặc định MEDIUM — chỉ so tương đối <i>trong cùng một pool</i>), <code>REQUEST_MAX_CPU_TIME_SEC</code> (0 = không giới hạn; trên <b>Managed Instance</b> vượt ngưỡng là <b>huỷ</b> request với lỗi 10961, còn trên SQL Server chỉ bắn event trừ khi bật trace flag 2422), <code>REQUEST_MEMORY_GRANT_TIMEOUT_SEC</code>, <code>MAX_DOP</code>, <code>GROUP_MAX_REQUESTS</code>, và <code>GROUP_MAX_TEMPDB_DATA_MB</code>/<code>_PERCENT</code> (vượt là huỷ request với lỗi 1138). Thứ tự ưu tiên MAXDOP: query hint thắng nhưng chỉ tới mức <code>MAX_DOP</code> của group; <code>MAX_DOP</code> của group đè cả thiết lập server lẫn database scoped configuration. Mọi thay đổi chưa có hiệu lực cho tới khi chạy <code>ALTER RESOURCE GOVERNOR RECONFIGURE</code>, và đổi <code>MAX_DOP</code> chỉ vào được plan đã cache sau <code>DBCC FREEPROCCACHE (&lt;tên_pool&gt;)</code>. Cần quyền <code>CONTROL SERVER</code>. Trên Managed Instance phải đứng ở <code>master</code> của primary replica. Theo Microsoft Learn, 9/2026.</span></li>
</section>
<section id="s64"><h3><span class="n">3.29.</span> <span class="lang-en">implement database-scoped configuration</span><span class="lang-vi">triển khai database-scoped configuration</span><a class="anch" href="#s64" title="Link tới mục này">#</a></h3>
...
<ul><li><span class="lang-en">Drop global temporary tables when not in use by any session.</span><span class="lang-vi">Tự động drop global temporary table khi không còn session nào dùng tới.</span></li>
<ul><li><span class="lang-en">Set in individual databases in Azure SQL Database.</span><span class="lang-vi">Trên Azure SQL Database thì đặt ở từng database riêng.</span></li>
<li><span class="lang-en">Set in tempdb in MI and VMs.</span><span class="lang-vi">Trên MI và trên VM thì đặt ở tempdb.</span></li>
...
<section id="s64-2"><h3><span class="n">3.30.</span> <span class="lang-en">review database configuration options</span><span class="lang-vi">xem lại các tùy chọn cấu hình database</span><a class="anch" href="#s64-2" title="Link tới mục này">#</a></h3>
...
<ul><li><span class="lang-en">Creates statistics on single columns in query predicates, to improve query plans and performance.</span><span class="lang-vi">Tự tạo statistics cho từng cột đơn lẻ xuất hiện trong predicate của query, để plan và hiệu năng tốt hơn.</span></li>
...
<li class="stale"><span class="lang-en"><b>Why "leave it OFF" — the reason this list never gives.</b> Shrinking reclaims space by <b>moving pages from the end of the file</b> into free space nearer the front, and Microsoft warns that the moved data "can be scattered to any available location in the file. This causes <b>index fragmentation</b> and can slow the performance of queries that search a range of the index." That is the direct link between <code>AUTO_SHRINK</code> and the fragmentation you then have to fix. The trap is a loop: shrink frees space the workload actually needed, the file autogrows again (and "autogrow events … hinder performance"), then shrink fires again — Microsoft says that if a database keeps growing back, repeated shrinking is <b>a wasted operation</b>, and that shrink "should not be considered a regular maintenance operation". Rebuilding indexes afterwards removes the fragmentation, but it needs free space, which grows the file once more. Microsoft's wording on the option itself is blunt: <i>"Unless you have a specific requirement, don't set the AUTO_SHRINK database option to ON."</i> Other limits worth knowing: a file can never shrink below the size the database was <b>created</b> at (or the last size explicitly set), shrink and backup <b>cannot run at the same time</b>, and a shrink both blocks and can be blocked — SQL Server 2022 added <code>WAIT_AT_LOW_PRIORITY</code> to <code>DBCC SHRINKDATABASE</code>/<code>SHRINKFILE</code> so it times out after a minute instead of blocking others. Shrinking requires <b>sysadmin</b> or <b>db_owner</b>. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Vì sao "để OFF" — cái lý do mà danh sách này không hề nói.</b> Shrink lấy lại chỗ bằng cách <b>dời page từ cuối file</b> về những khoảng trống ở gần đầu file, và Microsoft cảnh báo rằng dữ liệu bị dời đi "có thể nằm rải vào bất kỳ vị trí trống nào trong file. Việc này gây <b>phân mảnh index</b> và làm chậm các query quét theo khoảng của index." Đó chính là sợi dây nối thẳng từ <code>AUTO_SHRINK</code> sang đống phân mảnh mà sau đó bạn phải đi dọn. Cái bẫy là một vòng lặp: shrink cắt mất phần trống mà workload vốn đang cần, file lại autogrow (mà "sự kiện autogrow… làm giảm hiệu năng"), rồi shrink lại tiếp — Microsoft nói thẳng nếu database cứ phình lại thì shrink đi shrink lại là <b>việc làm vô ích</b>, và shrink "không nên bị coi là một thao tác bảo trì định kỳ". Rebuild index sau đó thì dọn được phân mảnh, nhưng rebuild lại cần chỗ trống, thế là file phình ra lần nữa. Câu chữ của Microsoft về chính tùy chọn này rất dứt khoát: <i>"Trừ khi có yêu cầu cụ thể, đừng đặt tùy chọn AUTO_SHRINK là ON."</i> Vài giới hạn khác nên nhớ: file không bao giờ co xuống dưới kích thước lúc database được <b>tạo ra</b> (hoặc kích thước gần nhất được đặt tường minh), shrink và backup <b>không chạy cùng lúc được</b>, và shrink vừa chặn người khác vừa có thể bị chặn — SQL Server 2022 thêm <code>WAIT_AT_LOW_PRIORITY</code> cho <code>DBCC SHRINKDATABASE</code>/<code>SHRINKFILE</code> để nó tự bỏ cuộc sau một phút thay vì chặn. Chạy shrink cần <b>sysadmin</b> hoặc <b>db_owner</b>. Theo Microsoft Learn, 9/2026.</span></li>
</ul><li><span class="lang-en">READ_ONLY / READ_WRITE</span><span class="lang-vi">READ_ONLY / READ_WRITE</span></li>
<ul><li><span class="lang-en">Can users only read from the database (not modify it).</span><span class="lang-vi"><b>READ_ONLY</b> — người dùng chỉ đọc được, không sửa được database. <b>READ_WRITE</b> — đọc và sửa bình thường.</span></li>
...
<ul><li><span class="lang-en">Only one user at a time, or only db_owner fixed database roles and dbcreator and sysadmin fixed server roles (any number), or all users which have appropriate permissions.</span><span class="lang-vi"><b>SINGLE_USER</b> — mỗi lúc chỉ một user được kết nối. <b>RESTRICTED_USER</b> — chỉ thành viên fixed database role db_owner và fixed server role dbcreator, sysadmin mới vào được (bao nhiêu người cũng được). <b>MULTI_USER</b> — mọi user có quyền phù hợp đều vào được; đây là trạng thái bình thường.</span></li>
...
<li class="stale"><span class="lang-en"><b>The list stops too early.</b> Two more levels exist: <b>160</b> = SQL Server 2022 (16.x) and <b>170</b> = SQL Server 2025 (17.x). Defaults for a newly created database today: <b>170</b> in Azure SQL Database, SQL database in Fabric, SQL Server 2025, and Azure SQL Managed Instance on the <i>Always-up-to-date</i> or <i>SQL Server 2025</i> update policy; <b>160</b> in SQL Server 2022 and on a managed instance with the <i>SQL Server 2022</i> update policy. 100 is still the floor in Azure SQL Database and Managed Instance. Remember why the level matters: cardinality estimator changes and Query Optimizer fixes shipped under trace flag 4199 are enabled <b>only at the default level of a version</b> — 160 turns on Parameter Sensitive Plan optimization and CE feedback, 170 extends PSP optimization to DML and <code>tempdb</code>. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Danh sách này dừng quá sớm.</b> Còn hai mức nữa: <b>160</b> = SQL Server 2022 (16.x) và <b>170</b> = SQL Server 2025 (17.x). Mặc định cho database mới ở thời điểm hiện tại: <b>170</b> trên Azure SQL Database, SQL database trong Fabric, SQL Server 2025 và Azure SQL Managed Instance dùng update policy <i>Always-up-to-date</i> hoặc <i>SQL Server 2025</i>; <b>160</b> trên SQL Server 2022 và trên managed instance dùng update policy <i>SQL Server 2022</i>. Mức thấp nhất trên Azure SQL Database và Managed Instance vẫn là 100. Nhớ vì sao level lại quan trọng: thay đổi của cardinality estimator và các bản vá Query Optimizer phát hành dưới trace flag 4199 chỉ bật ở <b>đúng level mặc định của phiên bản đó</b> — 160 bật Parameter Sensitive Plan optimization và CE feedback, 170 mở rộng PSP optimization sang DML và <code>tempdb</code>. Theo Microsoft Learn, 9/2026.</span></li>
</ul><li class="stale"><span class="lang-en"><b>The list is missing the two SET options that decide how readers block writers.</b> <code>READ_COMMITTED_SNAPSHOT</code> makes the READ COMMITTED level use row versioning, so a reader takes no shared locks and stops blocking writers; <code>ALLOW_SNAPSHOT_ISOLATION</code> allows sessions to ask for SNAPSHOT isolation explicitly. Defaults differ by platform: both are <b>OFF</b> in SQL Server and Azure SQL Managed Instance user databases, and both are <b>ON</b> by default in Azure SQL Database. Turning <code>READ_COMMITTED_SNAPSHOT</code> on or off requires that no other connection is using the database (the usual trick is <code>ALTER DATABASE … SET SINGLE_USER WITH ROLLBACK IMMEDIATE</code>), and the price is row versions kept in the <code>tempdb</code> version store — size <code>tempdb</code> for it. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Danh sách còn thiếu hai tùy chọn SET quyết định chuyện đọc có chặn ghi hay không.</b> <code>READ_COMMITTED_SNAPSHOT</code> khiến mức READ COMMITTED dùng row versioning, nên câu đọc không lấy shared lock và thôi chặn câu ghi; <code>ALLOW_SNAPSHOT_ISOLATION</code> cho phép session chủ động xin mức SNAPSHOT. Mặc định khác nhau theo nền tảng: cả hai <b>OFF</b> trên SQL Server và trên database người dùng của Azure SQL Managed Instance, còn trên Azure SQL Database thì cả hai <b>ON</b> sẵn. Bật/tắt <code>READ_COMMITTED_SNAPSHOT</code> đòi hỏi không còn connection nào khác đang dùng database (mẹo quen thuộc là <code>ALTER DATABASE … SET SINGLE_USER WITH ROLLBACK IMMEDIATE</code>), và cái giá phải trả là row version nằm trong version store của <code>tempdb</code> — phải tính dung lượng <code>tempdb</code> cho nó. Theo Microsoft Learn, 9/2026.</span></li>
</ul><li class="stale"><span class="lang-en"><b>The list is also missing <code>DELAYED_DURABILITY</code>, the option that trades durability for commit latency.</b> Three values: <b>DISABLED</b> (default — every commit is fully durable), <b>ALLOWED</b> (each transaction decides, via <code>COMMIT … WITH (DELAYED_DURABILITY = ON)</code> or an atomic block), <b>FORCED</b> (every commit on the database is delayed durable, no application change needed). The database-level setting always overrides the commit-level one. A delayed durable commit returns to the client <i>before</i> the log records reach disk, which is why it is the direct answer to a <code>WRITELOG</code> bottleneck. The in-memory log is flushed only when a <b>fully durable</b> transaction commits in the same database, when <code>sp_flush_log</code> runs, or on the engine's own size/time-based attempts — Microsoft gives <b>no hard guarantee</b> beyond the first two. What you lose: every committed-but-unflushed transaction, on a crash <b>and on a planned shutdown/restart alike</b>. Where it silently does not apply: cross-database and distributed transactions stay fully durable regardless of the setting; Change Tracking transactions stay fully durable too; and it is <b>not supported at all</b> with Transactional Replication or CDC (errors 22891/22892 since SQL Server 2022 CU 2 and 2019 CU 20). With availability groups it guarantees nothing on the primary or any secondary — control returns before any synchronous secondary acknowledges; log shipping and log backups carry only the transactions already made durable. Read the current setting in <code>sys.databases.delayed_durability_desc</code>. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Danh sách còn thiếu <code>DELAYED_DURABILITY</code> — tùy chọn đánh đổi độ bền lấy độ trễ commit.</b> Ba giá trị: <b>DISABLED</b> (mặc định — mọi commit đều fully durable), <b>ALLOWED</b> (để từng transaction tự quyết, bằng <code>COMMIT … WITH (DELAYED_DURABILITY = ON)</code> hoặc trong atomic block), <b>FORCED</b> (mọi commit của database đều delayed durable, không phải sửa code ứng dụng). Thiết lập ở cấp database luôn thắng thiết lập ở cấp commit. Commit kiểu delayed durable trả kết quả về client <i>trước khi</i> log record xuống đĩa — vì vậy nó là câu trả lời trực tiếp cho nghẽn <code>WRITELOG</code>. Log buffer trong bộ nhớ chỉ được flush khi có một transaction <b>fully durable</b> commit trong cùng database, khi chạy <code>sp_flush_log</code>, hoặc do engine tự flush theo dung lượng/thời gian — Microsoft <b>không bảo đảm chắc chắn</b> ngoài hai trường hợp đầu. Cái bạn mất: mọi transaction đã commit mà chưa kịp flush, khi crash <b>và cả khi tắt/khởi động lại có kế hoạch</b>. Những chỗ nó lặng lẽ không có tác dụng: transaction liên database và distributed transaction vẫn fully durable bất kể thiết lập; transaction có Change Tracking cũng vẫn fully durable; và nó <b>hoàn toàn không dùng được</b> cùng Transactional Replication hay CDC (lỗi 22891/22892 từ SQL Server 2022 CU 2 và 2019 CU 20). Với availability group thì nó không bảo đảm gì ở primary lẫn secondary — quyền điều khiển trả về client trước khi bất kỳ synchronous secondary nào xác nhận; log shipping và log backup chỉ mang theo những transaction đã thành durable. Xem thiết lập hiện tại ở <code>sys.databases.delayed_durability_desc</code>. Theo Microsoft Learn, 9/2026.</span></li>
</ul></section>
<section id="s66"><h3><span class="n">3.31.</span> <span class="lang-en">configure Intelligent Query Processing (IQP)</span><span class="lang-vi">cấu hình Intelligent Query Processing (IQP)</span><a class="anch" href="#s66" title="Link tới mục này">#</a></h3>
...
<li class="stale"><span class="lang-en"><b>Seven was the SQL Server 2019 count; the family has grown to four waves.</b> Wave 1 (SQL Server 2017, level <b>140</b>): batch mode adaptive joins, interleaved execution for MSTVFs, batch mode memory grant feedback. Wave 2 (SQL Server 2019, level <b>150</b>): batch mode on rowstore, row mode memory grant feedback, table variable deferred compilation, scalar UDF inlining — plus <code>APPROX_COUNT_DISTINCT</code>, which needs no particular level. Wave 3 (SQL Server 2022, level <b>160</b>): Parameter Sensitive Plan optimization, CE feedback, DOP feedback, optimized plan forcing, and CE/memory grant feedback persistence — with <code>APPROX_PERCENTILE_CONT</code>/<code>_DISC</code> from level 110, and memory grant feedback percentile and persistence available from level <b>140</b>, not 160. Wave 4 (SQL Server 2025, level <b>170</b>): optional parameter plan optimization (OPPO), CE feedback for expressions, and <code>OPTIMIZED_SP_EXECUTESQL</code>. Query Store in <code>READ_WRITE</code> is <b>required</b> for CE feedback, DOP feedback, optimized plan forcing and memory grant feedback persistence/percentile — the others work without it. <code>DOP_FEEDBACK</code> is the one that is <b>off by default</b> in SQL Server 2022. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Con số 7 là của thời SQL Server 2019; nhóm tính năng này giờ đã thành bốn đợt.</b> Đợt 1 (SQL Server 2017, level <b>140</b>): batch mode adaptive joins, interleaved execution cho MSTVF, memory grant feedback batch mode. Đợt 2 (SQL Server 2019, level <b>150</b>): batch mode on rowstore, memory grant feedback row mode, table variable deferred compilation, scalar UDF inlining — cộng thêm <code>APPROX_COUNT_DISTINCT</code> vốn không đòi level nào. Đợt 3 (SQL Server 2022, level <b>160</b>): Parameter Sensitive Plan optimization, CE feedback, DOP feedback, optimized plan forcing, và phần persistence của CE/memory grant feedback — kèm <code>APPROX_PERCENTILE_CONT</code>/<code>_DISC</code> từ level 110, còn memory grant feedback percentile và persistence thì có từ level <b>140</b> chứ không phải 160. Đợt 4 (SQL Server 2025, level <b>170</b>): optional parameter plan optimization (OPPO), CE feedback cho biểu thức, và <code>OPTIMIZED_SP_EXECUTESQL</code>. Query Store ở trạng thái <code>READ_WRITE</code> là <b>bắt buộc</b> với CE feedback, DOP feedback, optimized plan forcing và memory grant feedback persistence/percentile — số còn lại chạy được mà không cần. <code>DOP_FEEDBACK</code> là cái duy nhất <b>mặc định tắt</b> trên SQL Server 2022. Theo Microsoft Learn, 9/2026.</span></li>
...
<li><span class="lang-en">Selects the Join type (Hash Join or Nested Loops Join) during runtime based on actual input rows, when it has scanned the first input.</span><span class="lang-vi">Chọn kiểu join (Hash Join hay Nested Loops Join) ngay lúc chạy, dựa trên số dòng đầu vào thật sự, sau khi đã quét xong đầu vào thứ nhất.</span></li>
...
<ul><li><span class="lang-en">Use where absolute precision is not important, but responsiveness is.</span><span class="lang-vi">Dùng ở chỗ không cần chính xác tuyệt đối nhưng cần trả kết quả nhanh.</span></li>
...
<li><span class="lang-en">Use the actual cardinality of a multi-statement table valued functions on first compilation, rather than a fixed guess (100 rows from SQL Server 2014).</span><span class="lang-vi">Lấy cardinality thật của multi-statement table valued function ngay ở lần biên dịch đầu, thay vì đoán một con số cố định (100 dòng kể từ SQL Server 2014).</span></li>
...
<li><span class="lang-en">Use the actual cardinality of the table variable encountered on first compilation instead of a fixed guess (1 row).</span><span class="lang-vi">Lấy cardinality thật của table variable gặp được ở lần biên dịch đầu, thay vì đoán một con số cố định (1 dòng).</span></li>
</ul></ul></section>
<section id="s65"><h3><span class="n">3.32.</span> <span class="lang-en">configure compute resources for scaling</span><span class="lang-vi">cấu hình tài nguyên compute để mở rộng</span><a class="anch" href="#s65" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topics 1.8–1.10.</span><span class="lang-vi">Xem các mục 1.8–1.10.</span></li>
</ul></section>
<section id="s65-2"><h3><span class="n">3.33.</span> <span class="lang-en">assess proper database autogrowth configuration</span><span class="lang-vi">đánh giá cấu hình autogrowth phù hợp cho database</span><a class="anch" href="#s65-2" title="Link tới mục này">#</a></h3>
...
<section id="s65-3"><h3><span class="n">3.34.</span> <span class="lang-en">report on database free space</span><span class="lang-vi">báo cáo dung lượng trống của database</span><a class="anch" href="#s65-3" title="Link tới mục này">#</a></h3>
...
<section id="s-sec4"><h3><span class="n">4.1.</span> <span class="lang-en">Domain 4 at a glance — automation summary tables</span><span class="lang-vi">Tổng hợp phạm vi 4 — bảng ôn nhanh về tự động hoá</span><a class="anch" href="#s-sec4" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A synthesis of every section in domain 4 for revision.</span><span class="lang-vi">Tổng hợp toàn bộ các mục của phạm vi 4 để ôn nhanh.</span></li>
</ul>
...
<section id="s67"><h3><span class="n">4.2.</span> <span class="lang-en">manage schedules for regular maintenance jobs</span><span class="lang-vi">quản lý lịch chạy các job bảo trì định kỳ</span><a class="anch" href="#s67" title="Link tới mục này">#</a></h3>
...
<section id="s68"><h3><span class="n">4.3.</span> <span class="lang-en">configure notifications for task success/failure/non-completion</span><span class="lang-vi">cấu hình thông báo khi tác vụ thành công/thất bại/không hoàn tất</span><a class="anch" href="#s68" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">For Azure SQL Database, see topic 46.</span><span class="lang-vi">Với Azure SQL Database, xem mục 46.</span></li>
...
<section id="s69"><h3><span class="n">4.4.</span> <span class="lang-en">troubleshoot SQL Server Agent jobs and automated deployments</span><span class="lang-vi">xử lý sự cố SQL Server Agent job và triển khai tự động</span><a class="anch" href="#s69" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">Job failed: read step output in <code>msdb.dbo.sysjobhistory</code> (or Job Activity Monitor) — the last step's message contains the real error, not the job-level summary.</span><span class="lang-vi">Job thất bại: đọc output từng bước trong <code>msdb.dbo.sysjobhistory</code> (hoặc Job Activity Monitor) — thông điệp của bước cuối mới chứa lỗi thật, không phải dòng tóm tắt cấp job.</span></li>
<li><span class="lang-en">Non-T-SQL steps (PowerShell, CmdExec) fail with permission errors: the step needs a <b>proxy</b> backed by a credential; the job owner being sysadmin does not transfer to other subsystems.</span><span class="lang-vi">Bước không phải T-SQL (PowerShell, CmdExec) lỗi quyền: bước đó cần <b>proxy</b> gắn credential; owner của job là sysadmin cũng không tự có quyền ở subsystem khác.</span></li>
<li><span class="lang-en">Job never fires: check the schedule is enabled, the job is enabled, and SQL Server Agent service itself is running (on Azure VM it can be stopped after a restart).</span><span class="lang-vi">Job không bao giờ chạy: kiểm tra schedule đang bật, job đang bật, và chính service SQL Server Agent có chạy không (trên Azure VM có thể bị dừng sau khi restart).</span></li>
<li><span class="lang-en">ARM/Bicep deployment fails: read the <b>Activity Log</b> and the deployment's operation details (correlation ID); validate before deploying with <code>what-if</code> to see the exact change set.</span><span class="lang-vi">Triển khai ARM/Bicep thất bại: đọc <b>Activity Log</b> và chi tiết operation của deployment (correlation ID); trước khi deploy hãy chạy <code>what-if</code> để thấy đúng những gì sẽ đổi.</span></li>
<li><span class="lang-en">Elastic jobs stuck: check the job agent's credential can reach every target database and the target group membership — a dropped database left in the group fails the whole run.</span><span class="lang-vi">Elastic job kẹt: kiểm tra credential của job agent còn vào được mọi database đích và thành viên của target group — một database đã xóa mà vẫn nằm trong group sẽ làm hỏng cả lượt chạy.</span></li>
</ul>
<ul><li class="stale"><span class="lang-en">Section added from the official study guide (skills as of April 24, 2026) — the original notes did not cover this task statement. Per Microsoft Learn, August 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc chưa phủ task statement này. Theo Microsoft Learn, 8/2026.</span></li></ul></section>
<section id="s70"><h3><span class="n">4.5.</span> <span class="lang-en">perform automated deployment methods for resources</span><span class="lang-vi">thực hiện các phương thức triển khai tự động cho tài nguyên</span><a class="anch" href="#s70" title="Link tới mục này">#</a></h3>
...
<section id="s70-2"><h3><span class="n">4.6.</span> <span class="lang-en">Automate deployment by using Azure Resource Manager templates (ARM</span><span class="lang-vi">Tự động hóa triển khai bằng Azure Resource Manager template (ARM</span><a class="anch" href="#s70-2" title="Link tới mục này">#</a></h3>
...
</ul><li><span class="lang-en"><b>Deployment mode decides what happens to the resources already in the resource group</b> — it is what makes a pipeline safe, or unsafe, to re-run:</span><span class="lang-vi"><b>Deployment mode quyết định số phận của những resource đã có sẵn trong resource group</b> — chính nó quyết định pipeline chạy lại có an toàn hay không:</span></li>
<ul><li><span class="lang-en"><b>Incremental</b> — the default, and the mode Microsoft recommends. Resources declared in the template are created or updated; everything else already in the group is left untouched.</span><span class="lang-vi"><b>Incremental</b> — mặc định, và là mode Microsoft khuyến nghị. Resource khai trong template thì được tạo mới hoặc cập nhật; mọi thứ khác đang có trong group được giữ nguyên.</span></li>
<li><span class="lang-en"><b>Complete</b> — Resource Manager <b>deletes</b> every resource in the group that the template does not declare. Run the what-if operation first. The portal doesn&#39;t support this mode, linked/nested templates and subscription-level deployments can&#39;t use it, and a locked resource group blocks the deletions.</span><span class="lang-vi"><b>Complete</b> — Resource Manager <b>xoá</b> mọi resource trong group mà template không khai. Chạy what-if trước đã. Portal không hỗ trợ mode này, template linked/nested và deployment ở cấp subscription cũng không dùng được, còn resource group đang bị lock thì việc xoá không diễn ra.</span></li>
<li><code><span class="lang-en">az deployment group create --mode Incremental|Complete --resource-group rg --template-file main.bicep</span><span class="lang-vi">az deployment group create --mode Incremental|Complete --resource-group rg --template-file main.bicep</span></code></li>
<li><span class="lang-en"><b>Re-running is idempotent only if the names stay the same.</b> Resource Manager identifies a resource by its name: same name and unchanged settings means no operation at all, same name with changed properties means an update. Generating a fresh name (a new GUID, say) on every run creates a brand-new resource each time and leaves the previous ones behind.</span><span class="lang-vi"><b>Chạy lại chỉ idempotent khi tên giữ nguyên.</b> Resource Manager nhận diện resource bằng tên: cùng tên và cấu hình không đổi thì không làm gì cả, cùng tên nhưng đổi property thì cập nhật. Sinh tên mới (ví dụ GUID mới) ở mỗi lần chạy sẽ tạo ra một resource mới mỗi lần và bỏ lại các resource cũ.</span></li>
<li><span class="lang-en">In incremental mode every property is reapplied, not merged: a property you leave out of the template is reset to its default, so the template must always describe the final state of the resource.</span><span class="lang-vi">Ở incremental mode, mọi property đều được áp lại chứ không merge: property bạn bỏ khỏi template sẽ bị trả về giá trị mặc định, nên template luôn phải mô tả trạng thái cuối cùng của resource.</span></li>
<li><span class="lang-en">Changing the <b>location</b> or the <b>type</b> of an existing resource makes the deployment fail — deploy a new resource instead.</span><span class="lang-vi">Đổi <b>location</b> hoặc <b>type</b> của một resource đã tồn tại thì deployment lỗi — phải deploy resource mới thay vì sửa tại chỗ.</span></li>
</ul></ul></section>
<section id="s71"><h3><span class="n">4.7.</span> <span class="lang-en">Automate deployment by using PowerShell</span><span class="lang-vi">Tự động hóa triển khai bằng PowerShell</span><a class="anch" href="#s71" title="Link tới mục này">#</a></h3>
...
</ul><li class="stale"><span class="lang-en"><b>The cmdlets a real deployment script needs, which this sample never shows.</b> <b>Re-running the script.</b> <code>New-AzResourceGroup</code> does <i>not</i> fail when the group already exists — per the <code>-Name</code> parameter, "the command prompts you for confirmation before replacing the existing resource group", which is what hangs an unattended pipeline. Add <b><code>-Force</code></b> to run without asking, or branch on <code>Get-AzResourceGroup -ErrorAction SilentlyContinue</code>. <b>Opening the firewall.</b> The script above creates a server nobody can reach: add <code>New-AzSqlServerFirewallRule -StartIpAddress … -EndIpAddress …</code> for a server-level rule over an IP range. (<code>Set-AzSqlDatabase -PublicNetworkAccess</code> only toggles public access as a whole; virtual network rules are a different mechanism, for subnets.) <b>Deploying a template instead of individual cmdlets.</b> <code>New-AzResourceGroupDeployment</code> submits an ARM/Bicep template; <code>Test-AzResourceGroupDeployment</code> validates it first without deploying; and when a deployment reports <code>ProvisioningState: Failed</code> without saying which resource broke, <code>Get-AzResourceGroupDeploymentOperation</code> lists each child operation with its <code>statusMessage</code> — <code>Get-AzResourceGroupDeployment</code> only gives the overall state. <b>Applying a setting across many databases.</b> Wrap <code>Set-AzSqlDatabaseTransparentDataEncryption -State Enabled</code> (and its siblings) in a <code>foreach</code> over the database list — that loop is the whole point of scripting this rather than clicking in the portal. <b>One thing not to copy from the sample above:</b> it builds the admin credential from a password written into the script. In anything beyond a demo, read it from Azure Key Vault or a pipeline secret — the password still has to reach the cmdlet as a <code>SecureString</code> inside a <code>PSCredential</code> either way. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>Những cmdlet mà một script triển khai thật cần, nhưng ví dụ này không hề nhắc.</b> <b>Chạy lại script.</b> <code>New-AzResourceGroup</code> <i>không</i> báo lỗi khi resource group đã tồn tại — theo tài liệu tham số <code>-Name</code>, lệnh sẽ "hỏi xác nhận trước khi thay thế resource group hiện có", và chính cái prompt đó làm treo một pipeline không người trực. Thêm <b><code>-Force</code></b> để chạy mà không hỏi, hoặc rẽ nhánh bằng <code>Get-AzResourceGroup -ErrorAction SilentlyContinue</code>. <b>Mở firewall.</b> Script ở trên tạo ra một server mà không ai kết nối được: phải thêm <code>New-AzSqlServerFirewallRule -StartIpAddress … -EndIpAddress …</code> để tạo server-level rule theo khoảng IP. (<code>Set-AzSqlDatabase -PublicNetworkAccess</code> chỉ bật/tắt truy cập công khai nói chung; virtual network rule là cơ chế khác, dành cho subnet.) <b>Triển khai bằng template thay vì từng cmdlet.</b> <code>New-AzResourceGroupDeployment</code> nộp một template ARM/Bicep; <code>Test-AzResourceGroupDeployment</code> kiểm tra trước mà không triển khai; và khi deployment báo <code>ProvisioningState: Failed</code> mà không nói resource nào hỏng thì <code>Get-AzResourceGroupDeploymentOperation</code> liệt kê từng operation con kèm <code>statusMessage</code> — còn <code>Get-AzResourceGroupDeployment</code> chỉ cho trạng thái tổng. <b>Áp một thiết lập lên hàng loạt database.</b> Bọc <code>Set-AzSqlDatabaseTransparentDataEncryption -State Enabled</code> (và các cmdlet cùng họ) trong một vòng <code>foreach</code> chạy qua danh sách database — chính cái vòng lặp đó mới là lý do viết script thay vì bấm tay trên portal. <b>Một chỗ đừng bắt chước ví dụ trên:</b> nó dựng credential admin từ mật khẩu viết thẳng trong script. Ngoài phạm vi demo, hãy đọc mật khẩu từ Azure Key Vault hoặc secret của pipeline — dù lấy từ đâu thì mật khẩu vẫn phải tới cmdlet dưới dạng <code>SecureString</code> nằm trong một <code>PSCredential</code>. Theo Microsoft Learn, 9/2026.</span></li>
</section>
<section id="s72"><h3><span class="n">4.8.</span> <span class="lang-en">Automate deployment by using Azure CLI</span><span class="lang-vi">Tự động hóa triển khai bằng Azure CLI</span><a class="anch" href="#s72" title="Link tới mục này">#</a></h3>
...
<section id="s74"><h3><span class="n">4.9.</span> <span class="lang-en">automate database maintenance tasks</span><span class="lang-vi">tự động hóa các tác vụ bảo trì database</span><a class="anch" href="#s74" title="Link tới mục này">#</a></h3>
...
<section id="s75"><h3><span class="n">4.10.</span> <span class="lang-en">configure multi-server automation</span><span class="lang-vi">cấu hình tự động hóa đa server</span><a class="anch" href="#s75" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">See topic 3.5 for Azure SQL Database.</span><span class="lang-vi">Với Azure SQL Database, xem mục 46.</span></li>
...
<section id="s75-2"><h3><span class="n">4.11.</span> <span class="lang-en">automate backups</span><span class="lang-vi">tự động hóa backup</span><a class="anch" href="#s75-2" title="Link tới mục này">#</a></h3>
...
<section id="s75-3"><h3><span class="n">4.12.</span> <span class="lang-en">automate performance tuning and patching</span><span class="lang-vi">tự động hóa việc tinh chỉnh hiệu năng và vá lỗi</span><a class="anch" href="#s75-3" title="Link tới mục này">#</a></h3>
...
<section id="s75-4"><h3><span class="n">4.13.</span> <span class="lang-en">implement policies by using automated evaluation modes</span><span class="lang-vi">triển khai policy bằng các chế độ đánh giá tự động</span><a class="anch" href="#s75-4" title="Link tới mục này">#</a></h3>
...
<section id="s76"><h3><span class="n">4.14.</span> <span class="lang-en">Automate database workflows by using Azure Logic Apps (not needed from 7</span><span class="lang-vi">Tự động hóa workflow database bằng Azure Logic Apps (không còn cần từ 7</span><a class="anch" href="#s76" title="Link tới mục này">#</a></h3>
...
<section id="s77"><h3><span class="n">4.15.</span> <span class="lang-en">create event notifications based on metrics</span><span class="lang-vi">tạo event notification dựa trên metric</span><a class="anch" href="#s77" title="Link tới mục này">#</a></h3>
...
<section id="s77-2"><h3><span class="n">4.16.</span> <span class="lang-en">create event notifications for Azure resources</span><span class="lang-vi">tạo event notification cho tài nguyên Azure</span><a class="anch" href="#s77-2" title="Link tới mục này">#</a></h3>
...
<section id="s77-3"><h3><span class="n">4.17.</span> <span class="lang-en">create alerts for server configuration changes</span><span class="lang-vi">tạo cảnh báo cho các thay đổi cấu hình server</span><a class="anch" href="#s77-3" title="Link tới mục này">#</a></h3>
...
<section id="s77-4"><h3><span class="n">4.18.</span> <span class="lang-en">create tasks that respond to event notifications</span><span class="lang-vi">tạo tác vụ phản hồi lại event notification</span><a class="anch" href="#s77-4" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">As per 76, using an Error event.</span><span class="lang-vi">Giống mục 4.14, dùng một Error event.</span></li>
</ul></section>
<h2 class="dom" id="dom5">5 · Plan and implement a HA/DR environment</h2>
<section id="s-sec5"><h3><span class="n">5.1.</span> <span class="lang-en">Domain 5 at a glance — HA/DR summary tables</span><span class="lang-vi">Tổng hợp phạm vi 5 — bảng ôn nhanh về HA/DR</span><a class="anch" href="#s-sec5" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A synthesis of every section in domain 5 for revision.</span><span class="lang-vi">Tổng hợp toàn bộ các mục của phạm vi 5 để ôn nhanh.</span></li>
</ul>
...
<section id="s79"><h3><span class="n">5.2.</span> <span class="lang-en">recommend HADR strategy based on RPO/RTO requirements</span><span class="lang-vi">đề xuất chiến lược HADR dựa trên yêu cầu RPO/RTO</span><a class="anch" href="#s79" title="Link tới mục này">#</a></h3>
...
<section id="s4"><h3><span class="n">5.3.</span> <span class="lang-en">evaluate HADR for hybrid deployments</span><span class="lang-vi">đánh giá HADR cho triển khai hybrid</span><a class="anch" href="#s4" title="Link tới mục này">#</a></h3>
...
<ul><li><span class="lang-en">For more, see topic 5.19.</span><span class="lang-vi">Xem thêm ở mục 5.19.</span></li>
...
<section id="s84"><h3><span class="n">5.4.</span> <span class="lang-en">perform a database backup with options — on a VM</span><span class="lang-vi">thực hiện backup database kèm các tùy chọn — trên VM</span><a class="anch" href="#s84" title="Link tới mục này">#</a></h3>
...
<section id="s88"><h3><span class="n">5.5.</span> <span class="lang-en">perform transaction log backup</span><span class="lang-vi">thực hiện transaction log backup</span><a class="anch" href="#s88" title="Link tới mục này">#</a></h3>
...
<section id="s88-3"><h3><span class="n">5.6.</span> <span class="lang-en">perform database backups with options — on Managed Instance</span><span class="lang-vi">thực hiện backup database kèm các tùy chọn — trên Managed Instance</span><a class="anch" href="#s88-3" title="Link tới mục này">#</a></h3>
...
<section id="s85"><h3><span class="n">5.7.</span> <span class="lang-en">perform a database restore with options</span><span class="lang-vi">thực hiện restore database kèm các tùy chọn</span><a class="anch" href="#s85" title="Link tới mục này">#</a></h3>
...
<section id="s88-2"><h3><span class="n">5.8.</span> <span class="lang-en">perform restore of user databases</span><span class="lang-vi">thực hiện restore các database người dùng</span><a class="anch" href="#s88-2" title="Link tới mục này">#</a></h3>
...
<section id="s86"><h3><span class="n">5.9.</span> <span class="lang-en">perform a database restore to a point in time</span><span class="lang-vi">restore database về một thời điểm cụ thể</span><a class="anch" href="#s86" title="Link tới mục này">#</a></h3>
...
<section id="s87"><h3><span class="n">5.10.</span> <span class="lang-en">configure long-term backup retention</span><span class="lang-vi">cấu hình lưu giữ backup dài hạn</span><a class="anch" href="#s87" title="Link tới mục này">#</a></h3>
...
<section id="s88a"><h3><span class="n">5.11.</span> <span class="lang-en">backup and restore to and from cloud storage</span><span class="lang-vi">backup và restore từ/tới cloud storage</span><a class="anch" href="#s88a" title="Link tới mục này">#</a></h3>
...
<section id="s90"><h3><span class="n">5.12.</span> <span class="lang-en">create an Availability Group</span><span class="lang-vi">tạo một Availability Group</span><a class="anch" href="#s90" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">You need:</span><span class="lang-vi">Bạn cần:</span></li>
...
<section id="s90-2"><h3><span class="n">5.13.</span> <span class="lang-en">prepare databases for Always On Availability Groups</span><span class="lang-vi">chuẩn bị database cho Always On Availability Group</span><a class="anch" href="#s90-2" title="Link tới mục này">#</a></h3>
...
<section id="s90-3"><h3><span class="n">5.14.</span> <span class="lang-en">integrate a database into an Always On Availability Group</span><span class="lang-vi">đưa một database vào Always On Availability Group</span><a class="anch" href="#s90-3" title="Link tới mục này">#</a></h3>
...
<section id="s90-4"><h3><span class="n">5.15.</span> <span class="lang-en">configure an Always On Availability Group listener</span><span class="lang-vi">cấu hình listener cho Always On Availability Group</span><a class="anch" href="#s90-4" title="Link tới mục này">#</a></h3>
...
<section id="s92"><h3><span class="n">5.16.</span> <span class="lang-en">configure quorum options for a Windows Server Failover Cluster</span><span class="lang-vi">cấu hình tùy chọn quorum cho Windows Server Failover Cluster</span><a class="anch" href="#s92" title="Link tới mục này">#</a></h3>
...
<section id="s93"><h3><span class="n">5.17.</span> <span class="lang-en">Configure failover cluster instances on Azure VMs</span><span class="lang-vi">Cấu hình failover cluster instance trên Azure VM</span><a class="anch" href="#s93" title="Link tới mục này">#</a></h3>
...
<section id="s91"><h3><span class="n">5.18.</span> <span class="lang-en">configure auto-failover groups</span><span class="lang-vi">cấu hình auto-failover group</span><a class="anch" href="#s91" title="Link tới mục này">#</a></h3>
...
<section id="s94"><h3><span class="n">5.19.</span> <span class="lang-en">configure replication</span><span class="lang-vi">cấu hình replication</span><a class="anch" href="#s94" title="Link tới mục này">#</a></h3>
...
<li><span class="lang-en">Cannot be Azure SQL Database (need to use Data Sync – topic 1.16 – for this).</span><span class="lang-vi">KHÔNG thể là Azure SQL Database (với nó thì phải dùng Data Sync — mục 1.16).</span></li>
...
<section id="s94-2"><h3><span class="n">5.20.</span> <span class="lang-en">Configure log shipping</span><span class="lang-vi">Cấu hình log shipping</span><a class="anch" href="#s94-2" title="Link tới mục này">#</a></h3>
...
<section id="s82"><h3><span class="n">5.21.</span> <span class="lang-en">test HA by using failover – FAILOVER GROUP</span><span class="lang-vi">kiểm thử HA bằng failover – FAILOVER GROUP</span><a class="anch" href="#s82" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">A failover group fails over <b>as a unit</b>: every database in the group switches role together. You cannot fail over one database of the group on its own — if you need finer control, create multiple failover groups between the same pair of servers.</span><span class="lang-vi">Failover group failover <b>theo cả nhóm</b>: mọi database trong nhóm cùng đổi vai một lượt. Không failover riêng một database trong nhóm được — cần chia nhỏ thì tạo nhiều failover group giữa cùng một cặp server.</span></li>
<li><span class="lang-en">Two kinds of failover, and the drill uses the first one:</span><span class="lang-vi">Hai kiểu failover, và diễn tập thì dùng kiểu thứ nhất:</span></li>
<ul><li><span class="lang-en"><b>Failover (no data loss)</b> — fully synchronizes primary and secondary <i>before</i> switching roles, so nothing is lost. Only possible while the primary is still reachable. This is what Microsoft names for DR drills in production, for relocating a workload to another region, and for failing back after an outage.</span><span class="lang-vi"><b>Failover (không mất dữ liệu)</b> — đồng bộ đầy đủ primary và secondary <i>trước khi</i> đổi vai, nên không mất gì. Chỉ làm được khi primary còn với tới được. Đây chính là kiểu Microsoft chỉ định cho diễn tập DR trên production, cho việc dời workload sang region khác, và cho failback sau khi sự cố đã xử lý xong.</span></li>
<li><span class="lang-en"><b>Forced failover (có thể mất dữ liệu)</b> — promotes the secondary immediately without waiting for outstanding changes to replicate. It is a recovery method for when the primary is <i>not</i> reachable. When the old primary comes back it automatically reconnects as the new secondary.</span><span class="lang-vi"><b>Forced failover (có thể mất dữ liệu)</b> — đẩy secondary lên primary ngay, không chờ phần thay đổi còn tồn đọng nhân bản xong. Đây là biện pháp cứu hộ cho lúc primary <i>không</i> với tới được. Khi primary cũ sống lại, nó tự kết nối trở lại với vai secondary.</span></li>
</ul><li><span class="lang-en">Failover policy — and note the naming trap between the portal and the command line:</span><span class="lang-vi">Failover policy — và để ý cái bẫy tên gọi giữa portal và dòng lệnh:</span></li>
<ul><li><span class="lang-en"><b>Customer managed</b> (value <code>manual</code> in PowerShell / Azure CLI / REST) — <b>Microsoft khuyến nghị dùng cái này</b>. You decide when to fail over, for your group only.</span><span class="lang-vi"><b>Customer managed</b> (giá trị là <code>manual</code> trong PowerShell / Azure CLI / REST) — <b>đây là lựa chọn Microsoft khuyến nghị</b>. Bạn tự quyết lúc nào failover, và chỉ cho nhóm của mình.</span></li>
<li><span class="lang-en"><b>Microsoft managed</b> (value <code>automatic</code>) — Microsoft triggers a forced failover only during a widespread regional outage, and for <i>all</i> Microsoft-managed groups in that region at once, never for one group. The grace period (<code>GracePeriodWithDataLossHours</code>) <b>cannot be set below one hour</b>. Microsoft states plainly: use customer managed to test and implement your DR plan, and do <b>not</b> rely on Microsoft managed failover.</span><span class="lang-vi"><b>Microsoft managed</b> (giá trị là <code>automatic</code>) — Microsoft chỉ kích hoạt forced failover khi có sự cố diện rộng ở cả region, và làm cho <i>toàn bộ</i> các nhóm Microsoft-managed trong region đó cùng lúc, không bao giờ cho riêng một nhóm. Grace period (<code>GracePeriodWithDataLossHours</code>) <b>không đặt dưới một giờ được</b>. Microsoft nói thẳng: hãy dùng customer managed để kiểm thử và triển khai kế hoạch DR, <b>đừng</b> trông vào Microsoft managed failover.</span></li>
</ul><li><span class="lang-en">The two listener endpoints are the reason the application needs no config change:</span><span class="lang-vi">Hai listener endpoint chính là lý do ứng dụng không phải sửa cấu hình:</span></li>
<ul><li><span class="lang-en">Read-write listener <code>&lt;fog-name&gt;.database.windows.net</code> — a DNS CNAME pointing at the current primary; after failover the DNS record is updated automatically.</span><span class="lang-vi">Read-write listener <code>&lt;fog-name&gt;.database.windows.net</code> — bản ghi DNS CNAME trỏ tới primary hiện tại; sau failover bản ghi này được cập nhật tự động.</span></li>
<li><span class="lang-en">Read-only listener <code>&lt;fog-name&gt;.secondary.database.windows.net</code> — points at the current secondary; pair it with <code>ApplicationIntent=ReadOnly</code>. Failover of the read-only listener is <b>disabled by default</b>.</span><span class="lang-vi">Read-only listener <code>&lt;fog-name&gt;.secondary.database.windows.net</code> — trỏ tới secondary hiện tại; dùng kèm <code>ApplicationIntent=ReadOnly</code>. Việc failover của read-only listener <b>mặc định bị tắt</b>.</span></li>
<li><span class="lang-en">The DNS record has a <b>TTL of 30 seconds</b>: clients only reach the new primary after their DNS cache refreshes — worth remembering when a drill appears to "hang" right after the switch.</span><span class="lang-vi">Bản ghi DNS có <b>TTL 30 giây</b>: client chỉ tới được primary mới sau khi cache DNS của nó làm mới — nhớ điều này khi thấy một buổi diễn tập có vẻ "treo" ngay sau lúc đổi vai.</span></li>
</ul><li><span class="lang-en">Practical notes for a drill: use <b>paired regions</b> (better performance than unpaired); the <b>number of databases in the group directly lengthens</b> both failover and forced failover, so keep groups small; and the failover group name must be globally unique inside <code>.database.windows.net</code>.</span><span class="lang-vi">Lưu ý thực tế khi diễn tập: dùng <b>paired region</b> (hiệu năng tốt hơn cặp không ghép đôi); <b>số database trong nhóm càng nhiều thì cả failover lẫn forced failover càng lâu</b>, nên giữ nhóm nhỏ; và tên failover group phải duy nhất toàn cầu trong miền <code>.database.windows.net</code>.</span></li>
<li><span class="lang-en">Supplementary topic added from the official study guide (skills measured as of 24/04/2026) — the original notes left this task statement empty. Per Microsoft Learn, September 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc để trống task statement này. Theo Microsoft Learn, 9/2026.</span></li>
</ul>
</section>
<section id="s82-3"><h3><span class="n">5.22.</span> <span class="lang-en">test HA by using failover – AVAILABILITY GROUP</span><span class="lang-vi">kiểm thử HA bằng failover – AVAILABILITY GROUP</span><a class="anch" href="#s82-3" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">An availability group fails over <b>at the level of an availability replica</b>: a planned manual failover moves the target secondary to the primary role and, at the same time, demotes the old primary to secondary.</span><span class="lang-vi">Availability group failover <b>ở mức availability replica</b>: một planned manual failover đưa secondary đích lên vai primary, đồng thời hạ primary cũ xuống vai secondary.</span></li>
<li><span class="lang-en">Two hard prerequisites — miss either one and a planned failover is simply not offered:</span><span class="lang-vi">Hai điều kiện bắt buộc — thiếu một trong hai là planned failover không hề được phép:</span></li>
<ul><li><span class="lang-en">Both the primary and the target secondary must run in <b>synchronous-commit</b> availability mode.</span><span class="lang-vi">Cả primary lẫn secondary đích đều phải chạy ở chế độ <b>synchronous-commit</b>.</span></li>
<li><span class="lang-en">The target secondary must currently be <b>SYNCHRONIZED</b>, with every secondary database joined to the group. Check it before you start: column <code>is_failover_ready</code> in <code>sys.dm_hadr_database_replica_cluster_states</code>, or <code>synchronization_state_desc</code> in <code>sys.dm_hadr_database_replica_states</code>, or the <b>Failover Readiness</b> column of the Always On dashboard.</span><span class="lang-vi">Secondary đích phải đang ở trạng thái <b>SYNCHRONIZED</b>, và mọi secondary database đã join vào group. Kiểm tra trước khi làm: cột <code>is_failover_ready</code> trong <code>sys.dm_hadr_database_replica_cluster_states</code>, hoặc <code>synchronization_state_desc</code> trong <code>sys.dm_hadr_database_replica_states</code>, hoặc cột <b>Failover Readiness</b> trên dashboard Always On.</span></li>
</ul><li><span class="lang-en"><b>You must run it on the target secondary.</b> Connect to the server instance that hosts the replica you want to promote — this is the step most often got wrong, because the instinct is to drive everything from the primary.</span><span class="lang-vi"><b>Phải chạy lệnh trên chính secondary đích.</b> Kết nối tới server instance đang giữ replica mà bạn muốn đẩy lên — đây là bước hay làm sai nhất, vì phản xạ thông thường là ngồi ở primary điều khiển mọi thứ.</span></li>
<ul><li><span class="lang-en">T-SQL: <code>ALTER AVAILABILITY GROUP &lt;group_name&gt; FAILOVER;</code></span><span class="lang-vi">T-SQL: <code>ALTER AVAILABILITY GROUP &lt;tên_group&gt; FAILOVER;</code></span></li>
<li><span class="lang-en">SSMS: on the secondary, Always On High Availability – Availability Groups, right-click the group, <b>Failover</b>.</span><span class="lang-vi">SSMS: đứng ở secondary, vào Always On High Availability – Availability Groups, chuột phải vào group, chọn <b>Failover</b>.</span></li>
<li><span class="lang-en">PowerShell: <code>Switch-SqlAvailabilityGroup</code>, pointed at the path of the target secondary.</span><span class="lang-vi">PowerShell: <code>Switch-SqlAvailabilityGroup</code>, trỏ vào đường dẫn của secondary đích.</span></li>
</ul><li><span class="lang-en">Permissions: <code>ALTER AVAILABILITY GROUP</code> on the group, plus one of <code>CONTROL AVAILABILITY GROUP</code>, <code>ALTER ANY AVAILABILITY GROUP</code> or <code>CONTROL SERVER</code>.</span><span class="lang-vi">Quyền cần có: <code>ALTER AVAILABILITY GROUP</code> trên group, cộng thêm một trong <code>CONTROL AVAILABILITY GROUP</code>, <code>ALTER ANY AVAILABILITY GROUP</code> hoặc <code>CONTROL SERVER</code>.</span></li>
<li><span class="lang-en">Two behaviours that surprise people during a drill: the failover command <b>returns as soon as the target accepts it</b>, while database recovery then happens <b>asynchronously</b> afterwards; and cross-database consistency between databases inside the same availability group <b>might not be preserved</b> across a failover.</span><span class="lang-vi">Hai hành vi hay làm người ta bất ngờ khi diễn tập: lệnh failover <b>trả về ngay khi secondary đích nhận lệnh</b>, còn việc recovery database diễn ra <b>bất đồng bộ</b> sau đó; và tính nhất quán chéo giữa các database trong cùng một availability group <b>có thể không được giữ</b> qua một lần failover.</span></li>
<li><span class="lang-en"><code>FORCE_FAILOVER_ALLOW_DATA_LOSS</code> is a different operation: it is for when the target is <b>not</b> synchronized or the primary is gone, and it accepts data loss. Never use it for a routine drill.</span><span class="lang-vi"><code>FORCE_FAILOVER_ALLOW_DATA_LOSS</code> là thao tác khác hẳn: dành cho lúc secondary đích <b>chưa</b> đồng bộ hoặc primary đã mất, và nó chấp nhận mất dữ liệu. Đừng bao giờ dùng nó cho một buổi diễn tập thường kỳ.</span></li>
<li><span class="lang-en">After failing over <b>outside the automatic failover set</b>, review the quorum votes of the WSFC nodes so they still reflect the new layout. And a read-scale availability group with <code>CLUSTER_TYPE = NONE</code> has its own, entirely manual procedure — the cluster manager is not there to do it for you.</span><span class="lang-vi">Sau khi failover <b>ra ngoài automatic failover set</b>, phải xem lại phiếu bầu quorum của các node WSFC cho khớp bố cục mới. Còn read-scale availability group với <code>CLUSTER_TYPE = NONE</code> thì có quy trình riêng, hoàn toàn thủ công — không có cluster manager làm thay.</span></li>
<li><span class="lang-en">Supplementary topic added from the official study guide (skills measured as of 24/04/2026) — the original notes left this task statement empty. Per Microsoft Learn, September 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc để trống task statement này. Theo Microsoft Learn, 9/2026.</span></li>
</ul>
</section>
<section id="s82-2"><h3><span class="n">5.23.</span> <span class="lang-en">test DR by using failover or restore — failover group</span><span class="lang-vi">kiểm thử DR bằng failover hoặc restore — failover group</span><a class="anch" href="#s82-2" title="Link tới mục này">#</a></h3>
...
<section id="s82-4"><h3><span class="n">5.24.</span> <span class="lang-en">test DR by using failover or restore — availability group</span><span class="lang-vi">kiểm thử DR bằng failover hoặc restore — availability group</span><a class="anch" href="#s82-4" title="Link tới mục này">#</a></h3>
...
<section id="s95"><h3><span class="n">5.25.</span> <span class="lang-en">monitor and troubleshoot an HA/DR solution</span><span class="lang-vi">giám sát và xử lý sự cố giải pháp HA/DR</span><a class="anch" href="#s95" title="Link tới mục này">#</a></h3>
<ul><li><span class="lang-en">Availability Group health: the AG dashboard in SSMS plus <code>sys.dm_hadr_database_replica_states</code> — watch <b>synchronization state</b>, <b>log send queue</b> (data not yet shipped = potential data loss) and <b>redo queue</b> (shipped but not replayed = long failover).</span><span class="lang-vi">Sức khỏe Availability Group: dashboard AG trong SSMS cộng <code>sys.dm_hadr_database_replica_states</code> — theo dõi <b>synchronization state</b>, <b>log send queue</b> (dữ liệu chưa gửi đi = có thể mất dữ liệu) và <b>redo queue</b> (đã gửi nhưng chưa replay = failover sẽ lâu).</span></li>
<li><span class="lang-en">Secondary shows NOT SYNCHRONIZING with no progress: check network between replicas, free disk on the secondary, and whether seeding stalled — automatic seeding needs identical file paths and enough space.</span><span class="lang-vi">Secondary hiện NOT SYNCHRONIZING và đứng im: kiểm tra mạng giữa các replica, dung lượng đĩa còn trống ở secondary, và seeding có kẹt không — automatic seeding cần đường dẫn file giống hệt và đủ chỗ.</span></li>
<li><span class="lang-en">Failover group lag on Azure SQL: query <code>sys.dm_geo_replication_link_status</code> for <code>replication_lag_sec</code>; test failover regularly with <b>planned failover</b> (no data loss) before you ever need forced failover.</span><span class="lang-vi">Độ trễ failover group trên Azure SQL: truy vấn <code>sys.dm_geo_replication_link_status</code> lấy <code>replication_lag_sec</code>; diễn tập định kỳ bằng <b>planned failover</b> (không mất dữ liệu) trước khi phải dùng forced failover.</span></li>
<li><span class="lang-en">Transaction log keeps growing on an AG primary: a stalled secondary pins log truncation — check <code>log_reuse_wait_desc = AVAILABILITY_REPLICA</code> in <code>sys.databases</code>, fix or remove the lagging replica.</span><span class="lang-vi">Transaction log phình mãi trên primary của AG: một secondary bị kẹt sẽ giữ log không cho cắt — kiểm tra <code>log_reuse_wait_desc = AVAILABILITY_REPLICA</code> trong <code>sys.databases</code>, sửa hoặc gỡ replica đang tụt.</span></li>
<li><span class="lang-en">Cluster quorum lost (FCI/AG on VMs): the cluster service stops and everything goes offline — review witness configuration (cloud witness recommended on Azure) and node votes before declaring disaster.</span><span class="lang-vi">Mất quorum của cluster (FCI/AG trên VM): cluster service dừng và mọi thứ offline — xem lại cấu hình witness (trên Azure khuyến nghị cloud witness) và phiếu bầu của các node trước khi tuyên bố thảm họa.</span></li>
<li><span class="lang-en">Alerting: put Azure Monitor alerts on failover events and replication lag, and test the <b>listener</b> connection string from the app subnet — many 'DR failures' are just DNS/listener misconfigurations.</span><span class="lang-vi">Cảnh báo: đặt Azure Monitor alert cho sự kiện failover và độ trễ nhân bản, và test connection string qua <b>listener</b> từ subnet của app — nhiều vụ 'DR hỏng' thực ra chỉ là cấu hình DNS/listener sai.</span></li>
</ul>
<ul><li class="stale"><span class="lang-en">Section added from the official study guide (skills as of April 24, 2026) — the original notes did not cover this task statement. Per Microsoft Learn, August 2026.</span><span class="lang-vi">Mục bổ sung theo study guide chính thức (skills đo từ 24/04/2026) — bản notes gốc chưa phủ task statement này. Theo Microsoft Learn, 8/2026.</span></li></ul></section>
...
</ul><li><span class="lang-en">PAUSE / ABORT / RESUME – pauses/stops/restarts an ONLINE REORGANIZE or REBUILD. Used in SQL Server 2017+ or Azure SQL Database.</span><span class="lang-vi"><b>PAUSE</b> tạm dừng, <b>ABORT</b> hủy hẳn, <b>RESUME</b> chạy tiếp — cho một thao tác ONLINE REORGANIZE hoặc REBUILD. Có ở SQL Server 2017 trở lên hoặc Azure SQL Database.</span></li>
...
<li class="stale"><span class="lang-en"><b>"Less impactful to database performance" is backwards.</b> A shrink reclaims space by moving pages from the end of the file inward, and the moved data "can be scattered to any available location in the file. This causes <b>index fragmentation</b>" — so <code>AUTO_SHRINK</code> is <i>more</i> damaging to performance than a one-off manual shrink, not less, because it fires unpredictably in the background and nobody rebuilds the indexes afterwards. Microsoft is explicit: <i>"Unless you have a specific requirement, don't set the AUTO_SHRINK database option to ON."</i> The next bullet's rhetorical question has a concrete answer: the file autogrows again, autogrow events hurt performance, and if a database keeps growing back then repeated shrinking is <b>a wasted operation</b>. Full detail in topic 3.30. Per Microsoft Learn, September 2026.</span><span class="lang-vi"><b>"Ít ảnh hưởng tới hiệu năng database hơn" là nói ngược.</b> Shrink lấy lại chỗ bằng cách dời page từ cuối file vào trong, và dữ liệu bị dời "có thể nằm rải vào bất kỳ vị trí trống nào trong file. Việc này gây <b>phân mảnh index</b>" — nên <code>AUTO_SHRINK</code> ảnh hưởng hiệu năng <i>nặng hơn</i> một lần shrink thủ công chứ không nhẹ hơn, vì nó tự chạy nền không báo trước và không ai rebuild index sau đó. Microsoft nói thẳng: <i>"Trừ khi có yêu cầu cụ thể, đừng đặt tùy chọn AUTO_SHRINK là ON."</i> Câu hỏi tu từ ở gạch đầu dòng ngay dưới có câu trả lời cụ thể: file sẽ autogrow trở lại, mà sự kiện autogrow làm giảm hiệu năng, và nếu database cứ phình lại thì shrink đi shrink lại là <b>việc làm vô ích</b>. Chi tiết đầy đủ ở mục 3.30. Theo Microsoft Learn, 9/2026.</span></li>
...
`,Pa=`<h4>1 · Plan and implement data platform resources</h4><ol><li><a href="#s-sec1">1.1. <span class="lang-en">Summary tables for domain 1</span><span class="lang-vi">Bảng tổng hợp phạm vi 1</span></a></li><li><a href="#s-3">1.2. <span class="lang-en">evaluate the possible database offerings: deployment requirements, functionality, scalability, HA/DR and security</span><span class="lang-vi">đánh giá các lựa chọn database: yêu cầu triển khai, chức năng, khả năng mở rộng, HA/DR và bảo mật</span></a></li><li><a href="#s6a">1.3. <span class="lang-en">Identify use cases for Azure Arc-enabled SQL services</span><span class="lang-vi">Xác định các tình huống dùng Azure Arc-enabled SQL services</span></a></li><li><a href="#s6b">1.4. <span class="lang-en">Identify use cases for Azure SQL Database in Microsoft Fabric</span><span class="lang-vi">Xác định các tình huống dùng Azure SQL Database trong Microsoft Fabric</span></a></li><li><a href="#s1">1.5. <span class="lang-en">deploy database offerings on selected platforms</span><span class="lang-vi">triển khai database trên các nền tảng được chọn</span></a></li><li><a href="#s2">1.6. <span class="lang-en">Choose an automated deployment method</span><span class="lang-vi">Chọn phương thức triển khai tự động</span></a></li><li><a href="#s3">1.7. <span class="lang-en">apply patches and updates for hybrid and IaaS deployment</span><span class="lang-vi">áp dụng patch và bản cập nhật cho triển khai hybrid và IaaS</span></a></li><li><a href="#s9">1.8. <span class="lang-en">configure Azure SQL Database for scale and performance</span><span class="lang-vi">cấu hình Azure SQL Database để mở rộng và tối ưu hiệu năng</span></a></li><li><a href="#s10">1.9. <span class="lang-en">configure Azure SQL Managed Instance for scale and performance</span><span class="lang-vi">cấu hình Azure SQL Managed Instance để mở rộng và tối ưu hiệu năng</span></a></li><li><a href="#s11">1.10. <span class="lang-en">configure SQL Server in Azure VMs for scale and performance</span><span class="lang-vi">cấu hình SQL Server trên Azure VM để mở rộng và tối ưu hiệu năng</span></a></li><li><a href="#s11-2">1.11. <span class="lang-en">configure storage and infrastructure resources</span><span class="lang-vi">cấu hình lưu trữ và tài nguyên hạ tầng</span></a></li><li><a href="#s-16">1.12. <span class="lang-en">calculate resource requirements</span><span class="lang-vi">tính toán yêu cầu tài nguyên</span></a></li><li><a href="#s7">1.13. <span class="lang-en">Plan for table partitioning</span><span class="lang-vi">Lập kế hoạch phân vùng bảng</span></a></li><li><a href="#s8">1.14. <span class="lang-en">evaluate database partitioning techniques, such as database sharding</span><span class="lang-vi">đánh giá các kỹ thuật phân vùng database, chẳng hạn database sharding</span></a></li><li><a href="#s13">1.15. <span class="lang-en">evaluate the use of compression for tables and indexes</span><span class="lang-vi">đánh giá việc dùng compression cho bảng và index</span></a></li><li><a href="#s14">1.16. <span class="lang-en">evaluate requirements for the migration</span><span class="lang-vi">đánh giá yêu cầu cho việc migration</span></a></li><li><a href="#s15">1.17. <span class="lang-en">evaluate offline or online migration strategies</span><span class="lang-vi">đánh giá chiến lược migration offline hay online</span></a></li><li><a href="#s16">1.18. <span class="lang-en">implement an online migration strategy</span><span class="lang-vi">triển khai chiến lược migration online</span></a></li><li><a href="#s16-2">1.19. <span class="lang-en">implement an offline migration strategy</span><span class="lang-vi">triển khai chiến lược migration offline</span></a></li><li><a href="#s18">1.20. <span class="lang-en">Perform post migration validations</span><span class="lang-vi">Thực hiện kiểm định sau migration</span></a></li><li><a href="#s18a">1.21. <span class="lang-en">troubleshoot a migration</span><span class="lang-vi">xử lý sự cố migration</span></a></li><li><a href="#s20">1.22. <span class="lang-en">set up SQL Data Sync</span><span class="lang-vi">thiết lập SQL Data Sync</span></a></li><li><a href="#s22">1.23. <span class="lang-en">Implement a migration between Azure SQL services</span><span class="lang-vi">Thực hiện migration giữa các dịch vụ Azure SQL</span></a></li><li><a href="#s22a">1.24. <span class="lang-en">implement Azure SQL Managed Instance database copy and move</span><span class="lang-vi">thực hiện copy và move database của Azure SQL Managed Instance</span></a></li></ol><h4>2 · Implement a secure environment</h4><ol><li><a href="#s-sec2">2.1. <span class="lang-en">Summary tables for domain 2</span><span class="lang-vi">Bảng tổng hợp phạm vi 2</span></a></li><li><a href="#s23">2.2. <span class="lang-en">configure authentication by using Active Directory and Entra ID</span><span class="lang-vi">cấu hình xác thực bằng Active Directory và Entra ID</span></a></li><li><a href="#s23a">2.3. <span class="lang-en">Configure authentication for SQL on Azure VMs and Azure SQL Managed</span><span class="lang-vi">Cấu hình xác thực cho SQL trên Azure VM và Azure SQL Managed</span></a></li><li><a href="#s24">2.4. <span class="lang-en">create users from Entra ID identities</span><span class="lang-vi">tạo user từ danh tính Entra ID</span></a></li><li><a href="#s25">2.5. <span class="lang-en">configure security principals</span><span class="lang-vi">cấu hình security principal</span></a></li><li><a href="#s26">2.6. <span class="lang-en">configure database and object-level permissions using graphical tools</span><span class="lang-vi">cấu hình quyền cấp database và cấp object bằng công cụ đồ họa</span></a></li><li><a href="#s27">2.7. <span class="lang-en">apply principle of least privilege for all securables</span><span class="lang-vi">áp dụng nguyên tắc đặc quyền tối thiểu cho mọi securable</span></a></li><li><a href="#s29-2">2.8. <span class="lang-en">manage security principals</span><span class="lang-vi">quản lý security principal</span></a></li><li><a href="#s29-3">2.9. <span class="lang-en">configure permissions for users to access database objects</span><span class="lang-vi">cấu hình quyền cho user truy cập các object trong database</span></a></li><li><a href="#s29-4">2.10. <span class="lang-en">configure permissions by using custom roles</span><span class="lang-vi">cấu hình quyền bằng custom role</span></a></li><li><a href="#s28a">2.11. <span class="lang-en">troubleshoot authentication and authorization issues</span><span class="lang-vi">xử lý sự cố xác thực và phân quyền</span></a></li><li><a href="#s30">2.12. <span class="lang-en">implement Transparent Data Encryption (TDE)</span><span class="lang-vi">triển khai Transparent Data Encryption (TDE)</span></a></li><li><a href="#s31">2.13. <span class="lang-en">implement object-level encryption</span><span class="lang-vi">triển khai mã hóa ở cấp object</span></a></li><li><a href="#s33">2.14. <span class="lang-en">implement Always Encrypted</span><span class="lang-vi">triển khai Always Encrypted</span></a></li><li><a href="#s33a">2.15. <span class="lang-en">implement Always Encrypted with VBS enclaves</span><span class="lang-vi">triển khai Always Encrypted với VBS enclave</span></a></li><li><a href="#s34">2.16. <span class="lang-en">implement Dynamic Data Masking</span><span class="lang-vi">triển khai Dynamic Data Masking</span></a></li><li><a href="#s34-2">2.17. <span class="lang-en">implement Azure Key Vault and disk encryption for Azure VMs</span><span class="lang-vi">triển khai Azure Key Vault và mã hóa đĩa cho Azure VM</span></a></li><li><a href="#s29">2.18. <span class="lang-en">manage certificates</span><span class="lang-vi">quản lý certificate</span></a></li><li><a href="#s35">2.19. <span class="lang-en">Configure Transport Layer Security (TLS)</span><span class="lang-vi">Cấu hình Transport Layer Security (TLS)</span></a></li><li><a href="#s32">2.20. <span class="lang-en">configure server and database-level firewall rules</span><span class="lang-vi">cấu hình firewall rule cấp server và cấp database</span></a></li><li><a href="#s34a">2.21. <span class="lang-en">Configure Private Link and Service Endpoints</span><span class="lang-vi">Cấu hình Private Link và Service Endpoint</span></a></li><li><a href="#s36">2.22. <span class="lang-en">apply a data classification strategy</span><span class="lang-vi">áp dụng chiến lược phân loại dữ liệu</span></a></li><li><a href="#s37">2.23. <span class="lang-en">configure server and database audits</span><span class="lang-vi">cấu hình audit ở cấp server và cấp database</span></a></li><li><a href="#s38">2.24. <span class="lang-en">implement data change tracking</span><span class="lang-vi">triển khai theo dõi thay đổi dữ liệu (change tracking)</span></a></li><li><a href="#s39">2.25. <span class="lang-en">perform a vulnerability assessment</span><span class="lang-vi">thực hiện đánh giá lỗ hổng bảo mật</span></a></li><li><a href="#s40">2.26. <span class="lang-en">Manage database resources by using Azure Purview</span><span class="lang-vi">Quản lý tài nguyên database bằng Azure Purview</span></a></li><li><a href="#s41">2.27. <span class="lang-en">Implement Azure SQL Database ledger</span><span class="lang-vi">Triển khai Azure SQL Database ledger</span></a></li><li><a href="#s42">2.28. <span class="lang-en">Implement row-level security</span><span class="lang-vi">Triển khai row-level security</span></a></li><li><a href="#s43">2.29. <span class="lang-en">Configure Microsoft Defender for SQL</span><span class="lang-vi">Cấu hình Microsoft Defender for SQL</span></a></li></ol><h4>3 · Monitor, configure and optimize database resources</h4><ol><li><a href="#s-sec3">3.1. <span class="lang-en">Summary tables for domain 3</span><span class="lang-vi">Bảng tổng hợp phạm vi 3</span></a></li><li><a href="#s44">3.2. <span class="lang-en">prepare an operational performance baseline</span><span class="lang-vi">chuẩn bị baseline hiệu năng vận hành</span></a></li><li><a href="#s45">3.3. <span class="lang-en">determine sources for performance metrics — by Azure layer</span><span class="lang-vi">xác định nguồn của các chỉ số hiệu năng — theo tầng Azure</span></a></li><li><a href="#s45-2">3.4. <span class="lang-en">determine sources for performance metrics — MI and VM metrics</span><span class="lang-vi">xác định nguồn của các chỉ số hiệu năng — metric của MI và VM</span></a></li><li><a href="#s46">3.5. <span class="lang-en">interpret performance metrics</span><span class="lang-vi">diễn giải các chỉ số hiệu năng</span></a></li><li><a href="#s47">3.6. <span class="lang-en">configure and monitor activity and performance at the infrastructure, server,</span><span class="lang-vi">cấu hình và giám sát hoạt động cùng hiệu năng ở cấp hạ tầng, server,</span></a></li><li><a href="#s48">3.7. <span class="lang-en">Monitor by using SQL Insights</span><span class="lang-vi">Giám sát bằng SQL Insights</span></a></li><li><a href="#s48a">3.8. <span class="lang-en">Monitor by using database watcher</span><span class="lang-vi">Giám sát bằng database watcher</span></a></li><li><a href="#s50">3.9. <span class="lang-en">configure Query Store to collect performance data</span><span class="lang-vi">cấu hình Query Store để thu thập dữ liệu hiệu năng</span></a></li><li><a href="#s53">3.10. <span class="lang-en">determine the appropriate Dynamic Management Views (DMVs) to gather query</span><span class="lang-vi">chọn Dynamic Management View (DMV) phù hợp để thu thập</span></a></li><li><a href="#s53-2">3.11. <span class="lang-en">identify performance issues using DMVs</span><span class="lang-vi">phát hiện vấn đề hiệu năng bằng DMV</span></a></li><li><a href="#s52">3.12. <span class="lang-en">identify sessions that cause blocking</span><span class="lang-vi">xác định các session gây blocking</span></a></li><li><a href="#s57">3.13. <span class="lang-en">determine the appropriate type of execution plan</span><span class="lang-vi">chọn loại execution plan phù hợp</span></a></li><li><a href="#s57-2">3.14. <span class="lang-en">identify problem areas in execution plans</span><span class="lang-vi">phát hiện điểm có vấn đề trong execution plan</span></a></li><li><a href="#s57-3">3.15. <span class="lang-en">extract query plans from the Query Store</span><span class="lang-vi">trích xuất query plan từ Query Store</span></a></li><li><a href="#s57a">3.16. <span class="lang-en">assess database performance by using Intelligent Insights for Azure SQL Database</span><span class="lang-vi">đánh giá hiệu năng database bằng Intelligent Insights cho Azure SQL Database</span></a></li><li><a href="#s54">3.17. <span class="lang-en">identify and implement index changes for queries</span><span class="lang-vi">xác định và triển khai thay đổi index cho query</span></a></li><li><a href="#s55">3.18. <span class="lang-en">recommend query construct modifications based on resource usage</span><span class="lang-vi">đề xuất sửa cấu trúc query dựa trên mức tiêu thụ tài nguyên</span></a></li><li><a href="#s56">3.19. <span class="lang-en">assess the use of hints for query performance</span><span class="lang-vi">đánh giá việc dùng hint cho hiệu năng query</span></a></li><li><a href="#s58">3.20. <span class="lang-en">implement index maintenance tasks</span><span class="lang-vi">triển khai các tác vụ bảo trì index</span></a></li><li><a href="#s59">3.21. <span class="lang-en">implement statistics maintenance tasks</span><span class="lang-vi">triển khai các tác vụ bảo trì statistics</span></a></li><li><a href="#s60">3.22. <span class="lang-en">evaluate database health using DMVs</span><span class="lang-vi">đánh giá sức khỏe database bằng DMV</span></a></li><li><a href="#s60-2">3.23. <span class="lang-en">evaluate server health using DMVs</span><span class="lang-vi">đánh giá sức khỏe server bằng DMV</span></a></li><li><a href="#s60-3">3.24. <span class="lang-en">perform database consistency checks by using DBCC — what DBCC CHECKDB does</span><span class="lang-vi">kiểm tra tính nhất quán của database bằng DBCC — DBCC CHECKDB làm gì</span></a></li><li><a href="#s60-4">3.25. <span class="lang-en">perform database consistency checks by using DBCC — arguments and how to run it</span><span class="lang-vi">kiểm tra tính nhất quán của database bằng DBCC — đối số và cách chạy</span></a></li><li><a href="#s61">3.26. <span class="lang-en">configure database auto-tuning</span><span class="lang-vi">cấu hình auto-tuning cho database</span></a></li><li><a href="#s62">3.27. <span class="lang-en">configure server and service account settings for performance</span><span class="lang-vi">cấu hình thiết lập server và service account cho hiệu năng</span></a></li><li><a href="#s63">3.28. <span class="lang-en">configure Resource Governor for performance</span><span class="lang-vi">cấu hình Resource Governor cho hiệu năng</span></a></li><li><a href="#s64">3.29. <span class="lang-en">implement database-scoped configuration</span><span class="lang-vi">triển khai database-scoped configuration</span></a></li><li><a href="#s64-2">3.30. <span class="lang-en">review database configuration options</span><span class="lang-vi">xem lại các tùy chọn cấu hình database</span></a></li><li><a href="#s66">3.31. <span class="lang-en">configure Intelligent Query Processing (IQP)</span><span class="lang-vi">cấu hình Intelligent Query Processing (IQP)</span></a></li><li><a href="#s65">3.32. <span class="lang-en">configure compute resources for scaling</span><span class="lang-vi">cấu hình tài nguyên compute để mở rộng</span></a></li><li><a href="#s65-2">3.33. <span class="lang-en">assess proper database autogrowth configuration</span><span class="lang-vi">đánh giá cấu hình autogrowth phù hợp cho database</span></a></li><li><a href="#s65-3">3.34. <span class="lang-en">report on database free space</span><span class="lang-vi">báo cáo dung lượng trống của database</span></a></li></ol><h4>4 · Configure and manage automation of tasks</h4><ol><li><a href="#s-sec4">4.1. <span class="lang-en">Summary tables for domain 4</span><span class="lang-vi">Bảng tổng hợp phạm vi 4</span></a></li><li><a href="#s67">4.2. <span class="lang-en">manage schedules for regular maintenance jobs</span><span class="lang-vi">quản lý lịch chạy các job bảo trì định kỳ</span></a></li><li><a href="#s68">4.3. <span class="lang-en">configure notifications for task success/failure/non-completion</span><span class="lang-vi">cấu hình thông báo khi tác vụ thành công/thất bại/không hoàn tất</span></a></li><li><a href="#s69">4.4. <span class="lang-en">troubleshoot SQL Server Agent jobs and automated deployments</span><span class="lang-vi">xử lý sự cố SQL Server Agent job và triển khai tự động</span></a></li><li><a href="#s70">4.5. <span class="lang-en">perform automated deployment methods for resources</span><span class="lang-vi">thực hiện các phương thức triển khai tự động cho tài nguyên</span></a></li><li><a href="#s70-2">4.6. <span class="lang-en">Automate deployment by using Azure Resource Manager templates (ARM</span><span class="lang-vi">Tự động hóa triển khai bằng Azure Resource Manager template (ARM</span></a></li><li><a href="#s71">4.7. <span class="lang-en">Automate deployment by using PowerShell</span><span class="lang-vi">Tự động hóa triển khai bằng PowerShell</span></a></li><li><a href="#s72">4.8. <span class="lang-en">Automate deployment by using Azure CLI</span><span class="lang-vi">Tự động hóa triển khai bằng Azure CLI</span></a></li><li><a href="#s74">4.9. <span class="lang-en">automate database maintenance tasks</span><span class="lang-vi">tự động hóa các tác vụ bảo trì database</span></a></li><li><a href="#s75">4.10. <span class="lang-en">configure multi-server automation</span><span class="lang-vi">cấu hình tự động hóa đa server</span></a></li><li><a href="#s75-2">4.11. <span class="lang-en">automate backups</span><span class="lang-vi">tự động hóa backup</span></a></li><li><a href="#s75-3">4.12. <span class="lang-en">automate performance tuning and patching</span><span class="lang-vi">tự động hóa việc tinh chỉnh hiệu năng và vá lỗi</span></a></li><li><a href="#s75-4">4.13. <span class="lang-en">implement policies by using automated evaluation modes</span><span class="lang-vi">triển khai policy bằng các chế độ đánh giá tự động</span></a></li><li><a href="#s76">4.14. <span class="lang-en">Automate database workflows by using Azure Logic Apps (not needed from 7</span><span class="lang-vi">Tự động hóa workflow database bằng Azure Logic Apps (không còn cần từ 7</span></a></li><li><a href="#s77">4.15. <span class="lang-en">create event notifications based on metrics</span><span class="lang-vi">tạo event notification dựa trên metric</span></a></li><li><a href="#s77-2">4.16. <span class="lang-en">create event notifications for Azure resources</span><span class="lang-vi">tạo event notification cho tài nguyên Azure</span></a></li><li><a href="#s77-3">4.17. <span class="lang-en">create alerts for server configuration changes</span><span class="lang-vi">tạo cảnh báo cho các thay đổi cấu hình server</span></a></li><li><a href="#s77-4">4.18. <span class="lang-en">create tasks that respond to event notifications</span><span class="lang-vi">tạo tác vụ phản hồi lại event notification</span></a></li></ol><h4>5 · Plan and implement a HA/DR environment</h4><ol><li><a href="#s-sec5">5.1. <span class="lang-en">Summary tables for domain 5</span><span class="lang-vi">Bảng tổng hợp phạm vi 5</span></a></li><li><a href="#s79">5.2. <span class="lang-en">recommend HADR strategy based on RPO/RTO requirements</span><span class="lang-vi">đề xuất chiến lược HADR dựa trên yêu cầu RPO/RTO</span></a></li><li><a href="#s4">5.3. <span class="lang-en">evaluate HADR for hybrid deployments</span><span class="lang-vi">đánh giá HADR cho triển khai hybrid</span></a></li><li><a href="#s84">5.4. <span class="lang-en">perform a database backup with options — on a VM</span><span class="lang-vi">thực hiện backup database kèm các tùy chọn — trên VM</span></a></li><li><a href="#s88">5.5. <span class="lang-en">perform transaction log backup</span><span class="lang-vi">thực hiện transaction log backup</span></a></li><li><a href="#s88-3">5.6. <span class="lang-en">perform database backups with options — on Managed Instance</span><span class="lang-vi">thực hiện backup database kèm các tùy chọn — trên Managed Instance</span></a></li><li><a href="#s85">5.7. <span class="lang-en">perform a database restore with options</span><span class="lang-vi">thực hiện restore database kèm các tùy chọn</span></a></li><li><a href="#s88-2">5.8. <span class="lang-en">perform restore of user databases</span><span class="lang-vi">thực hiện restore các database người dùng</span></a></li><li><a href="#s86">5.9. <span class="lang-en">perform a database restore to a point in time</span><span class="lang-vi">restore database về một thời điểm cụ thể</span></a></li><li><a href="#s87">5.10. <span class="lang-en">configure long-term backup retention</span><span class="lang-vi">cấu hình lưu giữ backup dài hạn</span></a></li><li><a href="#s88a">5.11. <span class="lang-en">backup and restore to and from cloud storage</span><span class="lang-vi">backup và restore từ/tới cloud storage</span></a></li><li><a href="#s90">5.12. <span class="lang-en">create an Availability Group</span><span class="lang-vi">tạo một Availability Group</span></a></li><li><a href="#s90-2">5.13. <span class="lang-en">prepare databases for Always On Availability Groups</span><span class="lang-vi">chuẩn bị database cho Always On Availability Group</span></a></li><li><a href="#s90-3">5.14. <span class="lang-en">integrate a database into an Always On Availability Group</span><span class="lang-vi">đưa một database vào Always On Availability Group</span></a></li><li><a href="#s90-4">5.15. <span class="lang-en">configure an Always On Availability Group listener</span><span class="lang-vi">cấu hình listener cho Always On Availability Group</span></a></li><li><a href="#s92">5.16. <span class="lang-en">configure quorum options for a Windows Server Failover Cluster</span><span class="lang-vi">cấu hình tùy chọn quorum cho Windows Server Failover Cluster</span></a></li><li><a href="#s93">5.17. <span class="lang-en">Configure failover cluster instances on Azure VMs</span><span class="lang-vi">Cấu hình failover cluster instance trên Azure VM</span></a></li><li><a href="#s91">5.18. <span class="lang-en">configure auto-failover groups</span><span class="lang-vi">cấu hình auto-failover group</span></a></li><li><a href="#s94">5.19. <span class="lang-en">configure replication</span><span class="lang-vi">cấu hình replication</span></a></li><li><a href="#s94-2">5.20. <span class="lang-en">Configure log shipping</span><span class="lang-vi">Cấu hình log shipping</span></a></li><li><a href="#s82">5.21. <span class="lang-en">test HA by using failover – FAILOVER GROUP</span><span class="lang-vi">kiểm thử HA bằng failover – FAILOVER GROUP</span></a></li><li><a href="#s82-3">5.22. <span class="lang-en">test HA by using failover – AVAILABILITY GROUP</span><span class="lang-vi">kiểm thử HA bằng failover – AVAILABILITY GROUP</span></a></li><li><a href="#s82-2">5.23. <span class="lang-en">test DR by using failover or restore — failover group</span><span class="lang-vi">kiểm thử DR bằng failover hoặc restore — failover group</span></a></li><li><a href="#s82-4">5.24. <span class="lang-en">test DR by using failover or restore — availability group</span><span class="lang-vi">kiểm thử DR bằng failover hoặc restore — availability group</span></a></li><li><a href="#s95">5.25. <span class="lang-en">monitor and troubleshoot an HA/DR solution</span><span class="lang-vi">giám sát và xử lý sự cố giải pháp HA/DR</span></a></li></ol><h4>Không còn nằm trong đề DP-300</h4><ol><li><a href="#s-125"><span class="lang-en">evaluate requirements for the upgrade</span><span class="lang-vi">đánh giá yêu cầu cho việc nâng cấp</span></a></li><li><a href="#s-126"><span class="lang-en">evaluate offline or online upgrade strategies</span><span class="lang-vi">đánh giá chiến lược nâng cấp offline hay online</span></a></li><li><a href="#s-127"><span class="lang-en">implement an online upgrade strategy</span><span class="lang-vi">triển khai chiến lược nâng cấp online</span></a></li><li><a href="#s-128"><span class="lang-en">implement an offline upgrade strategy</span><span class="lang-vi">triển khai chiến lược nâng cấp offline</span></a></li><li><a href="#s-129"><span class="lang-en">manage storage capacity</span><span class="lang-vi">quản lý dung lượng lưu trữ</span></a></li><li><a href="#s-130"><span class="lang-en">assess growth/fragmentation of databases and logs</span><span class="lang-vi">đánh giá mức tăng trưởng/phân mảnh của database và log</span></a></li><li><a href="#s-131"><span class="lang-en">assess performance-related database configuration parameters</span><span class="lang-vi">đánh giá các tham số cấu hình database liên quan hiệu năng</span></a></li><li><a href="#s-132"><span class="lang-en">identify data quality issues with duplication of data</span><span class="lang-vi">phát hiện vấn đề chất lượng dữ liệu do trùng lặp</span></a></li><li><a href="#s-133"><span class="lang-en">identify normal form of database tables</span><span class="lang-vi">xác định dạng chuẩn hóa của bảng trong database</span></a></li><li><a href="#s-134"><span class="lang-en">assess index design for performance</span><span class="lang-vi">đánh giá thiết kế index cho hiệu năng</span></a></li><li><a href="#s-135"><span class="lang-en">validate data types defined for columns</span><span class="lang-vi">kiểm định các kiểu dữ liệu đã định nghĩa cho cột</span></a></li><li><a href="#s-136"><span class="lang-en">recommend table and index storage including filegroups</span><span class="lang-vi">đề xuất cách lưu trữ bảng và index, bao gồm filegroup</span></a></li></ol>
`,Qa={class:"layout"},Ba={class:"search"},za={key:0,class:"prog"},xa={class:"prog-top"},Ua={class:"pct"},Va={class:"bar"},Ga={class:"prog-sub"},Fa={key:0},Ha={class:"bad"},Ya=["aria-label"],Ka=["title"],Wa={class:"prog-sub days-cap"},ja={class:"cov"},Xa={key:0},$a={class:"topbar"},Ja=["title"],G=14,en=Aa({__name:"Dp300NotesPage",setup(Za){_a("dp300","notes");const ta=Ma(),S=Ea(),C=Ta("dp300"),ca=o(),d=o(),O=o(),u=o(),F=o(),R=o(matchMedia("(max-width:860px)").matches);let v=[],D=[],f=[],A=null,E=null,H;const oa=()=>document.documentElement.dataset.lang||"vi",Y=n=>[...n.querySelectorAll(oa()==="en"?".lang-en":".lang-vi")],K=n=>Y(n).map(a=>a.textContent).join(" ").toLowerCase();function pa(n){document.documentElement.dataset.lang=n,S.setLang(n),v.forEach(a=>a.text=K(a.el)),u.value.value&&P()}const ra=n=>{n.querySelectorAll("mark").forEach(a=>a.replaceWith(document.createTextNode(a.textContent||""))),n.normalize()};function ga(n,a){const s=document.createTreeWalker(n,NodeFilter.SHOW_TEXT),e=[];let i;for(;i=s.nextNode();)(i.nodeValue||"").toLowerCase().includes(a)&&e.push(i);e.forEach(h=>{const t=document.createDocumentFragment(),r=h.nodeValue||"",g=r.toLowerCase();let N=0,k;for(;(k=g.indexOf(a,N))>-1;){t.appendChild(document.createTextNode(r.slice(N,k)));const ea=document.createElement("mark");ea.textContent=r.slice(k,k+a.length),t.appendChild(ea),N=k+a.length}t.appendChild(document.createTextNode(r.slice(N))),h.replaceWith(t)})}const ua=(n,a)=>Y(n).forEach(s=>ga(s,a));function P(){const n=u.value.value.trim().toLowerCase();let a=0;d.value.querySelectorAll("h2.dom").forEach(s=>s.classList.toggle("hidden",!!n)),v.forEach(s=>{ra(s.el);const e=!n||s.text.includes(n);s.el.classList.toggle("hidden",!e),e&&(a++,n&&ua(s.el,n))}),n||d.value.querySelectorAll("h2.dom").forEach(s=>s.classList.remove("hidden")),F.value.classList.toggle("hidden",a>0),D.forEach(s=>{const e=s.getAttribute("href").slice(1),i=document.getElementById(e);s.parentElement.classList.toggle("hidden",!!(i&&i.classList.contains("hidden")))})}function ha(){clearTimeout(H),H=setTimeout(P,120)}function W(n){n.key==="/"&&document.activeElement!==u.value&&(n.preventDefault(),u.value.focus()),n.key==="Escape"&&document.activeElement===u.value&&(u.value.value="",P(),u.value.blur())}function Q(){var s;const n=decodeURIComponent(location.hash.slice(1)),a=n?document.getElementById(n):null;E==null||E.classList.remove("flash"),E=null,!(!a||!((s=d.value)!=null&&s.contains(a)))&&(a.scrollIntoView({block:"start"}),a.offsetWidth,a.classList.add("flash"),E=a)}const I=o(0);function da(n){v.forEach(({el:a})=>{var h;const s=(h=n.get(a.id))==null?void 0:h.n;if(!s)return;const e=a.querySelector("h3");if(!e)return;const i=document.createElement("a");i.className="ql",i.href="/dp-300/practice?doc="+encodeURIComponent(a.id),i.target="_blank",i.rel="noopener",i.title=`Luyện ${s} câu hỏi thuộc mục này (mở tab mới)`,i.textContent=`ôn ${s} câu`,e.insertBefore(i,e.querySelector(".anch")),I.value++})}const j=o(0),T=o(0),w=o(0),B=o(0);let M=null;const va=["CN","T2","T3","T4","T5","T6","T7"],L=o([]),X=La(),z=V(()=>{var n;return((n=L.value.find(a=>a.day===X))==null?void 0:n.n)||0}),$=V(()=>L.value.slice(-7).reduce((n,a)=>n+a.n,0)),ma=V(()=>Math.max(1,...L.value.map(n=>n.n))),ba=n=>n?`${18+82*(n/ma.value)}%`:"2px";function ya(){const n=C.learnedByDay(),a=new Date;a.setHours(12,0,0,0),a.setDate(a.getDate()-(G-1));const s=[];for(let e=0;e<G;e++){const i=Na(a);s.push({day:i,n:n[i]||0,label:`${va[a.getDay()]} ${i.slice(8)}/${i.slice(5,7)}`}),a.setDate(a.getDate()+1)}L.value=s}function J(){if(!M||!d.value)return;const n=M();let a=0,s=0,e=0,i=0;v.forEach(({el:h})=>{const t=n.get(h.id);if(!t)return;s+=t.n,e+=t.seen,i+=t.wrong,t.seen>=t.n&&a++;const r=h.querySelector("h3");if(!r)return;let g=r.querySelector(".prg");g||(g=document.createElement("span"),g.className="prg",r.insertBefore(g,r.querySelector(".anch"))),g.textContent=`đã học ${t.seen}/${t.n}`+(t.wrong?` · ${t.wrong} sai`:""),g.className="prg"+(t.seen>=t.n?" full":t.seen?"":" none")+(t.wrong?" bad":""),g.title=t.wrong?`${t.seen}/${t.n} câu đã làm, ${t.wrong} câu lần gần nhất còn sai`:`${t.seen}/${t.n} câu của mục này đã làm`}),j.value=a,T.value=s,w.value=e,B.value=i,ya()}function Z(){C.reload(),J()}const aa=()=>{document.hidden||Z()},na=n=>{(!n.key||n.key.startsWith("dp300."))&&Z()};function Sa(n){var e,i;const a=(i=(e=n.target).closest)==null?void 0:i.call(e,"a");if(!a)return;const s=a.getAttribute("href")||"";s.startsWith("/")&&a.target!=="_blank"&&(n.metaKey||n.ctrlKey||n.shiftKey||n.altKey||n.button!==0||(n.preventDefault(),ta.push(s)))}function sa(){O.value.querySelectorAll("ol").forEach(n=>n.classList.toggle("hidden",R.value))}function fa(){R.value=!R.value,sa()}return ka(()=>{document.documentElement.dataset.lang=S.lang,v=[...d.value.querySelectorAll("section")].map(a=>({el:a,text:""})),v.forEach(a=>a.text=K(a.el)),D=[...O.value.querySelectorAll("a")],Ca(async()=>{const{PACKS:a,statsByNote:s}=await import("./packs-yV1C62D9.js");return{PACKS:a,statsByNote:s}},__vite__mapDeps([0,1,2])).then(({PACKS:a,statsByNote:s})=>{d.value&&(M=()=>s(a.dp300,C.seen,C.wrong),da(M()),J())});const n={};D.forEach(a=>n[a.getAttribute("href").slice(1)]=a),typeof IntersectionObserver<"u"&&(A=new IntersectionObserver(a=>{a.forEach(s=>{const e=n[s.target.id];e&&s.isIntersecting&&(D.forEach(i=>i.classList.remove("on")),e.classList.add("on"),e.scrollIntoView({block:"nearest"}))})},{rootMargin:"0px 0px -75% 0px"}),v.forEach(a=>A.observe(a.el))),sa(),location.hash&&Q(),document.addEventListener("keydown",W),window.addEventListener("hashchange",Q),window.addEventListener("storage",na),document.addEventListener("visibilitychange",aa),f.push(()=>document.removeEventListener("keydown",W)),f.push(()=>window.removeEventListener("hashchange",Q)),f.push(()=>window.removeEventListener("storage",na)),f.push(()=>document.removeEventListener("visibilitychange",aa))}),Ra(()=>{f.forEach(n=>n()),A==null||A.disconnect(),delete document.documentElement.dataset.lang}),(n,a)=>{const s=wa("router-link");return y(),m("div",{ref_key:"rootEl",ref:ca,class:"notes-dp"},[l("div",Qa,[l("aside",null,[a[18]||(a[18]=l("h1",null,"DP-300 · Notes",-1)),a[19]||(a[19]=l("div",{class:"sub"},"138 mục · 4106 dòng ghi chú",-1)),l("div",Ba,[l("input",{ref_key:"qEl",ref:u,type:"search",placeholder:"Tìm trong note… (/)",autocomplete:"off",onInput:ha},null,544)]),T.value?(y(),m("div",za,[l("div",xa,[a[3]||(a[3]=c(" Đã học ",-1)),l("b",null,p(w.value)+"/"+p(T.value),1),a[4]||(a[4]=c(" câu ",-1)),l("span",Ua,p(Math.round(w.value/T.value*100))+"%",1)]),l("div",Va,[l("i",{style:la({width:w.value/T.value*100+"%"})},null,4)]),l("div",Ga,[c(p(j.value)+"/"+p(I.value)+" mục đã học hết",1),B.value?(y(),m("span",Fa,[a[5]||(a[5]=c(" · ",-1)),l("b",Ha,p(B.value),1),a[6]||(a[6]=c(" câu đang sai",-1))])):x("",!0)]),l("div",{class:"days",role:"img","aria-label":`Số câu học mới ${G} ngày gần đây: hôm nay ${z.value} câu, 7 ngày qua ${$.value} câu`},[(y(!0),m(Da,null,Ia(L.value,e=>(y(),m("div",{key:e.day,class:ia(["dcol",{now:e.day===b(X),zero:!e.n}]),title:`${e.label}: ${e.n} câu học mới`},[l("i",{style:la({height:ba(e.n)})},null,4)],10,Ka))),128))],8,Ya),l("div",Wa,[a[7]||(a[7]=c(" Hôm nay ",-1)),l("b",{class:ia({on:z.value})},"+"+p(z.value),3),a[8]||(a[8]=c(" câu · 7 ngày qua ",-1)),l("b",null,p($.value),1),a[9]||(a[9]=c(" câu ",-1))])])):x("",!0),a[0]||(q(-1,!0),(a[0]=l("nav",{ref_key:"tocEl",ref:O,class:"toc-nav",innerHTML:b(Pa)},null,8,["innerHTML"])).cacheIndex=0,q(1),a[0]),a[20]||(a[20]=l("div",{class:"cov"},"Bản dịch tiếng Việt: 3571/3571 mục/dòng",-1)),l("div",ja,[a[10]||(a[10]=c(" Pill ",-1)),a[11]||(a[11]=l("b",null,"“ôn N câu”",-1)),a[12]||(a[12]=c(" ở tiêu đề mục mở ",-1)),a[13]||(a[13]=l("b",null,"tab mới",-1)),a[14]||(a[14]=c(" với đúng các câu hỏi thuộc mục đó",-1)),I.value?(y(),m("span",Xa," — "+p(I.value)+" mục có câu hỏi",1)):x("",!0),a[15]||(a[15]=c(". Số ",-1)),a[16]||(a[16]=l("b",null,"“đã học M/N”",-1)),a[17]||(a[17]=c(" đếm các câu đã từng chốt đáp án. ",-1))])]),l("main",null,[l("div",$a,[_(s,{to:"/dp-300/practice"},{default:U(()=>[...a[21]||(a[21]=[c("← Về bài luyện tập",-1)])]),_:1}),_(s,{to:"/dp-300/tables"},{default:U(()=>[...a[22]||(a[22]=[c("Bảng ôn nhanh",-1)])]),_:1}),a[24]||(a[24]=l("span",{class:"spacer"},null,-1)),l("button",{class:"lang-btn",title:b(S).lang==="vi"?"Switch to English":"Chuyển sang tiếng Việt",onClick:a[1]||(a[1]=e=>pa(b(S).lang==="vi"?"en":"vi"))},p(b(S).lang==="vi"?"EN":"VI"),9,Ja),l("button",{onClick:fa},p(R.value?"Mở mục lục":"Thu gọn mục lục"),1),_(qa),_(s,{to:"/",style:{"text-decoration":"none"}},{default:U(()=>[...a[23]||(a[23]=[l("button",null,"🏠",-1)])]),_:1})]),a[2]||(q(-1,!0),(a[2]=l("div",{ref_key:"contentEl",ref:d,innerHTML:b(Oa),onClick:Sa},null,8,["innerHTML"])).cacheIndex=2,q(1),a[2]),l("div",{ref_key:"nohitEl",ref:F,class:"nohit hidden"},"Không tìm thấy kết quả nào.",512)])])],512)}}});export{en as default};
