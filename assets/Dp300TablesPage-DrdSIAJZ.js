import{d as rt,j as p,q as at,A as ct,c as o,a,t as l,b as A,G as f,H as z,f as N,g as _,w as O,Q as F,m as Y,r as it,n as ht,o as s,J as W,h as j}from"./index-CFuFbF7S.js";import{_ as ot}from"./ThemeToggle.vue_vue_type_script_setup_true_lang-D3Tlpf3X.js";import{u as st}from"./useStudyClock-wLuT3DI1.js";const P=`<h2 class="dom" id="d0">Bản đồ đề thi · bản 24/04/2026</h2>

<section id="t001">
<h3>Đề DP-300 hiện tại — trọng số, phạm vi và chỗ ôn tương ứng<a class="nl" href="/dp-300/notes#dom1">notes</a></h3>
...
<tr><td>1 · Nền tảng dữ liệu &amp; di trú</td><td>15–20%</td><td>Chọn database offering; deployment tự động; <b>Azure Arc-enabled SQL</b>; <b>Azure SQL Database trong Microsoft Fabric</b>; table partitioning; sharding; hybrid + patch IaaS; scale DB/MI/VM; data compression; migration online/offline; <b>MI database copy/move</b>; troubleshoot migration</td><td><a href="/dp-300/notes#s-sec1">bảng tổng hợp phạm vi 1</a> · nhóm <a href="#d1">Phạm vi 1</a> bên dưới</td></tr>
<tr><td>2 · Môi trường bảo mật</td><td>20–25%</td><td>Entra ID authentication (DB, MI, SQL Server); security principals; least privilege; phân quyền bằng T-SQL; TDE; object-level encryption; firewall rules; <b>Always Encrypted + VBS enclaves</b>; private link / service endpoint; data classification; audit; <b>change data tracking</b>; dynamic data masking; <b>ledger</b>; row-level security</td><td><a href="/dp-300/notes#s-sec2">bảng tổng hợp phạm vi 2</a> · nhóm <a href="#d2">Phạm vi 2</a></td></tr>
<tr><td>3 · Giám sát &amp; tinh chỉnh</td><td>20–25%</td><td>Baseline; nguồn metric; <b>database watcher</b>; Extended Events; Query Store; session blocking; DMV; index cho query; sửa cấu trúc query; execution plan; Intelligent Insights; index/statistics maintenance; integrity check; automatic tuning; server settings; <b>Resource Governor</b>; database-scoped configuration; scale compute/storage; <b>intelligent query processing (IQP)</b></td><td><a href="/dp-300/notes#s-sec3">bảng tổng hợp phạm vi 3</a> · nhóm <a href="#d3">Phạm vi 3</a></td></tr>
<tr><td>4 · Tự động hoá</td><td>15–20%</td><td>SQL Server Agent jobs (lịch bảo trì, alert, notification, troubleshoot); deployment bằng ARM/Bicep, Azure PowerShell, Azure CLI; <b>elastic jobs</b>; alert cho database task; troubleshoot task tự động</td><td><a href="/dp-300/notes#s-sec4">bảng tổng hợp phạm vi 4</a> · nhóm <a href="#d4">Phạm vi 4</a></td></tr>
<tr><td>5 · HA/DR</td><td>20–25%</td><td>Chiến lược theo RPO/RTO; HA/DR hybrid và Azure-specific; quy trình test; backup/restore bằng công cụ native và T-SQL; restore point-in-time; <b>long-term retention</b>; backup/restore với cloud storage; active geo-replication; <b>Always On AG trên MI và VM</b>; failover groups; FCI trên VM; log shipping; monitor + troubleshoot HA/DR</td><td><a href="/dp-300/notes#s-sec5">bảng tổng hợp phạm vi 5</a> · nhóm <a href="#d5">Phạm vi 5</a></td></tr>
</table></div>
<p class="lead">Các chủ đề <b>được nêu đích danh</b> trong bản study guide này đều đã có trong tài liệu của repo: database watcher, ledger, Always Encrypted với VBS enclaves, Change Tracking/CDC, IQP, Arc-enabled SQL (<a href="/dp-300/notes#s6a">mục 6a</a>), SQL Database trong Fabric (<a href="/dp-300/notes#s6b">mục 6b</a>), elastic jobs và Resource Governor — sai câu nào thuộc nhóm này thì lần theo link ở cột phải. Nguồn đối chiếu: study guide DP-300 và trang chứng chỉ Azure Database Administrator Associate trên Microsoft Learn, đọc ngày 21/08/2026.</p>
</section>
